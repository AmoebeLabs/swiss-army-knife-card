 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const x=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),w=` ${i} `;class ${constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",s=!1;for(let o=0;o<t;o++){const t=this.strings[o],n=t.lastIndexOf("\x3c!--");s=(n>-1||s)&&-1===t.indexOf("--\x3e",n+1);const h=d.exec(t);e+=null===h?t+(s?w:a):t.substr(0,h.index)+h[1]+h[2]+r+h[3]+i}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==x&&(e=x.createHTML(e)),t.innerHTML=e,t}}class k extends ${getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),s=t.content,i=s.firstChild;return s.removeChild(i),e(s,i.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function L(t){let e=R.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},R.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const a=t.strings.join(i);return s=e.keyString.get(a),void 0===s&&(s=new n(t,t.getTemplateElement()),e.keyString.set(a,s)),e.stringsArray.set(t.strings,s),s}const R=new Map,O=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const a=e[0];if("."===a){return new I(t,e.slice(1),s).parts}if("@"===a)return[new V(t,e.slice(1),i.eventContext)];if("?"===a)return[new A(t,e.slice(1),s)];return new C(t,e,s).parts}handleTextExpression(t){return new T(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const F=(t,...e)=>new $(t,e,"html",z),B=(t,...e)=>new k(t,e,"svg",z)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */class wt{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const s of e)this.classes.add(s)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach((e=>t+=e+" ")),this.element.setAttribute("class",t)}}}const $t=new WeakMap,kt=f((t=>e=>{if(!(e instanceof E)||e instanceof N||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:s}=e,{element:i}=s;let a=$t.get(e);void 0===a&&(i.setAttribute("class",s.strings.join(" ")),$t.set(e,a=new Set));const o=i.classList||new wt(i);a.forEach((e=>{e in t||(o.remove(e),a.delete(e))}));for(const r in t){const e=t[r];e!=a.has(r)&&(e?(o.add(r),a.add(r)):(o.remove(r),a.delete(r)))}"function"==typeof o.commit&&o.commit()})),St=(t,e,s,i)=>{i=i||{},s=null==s?{}:s;const a=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return a.detail=s,t.dispatchEvent(a),a};class Mt{static{Mt.colorCache={},Mt.element=void 0}static _prefixKeys(t){let e={};return Object.keys(t).forEach((s=>{const i=`--${s}`,a=String(t[s]);e[i]=`${a}`})),e}static processTheme(t){let e={},s={},i={},a={};const{modes:o,...r}=t;return o&&(s={...r,...o.dark},e={...r,...o.light}),i=Mt._prefixKeys(e),a=Mt._prefixKeys(s),{themeLight:i,themeDark:a}}static processPalette(t){let e={},s={},i={},a={},o={};return Object.values(t).forEach((t=>{const{modes:a,...o}=t;e={...e,...o},a&&(i={...i,...o,...a.dark},s={...s,...o,...a.light})})),a=Mt._prefixKeys(s),o=Mt._prefixKeys(i),{paletteLight:a,paletteDark:o}}static setElement(t){Mt.element=t}static calculateColor(t,e,s){const i=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let a,o,r;const n=i.length;if(t<=i[0])return e[i[0]];if(t>=i[n-1])return e[i[n-1]];for(let h=0;h<n-1;h++){const n=i[h],l=i[h+1];if(t>=n&&t<l){if([a,o]=[e[n],e[l]],!s)return a;r=Mt.calculateValueBetween(n,l,t);break}}return Mt.getGradientValue(a,o,r)}static calculateColor2(t,e,s,i,a){const o=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let r,n,h;const l=o.length;if(t<=o[0])return e[o[0]];if(t>=o[l-1])return e[o[l-1]];for(let c=0;c<l-1;c++){const l=o[c],d=o[c+1];if(t>=l&&t<d){if([r,n]=[e[l].styles[s][i],e[d].styles[s][i]],!a)return r;h=Mt.calculateValueBetween(l,d,t);break}}return Mt.getGradientValue(r,n,h)}static calculateValueBetween(t,e,s){return(Math.min(Math.max(s,t),e)-t)/(e-t)}static getColorVariable(t){const e=t.substr(4,t.length-5);return window.getComputedStyle(Mt.element).getPropertyValue(e)}static getGradientValue(t,e,s){const i=Mt.colorToRGBA(t),a=Mt.colorToRGBA(e),o=1-s,r=s,n=Math.floor(i[0]*o+a[0]*r),h=Math.floor(i[1]*o+a[1]*r),l=Math.floor(i[2]*o+a[2]*r),c=Math.floor(i[3]*o+a[3]*r);return`#${Mt.padZero(n.toString(16))}${Mt.padZero(h.toString(16))}${Mt.padZero(l.toString(16))}${Mt.padZero(c.toString(16))}`}static padZero(t){return t.length<2&&(t=`0${t}`),t.substr(0,2)}static colorToRGBA(t){const e=Mt.colorCache[t];if(e)return e;let s=t;"var"===t.substr(0,3).valueOf()&&(s=Mt.getColorVariable(t));const i=window.document.createElement("canvas");i.width=i.height=1;const a=i.getContext("2d");a.clearRect(0,0,1,1),a.fillStyle=s,a.fillRect(0,0,1,1);const o=[...a.getImageData(0,0,1,1).data];return Mt.colorCache[t]=o,o}static hslToRgb(t){const e=t.h/360,s=t.s/100,i=t.l/100;let a,o,r;if(0===s)a=o=r=i;else{function n(t,e,s){return s<0&&(s+=1),s>1&&(s-=1),s<1/6?t+6*(e-t)*s:s<.5?e:s<2/3?t+(e-t)*(2/3-s)*6:t}const h=i<.5?i*(1+s):i+s-i*s,l=2*i-h;a=n(l,h,e+1/3),o=n(l,h,e),r=n(l,h,e-1/3)}return a*=255,o*=255,r*=255,{r:a,g:o,b:r}}}class Ct{constructor(t,e,s){this.toolId=Math.random().toString(36).substr(2,9),this.toolset=t,this._card=this.toolset._card,this.config=e,this.dev={...this._card.dev},this.toolsetPos=s,this.svg={},this.svg.cx=bt.calculateSvgCoordinate(e.position.cx,0),this.svg.cy=bt.calculateSvgCoordinate(e.position.cy,0),this.svg.height=e.position.height?bt.calculateSvgDimension(e.position.height):0,this.svg.width=e.position.width?bt.calculateSvgDimension(e.position.width):0,this.svg.x=this.svg.cx-this.svg.width/2,this.svg.y=this.svg.cy-this.svg.height/2,this.classes={},this.classes.card={},this.classes.toolset={},this.classes.tool={},this.styles={},this.styles.card={},this.styles.toolset={},this.styles.tool={},this.animationClass={},this.animationClassHasChanged=!0,this.animationStyle={},this.animationStyleHasChanged=!0,this.config?.show?.style||(this.config.show||(this.config.show={}),this.config.show.style="default"),this.colorStops={},this.config.colorstops&&this.config.colorstops.colors&&Object.keys(this.config.colorstops.colors).forEach((t=>{this.colorStops[t]=this.config.colorstops.colors[t]})),"colorstop"===this.config.show.style&&this.config?.colorstops.colors&&(this.sortedColorStops=Object.keys(this.config.colorstops.colors).map((t=>Number(t))).sort(((t,e)=>t-e))),this.csnew={},this.config.csnew&&this.config.csnew.colors&&(this.config.csnew.colors.forEach(((t,e)=>{this.csnew[t.stop]=this.config.csnew.colors[e]})),this.sortedcsnew=Object.keys(this.csnew).map((t=>Number(t))).sort(((t,e)=>t-e)))}textEllipsis(t,e){return e&&e<t.length?t.slice(0,e-1).concat("..."):t}defaultEntityIndex(){return this.default||(this.default={},this.config.hasOwnProperty("entity_indexes")?this.default.entity_index=this.config.entity_indexes[0].entity_index:this.default.entity_index=this.config.entity_index),this.default.entity_index}set value(t){let e=t;this.dev.debug&&console.log("BaseTool set value(state)",e);try{if("undefined"!==e&&void 0!==e&&this._stateValue?.toString().toLowerCase()===e.toString().toLowerCase())return}catch(i){console.log("catching something",i,t,this.config)}this.derivedEntity=null,this.config.derived_entity&&(this.derivedEntity=xt.getJsTemplateOrValue(this,t,yt.mergeDeep(this.config.derived_entity)),e=this.derivedEntity.state?.toString()),this._stateValuePrev=this._stateValue||e,this._stateValue=e,this._stateValueIsDirty=!0;let s=!1;this.activeAnimation=null,this.config.animations&&Object.keys(this.config.animations).map((t=>{const e=JSON.parse(JSON.stringify(this.config.animations[t])),i=xt.getJsTemplateOrValue(this,this._stateValue,yt.mergeDeep(e));if(s)return!0;switch(i.operator?i.operator:"=="){case"==":s=void 0===this._stateValue?void 0===i.state||"undefined"===i.state.toLowerCase():this._stateValue.toLowerCase()===i.state.toLowerCase();break;case"!=":s=void 0===this._stateValue?"undefined"!==i.state.toLowerCase():this._stateValue.toLowerCase()!==i.state.toLowerCase();break;case">":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())>Number(i.state.toLowerCase()));break;case"<":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())<Number(i.state.toLowerCase()));break;case">=":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())>=Number(i.state.toLowerCase()));break;case"<=":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())<=Number(i.state.toLowerCase()));break;default:s=!1}return this.dev.debug&&console.log("BaseTool, animation, match, value, config, operator",s,this._stateValue,i.state,i.operator),!s||(this.animationClass&&i.reuse||(this.animationClass={}),i.classes&&(this.animationClass=yt.mergeDeep(this.animationClass,i.classes)),this.animationStyle&&i.reuse||(this.animationStyle={}),i.styles&&(this.animationStyle=yt.mergeDeep(this.animationStyle,i.styles)),this.animationStyleHasChanged=!0,this.item=i,this.activeAnimation=i,s)}))}getEntityIndexFromAnimation(t){return t.hasOwnProperty("entity_index")?t.entity_index:this.config.hasOwnProperty("entity_index")?this.config.entity_index:this.config.entity_indexes?this.config.entity_indexes[0].entity_index:void 0}getIndexInEntityIndexes(t){return this.config.entity_indexes.findIndex((e=>e.entity_index===t))}stateIsMatch(t,e){let s;const i=JSON.parse(JSON.stringify(t)),a=xt.getJsTemplateOrValue(this,e,yt.mergeDeep(i));switch(a.operator?a.operator:"=="){case"==":s=void 0===e?void 0===a.state||"undefined"===a.state.toLowerCase():e.toLowerCase()===a.state.toLowerCase();break;case"!=":s=void 0===e?void 0!==a.state||"undefined"!==a.state.toLowerCase():e.toLowerCase()!==a.state.toLowerCase();break;case">":void 0!==e&&(s=Number(e.toLowerCase())>Number(a.state.toLowerCase()));break;case"<":void 0!==e&&(s=Number(e.toLowerCase())<Number(a.state.toLowerCase()));break;case">=":void 0!==e&&(s=Number(e.toLowerCase())>=Number(a.state.toLowerCase()));break;case"<=":void 0!==e&&(s=Number(e.toLowerCase())<=Number(a.state.toLowerCase()));break;default:s=!1}return s}mergeAnimationData(t){this.animationClass&&t.reuse||(this.animationClass={}),t.classes&&(this.animationClass=yt.mergeDeep(this.animationClass,t.classes)),this.animationStyle&&t.reuse||(this.animationStyle={}),t.styles&&(this.animationStyle=yt.mergeDeep(this.animationStyle,t.styles)),this.animationStyleHasChanged=!0,this.item||(this.item={}),this.item=yt.mergeDeep(this.item,t),this.activeAnimation={...t}}set values(t){this._lastStateValues||(this._lastStateValues=[]),this._stateValues||(this._stateValues=[]);const e=[...t];this.dev.debug&&console.log("BaseTool set values(state)",e);for(let s=0;s<t.length;++s){void 0!==e[s]&&(this._stateValues[s]?.toLowerCase()===e[s].toLowerCase()||this.config.derived_entities&&(this.derivedEntities[s]=xt.getJsTemplateOrValue(this,t[s],yt.mergeDeep(this.config.derived_entities[s])),e[s]=this.derivedEntities[s].state?.toString())),this._lastStateValues[s]=this._stateValues[s]||e[s],this._stateValues[s]=e[s],this._stateValueIsDirty=!0;let i=!1;this.activeAnimation=null,this.config.animations&&Object.keys(this.config.animations.map(((e,s)=>{const a=this.getIndexInEntityIndexes(this.getEntityIndexFromAnimation(e));return i=this.stateIsMatch(e,t[a]),!!i&&(this.mergeAnimationData(e),!0)})))}this._stateValue=this._stateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())],this._stateValuePrev=this._lastStateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())]}EnableHoverForInteraction(){const t=this.config.hasOwnProperty("entity_index")||this.config?.user_actions?.tap_action;this.classes.tool.hover=!!t}MergeAnimationStyleIfChanged(t){this.animationStyleHasChanged&&(this.animationStyleHasChanged=!1,this.styles=t?yt.mergeDeep(t,this.config.styles,this.animationStyle):yt.mergeDeep(this.config.styles,this.animationStyle),this.styles.card&&0!==Object.keys(this.styles.card).length&&(this._card.styles.card=yt.mergeDeep(this.styles.card)))}MergeAnimationClassIfChanged(t){this.animationClassHasChanged=!0,this.animationClassHasChanged&&(this.animationClassHasChanged=!1,this.classes=t?yt.mergeDeep(t,this.config.classes,this.animationClass):yt.mergeDeep(this.config.classes,this.animationClass))}MergeColorFromState(t){if(this.config.hasOwnProperty("entity_index")){const e=this.getColorFromState(this._stateValue);""!==e&&(t.fill=this.config[this.config.show.style].fill?e:"",t.stroke=this.config[this.config.show.style].stroke?e:"")}}MergeColorFromState2(t,e){if(this.config.hasOwnProperty("entity_index")){const s=this.config[this.config.show.style].fill?this.getColorFromState2(this._stateValue,e,"fill"):"",i=this.config[this.config.show.style].stroke?this.getColorFromState2(this._stateValue,e,"stroke"):"";""!==s&&(t.fill=s),""!==i&&(t.stroke=i)}}getColorFromState(t){let e="";switch(this.config.show.style){case"default":break;case"fixedcolor":e=this.config.color;break;case"colorstop":case"colorstops":case"colorstopgradient":e=Mt.calculateColor(t,this.colorStops,"colorstopgradient"===this.config.show.style);break;case"minmaxgradient":e=Mt.calculateColor(t,this.colorStopsMinMax,!0)}return e}getColorFromState2(t,e,s){let i="";switch(this.config.show.style){case"colorstop":case"colorstops":case"colorstopgradient":i=Mt.calculateColor2(t,this.csnew,e,s,"colorstopgradient"===this.config.show.style);break;case"minmaxgradient":i=Mt.calculateColor2(t,this.colorStopsMinMax,e,s,!0)}return i}_processTapEvent(t,e,s,i,a,o){let r;if(i){St(t,"haptic",i.haptic||"medium"),this.dev.debug&&console.log("_processTapEvent",s,i,a,o);for(let s=0;s<i.actions.length;s++)switch(i.actions[s].action){case"more-info":void 0!==a&&(r=new Event("hass-more-info",{composed:!0}),r.detail={entityId:a},t.dispatchEvent(r));break;case"navigate":if(!i.actions[s].navigation_path)return;window.history.pushState(null,"",i.actions[s].navigation_path),r=new Event("location-changed",{composed:!0}),r.detail={replace:!1},window.dispatchEvent(r);break;case"call-service":{if(!i.actions[s].service)return;const[t,r]=i.actions[s].service.split(".",2),n={...i.actions[s].service_data};n.entity_id||(n.entity_id=a),i.actions[s].parameter&&(n[i.actions[s].parameter]=o),e.callService(t,r,n);break}case"fire-dom-event":{const e={...i.actions[s]};r=new Event("ll-custom",{composed:!0,bubbles:!0}),r.detail=e,t.dispatchEvent(r);break}default:console.error("Unknown Event definition",i)}}}handleTapEvent(t,e){let s;t.stopPropagation(),t.preventDefault();let i=this.defaultEntityIndex();s=void 0===i||e.user_actions?e.user_actions?.tap_action:{haptic:"light",actions:[{action:"more-info"}]},s&&this._processTapEvent(this._card,this._card._hass,this.config,s,this._card.config.hasOwnProperty("entities")?this._card.config.entities[i]?.entity:void 0,void 0)}}class Et extends Ct{constructor(t,e,s){super(t,yt.mergeDeep({position:{cx:50,cy:50,width:100,height:25,radius:5,ratio:30,divider:30},classes:{tool:{"sak-badge":!0,hover:!0},left:{"sak-badge__left":!0},right:{"sak-badge__right":!0}},styles:{tool:{},left:{},right:{}}},e),s),this.svg.radius=bt.calculateSvgDimension(e.position.radius),this.svg.leftXpos=this.svg.x,this.svg.leftYpos=this.svg.y,this.svg.leftWidth=this.config.position.ratio/100*this.svg.width,this.svg.arrowSize=this.svg.height*this.config.position.divider/100/2,this.svg.divSize=this.svg.height*(100-this.config.position.divider)/100/2,this.svg.rightXpos=this.svg.x+this.svg.leftWidth,this.svg.rightYpos=this.svg.y,this.svg.rightWidth=(100-this.config.position.ratio)/100*this.svg.width,this.classes.tool={},this.classes.left={},this.classes.right={},this.styles.tool={},this.styles.left={},this.styles.right={},this.dev.debug&&console.log("BadgeTool constructor coords, dimensions",this.svg,this.config)}_renderBadge(){let t=[];return this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),t=B`
    ...
    `}}class It extends Ct{constructor(t,e,s){super(t,yt.mergeDeep({position:{cx:50,cy:50,radiusx:50,radiusy:25},classes:{tool:{"sak-ellipse":!0,hover:!0},ellipse:{"sak-ellipse__ellipse":!0}},styles:{tool:{},ellipse:{}}},e),s),this.svg.radiusx=bt.calculateSvgDimension(e.position.radiusx),this.svg.radiusy=bt.calculateSvgDimension(e.position.radiusy),this.classes.tool={},this.classes.ellipse={},this.styles.tool={},this.styles.ellipse={},this.dev.debug&&console.log("EllipseTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}_renderEllipse(){return this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.ellipse),this.dev.debug&&console.log("EllipseTool - renderEllipse",this.svg.cx,this.svg.cy,this.svg.radiusx,this.svg.radiusy),B`
    ...
    `}}var qt=function(){return qt=Object.assign||function(t){for(var e,s=1,i=arguments.length;s<i;s++)for(var a in e=arguments[s])Object.prototype.hasOwnProperty.call(e,a)&&(t[a]=e[a]);return t},qt.apply(this,arguments)};var Ht,Wt={second:45,minute:45,hour:22,day:5};!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(Ht=Ht||(Ht={}));const Yt=(t,e,s)=>{const i=e?(t=>{switch(t.number_format){case Ht.comma_decimal:return["en-US","en"];case Ht.decimal_comma:return["de","es","it"];case Ht.space_comma:return["fr","sv","cs"];case Ht.system:return;default:return t.language}})(e):void 0;if(Number.isNaN=Number.isNaN||function t(e){return"number"==typeof e&&t(e)},e?.number_format!==Ht.none&&!Number.isNaN(Number(t))&&Intl)try{return new Intl.NumberFormat(i,Jt(t,s)).format(Number(t))}catch(a){return console.error(a),new Intl.NumberFormat(void 0,Jt(t,s)).format(Number(t))}return!Number.isNaN(Number(t))&&""!==t&&e?.number_format===Ht.none&&Intl?new Intl.NumberFormat("en-US",Jt(t,{...s,useGrouping:!1})).format(Number(t)):"string"==typeof t?t:`${((t,e=2)=>Math.round(t*10**e)/10**e)(t,s?.maximumFractionDigits).toString()}${"currency"===s?.style?` ${s.currency}`:""}`},Jt=(t,e)=>{const s={maximumFractionDigits:2,...e};if("string"!=typeof t)return s;if(!e||void 0===e.minimumFractionDigits&&void 0===e.maximumFractionDigits){const e=t.indexOf(".")>-1?t.split(".")[1].length:0;s.minimumFractionDigits=e,s.maximumFractionDigits=e}return s};var Xt=Number.isNaN||function(t){return"number"==typeof t&&t!=t};function Zt(t,e){if(t.length!==e.length)return!1;for(var s=0;s<t.length;s++)if(i=t[s],a=e[s],!(i===a||Xt(i)&&Xt(a)))return!1;var i,a;return!0}function Kt(t,e){void 0===e&&(e=Zt);var s=null;function i(){for(var i=[],a=0;a<arguments.length;a++)i[a]=arguments[a];if(s&&s.lastThis===this&&e(i,s.lastArgs))return s.lastResult;var o=t.apply(this,i);return s={lastResult:o,lastArgs:i,lastThis:this},o}return i.clear=function(){s=null},i}const Qt=Kt((t=>new Intl.DateTimeFormat(t.language,{weekday:"long",month:"long",day:"numeric"}))),te=Kt((t=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}))),ee=Kt((t=>new Intl.DateTimeFormat(t.language,{year:"numeric",month:"numeric",day:"numeric"}))),se=Kt((t=>new Intl.DateTimeFormat(t.language,{day:"numeric",month:"short"}))),ie=Kt((t=>new Intl.DateTimeFormat(t.language,{month:"long",year:"numeric"}))),ae=Kt((t=>new Intl.DateTimeFormat(t.language,{month:"long"})));Kt((t=>new Intl.DateTimeFormat(t.language,{year:"numeric"})));const oe=Kt((t=>new Intl.DateTimeFormat(t.language,{weekday:"long"}))),re=Kt((t=>new Intl.DateTimeFormat(t.language,{weekday:"short"})));var ne;!function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ne=ne||(ne={}));const he=Kt((t=>{if(t.time_format===ne.language||t.time_format===ne.system){const e=t.time_format===ne.language?t.language:void 0,s=(new Date).toLocaleString(e);return s.includes("AM")||s.includes("PM")}return t.time_format===ne.am_pm})),le=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{hour:"numeric",minute:"2-digit",hour12:he(t)}))),ce=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{hour:he(t)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hour12:he(t)}))),de=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{weekday:"long",hour:he(t)?"numeric":"2-digit",minute:"2-digit",hour12:he(t)}))),ge=Kt((()=>new Intl.DateTimeFormat("en-GB",{hour:"numeric",minute:"2-digit",hour12:!1}))),ue=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"long",day:"numeric",hour:he(t)?"numeric":"2-digit",minute:"2-digit",hour12:he(t)}))),me=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"short",day:"numeric",hour:he(t)?"numeric":"2-digit",minute:"2-digit",hour12:he(t)}))),pe=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{month:"short",day:"numeric",hour:he(t)?"numeric":"2-digit",minute:"2-digit",hour12:he(t)}))),fe=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"long",day:"numeric",hour:he(t)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hour12:he(t)}))),ve=Kt((t=>new Intl.DateTimeFormat("en"!==t.language||he(t)?t.language:"en-u-hc-h23",{year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"2-digit",hour12:he(t)}))),_e=(t,e=2)=>{let s=`${t}`;for(let i=1;i<e;i++)s=parseInt(s)<10**i?`0${s}`:s;return s};const ye={ms:1,s:1e3,min:6e4,h:36e5,d:864e5},be=(t,e)=>function(t){const e=Math.floor(t/1e3/3600),s=Math.floor(t/1e3%3600/60),i=Math.floor(t/1e3%3600%60),a=Math.floor(t%1e3);return e>0?`${e}:${_e(s)}:${_e(i)}`:s>0?`${s}:${_e(i)}`:i>0||a>0?`${i}${a>0?`.${_e(a,3)}`:""}`:null}(parseFloat(t)*ye[e])||"0";class xe extends Ct{constructor(t,e,s){super(t,yt.mergeDeep({show:{uom:"end"},classes:{tool:{"sak-state":!0,hover:!0},state:{"sak-state__value":!0},uom:{"sak-state__uom":!0}},styles:{tool:{},state:{},uom:{}}},e),s),this.classes.tool={},this.classes.state={},this.classes.uom={},this.styles.tool={},this.styles.state={},this.styles.uom={},this.dev.debug&&console.log("EntityStateTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}static testTimeDate=!1;set value(t){super.value=t}formatStateString(t,e){const s=this._card._hass.selectedLanguage||this._card._hass.language;let i={};if(i.language=s,["relative","total","datetime","datetime-short","datetime-short_with-year","datetime_seconds","datetime-numeric","date","date_month","date_month_year","date-short","date-numeric","date_weekday","date_weekday_day","date_weekday-short","time","time-24h","time_weekday","time_seconds"].includes(e.format)){const o=new Date(t);if(!(o instanceof Date)||isNaN(o.getTime()))return t;let r;switch(e.format){case"relative":const t=function(t,e,s){void 0===e&&(e=Date.now()),void 0===s&&(s={});var i=qt(qt({},Wt),s||{}),a=(+t-+e)/1e3;if(Math.abs(a)<i.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<i.minute)return{value:Math.round(o),unit:"minute"};var r=a/3600;if(Math.abs(r)<i.hour)return{value:Math.round(r),unit:"hour"};var n=a/86400;if(Math.abs(n)<i.day)return{value:Math.round(n),unit:"day"};var h=new Date(t),l=new Date(e),c=h.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var d=12*c+h.getMonth()-l.getMonth();if(Math.round(Math.abs(d))>0)return{value:Math.round(d),unit:"month"};var g=a/604800;return{value:Math.round(g),unit:"week"}}(o,new Date);r=new Intl.RelativeTimeFormat(s,{numeric:"auto"}).format(t.value,t.unit);break;case"total":case"precision":r="Not Yet Supported";break;case"datetime":r=((t,e)=>ue(e).format(t))(o,i);break;case"datetime-short":r=((t,e)=>pe(e).format(t))(o,i);break;case"datetime-short_with-year":r=((t,e)=>me(e).format(t))(o,i);break;case"datetime_seconds":r=((t,e)=>fe(e).format(t))(o,i);break;case"datetime-numeric":r=((t,e)=>ve(e).format(t))(o,i);break;case"date":r=((t,e)=>te(e).format(t))(o,i);break;case"date_month":r=((t,e)=>ae(e).format(t))(o,i);break;case"date_month_year":r=((t,e)=>ie(e).format(t))(o,i);break;case"date-short":r=((t,e)=>se(e).format(t))(o,i);break;case"date-numeric":r=((t,e)=>ee(e).format(t))(o,i);break;case"date_weekday":r=((t,e)=>oe(e).format(t))(o,i);break;case"date_weekday-short":r=((t,e)=>re(e).format(t))(o,i);break;case"date_weekday_day":r=((t,e)=>Qt(e).format(t))(o,i);break;case"time":r=((t,e)=>le(e).format(t))(o,i);break;case"time-24h":a=o,r=ge().format(a);break;case"time_weekday":r=((t,e)=>de(e).format(t))(o,i);break;case"time_seconds":r=((t,e)=>ce(e).format(t))(o,i)}return r}var a;return isNaN(parseFloat(t))||!isFinite(t)?t:"brightness"===e.format||"brightness_pct"===e.format?`${Math.round(t/255*100)} %`:"duration"===e.format?be(t,"s"):void 0}_renderState(){this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.state);let t=this._stateValue;const e=this._card.entities[this.defaultEntityIndex()];if(void 0===e)return B``;if([void 0,"undefined"].includes(t))return B``;if(void 0===t)return B``;const s=this._card._hass.entities[e.entity_id],i=this._card.config.entities[this.defaultEntityIndex()],a=Lt(this._card.entities[this.defaultEntityIndex()].entity_id),o=this.config.locale_tag?this.config.locale_tag+t.toLowerCase():void 0;if(void 0!==i.format&&void 0!==t&&(t=this.formatStateString(t,i)),(t&&isNaN(t)&&!i.secondary_info||i.attribute)&&(t=o&&this._card._hass.localize(o)||s?.translation_key&&this._card._hass.localize(`component.${s.platform}.entity.${a}.${s.translation_key}.state.${t}`)||s?.attributes?.device_class&&this._card._hass.localize(`component.${a}.entity_component.${s.attributes.device_class}.state.${t}`)||this._card._hass.localize(`component.${a}.entity_component._.state.${t}`)||t,t=this.textEllipsis(t,this.config?.show?.ellipsis)),["undefined","unknown","unavailable","-ua-"].includes(t)&&(t=this._card._hass.localize(`state.default.${t}`)),!isNaN(t)){let e={};e=Jt(t,e),void 0!==this._card.config.entities[this.defaultEntityIndex()].decimals&&(e.maximumFractionDigits=this._card.config.entities[this.defaultEntityIndex()].decimals,e.minimumFractionDigits=e.maximumFractionDigits),t=Yt(t,this._card._hass.locale,e)}return B`
    ...
    <svg overflow="visible" id="state-${this.toolId}"
      ...
      `}}const we=36e5;class $e{constructor(t,e,s,i,a=24,o=1,r="avg",n="interval",h=!0,l=!1,c=[],d=[],g=[],u={}){this.aggregateFuncMap={avg:this._average,median:this._median,max:this._maximum,min:this._minimum,first:this._first,last:this._last,sum:this._sum,delta:this._delta,diff:this._diff},this.startOn=i,this.config=u,this.graphArea={},this.graphArea.x=0,this.graphArea.y=0,this.graphArea.width=t-2*this.graphArea.x,this.graphArea.height=e-2*this.graphArea.y,this.drawArea={},this.drawArea.x=s.l,this.drawArea.y=s.t,this.drawArea.top=s.t,this.drawArea.bottom=s.b,this.drawArea.width=t-(s.l+s.r),this.drawArea.height=e-(s.t+s.b),this._history=void 0,this.coords=[],this.width=t,this.height=e,this.margin=s,this._max=0,this._min=0,this.points=o,this.hours=a,this.aggregateFuncName=r,this._calcPoint=this.aggregateFuncMap[r]||this._average,this._smoothing=h,this._logarithmic=l,this._groupBy=n,this._endTime=0,this.valuesPerBucket=0,this.levelCount=1,this.trafficLights=c,this.bucketss=d,this.stateMap=[...g],this.clockWidth=bt.calculateSvgDimension(this.config?.clock?.size||5)}get max(){return this._max}set max(t){this._max=t}get min(){return this._min}set min(t){this._min=t}set history(t){this._history=t}update(t=void 0){if(t&&(this._history=t),!this._history)return;if(0===this.history?.length)return;this._updateEndTime();const e=this._history.reduce(((t,e)=>this._reducer(t,e)),[]);let s;e[0]&&e[0].length&&(e[0]=[e[0][e[0].length-1]]);let i=new Date;if(i.getDate(),"today"===this.startOn){let t=i.getHours()+i.getMinutes()/60;s=Math.ceil(t*this.points)}else s=Math.ceil(this.hours*this.points);if(e.length=s,this.startOn,this.coords=this._calcPoints(e),this.min=Math.min(...this.coords.map((t=>Number(t[2])))),this.max=Math.max(...this.coords.map((t=>Number(t[2])))),"line"===this.config.show.graph&&!0===this.config.line?.show_minmax){const t=this._history.reduce(((t,e)=>this._reducerMinMax(t,e)),[]);t[0][0]&&t[0][0].length&&(t[0][0]=[t[0][0][t[0][0].length-1]]),t[1][0]&&t[1][0].length&&(t[1][0]=[t[1][0][t[1][0].length-1]]),t[0].length=s,t[1].length=s;const i=[...e],a=[...e];let o=this._calcPoint;this._calcPoint=this.aggregateFuncMap.min,this.coordsMin=[],this.coordsMin=this._calcPoints(i),this._calcPoint=this.aggregateFuncMap.max,this.coordsMax=[],this.coordsMax=this._calcPoints(a),this._calcPoint=o,this.min=Math.min(...this.coordsMin.map((t=>Number(t[2])))),this.max=Math.max(...this.coordsMax.map((t=>Number(t[2]))))}}_reducerMinMax(t,e){const s=(this._endTime-new Date(e.last_changed).getTime())/we*this.points-this.hours*this.points,i=s<0?Math.floor(Math.abs(s)):0;return t[0]||(t[0]=[]),t[1]||(t[1]=[]),t[0][i]||(t[0][i]={},t[1][i]={}),t[0][i].state=Math.min(t[0][i].state?t[0][i].state:Number.POSITIVE_INFINITY,e.state),t[0][i].haState=Math.min(t[0][i].haState?t[0][i].haState:Number.POSITIVE_INFINITY,e.haState),t[1][i].state=Math.max(t[1][i].state?t[0][i].state:Number.NEGATIVE_INFINITY,e.state),t[1][i].haState=Math.max(t[1][i].haState?t[0][i].haState:Number.NEGATIVE_INFINITY,e.haState),t}_reducer(t,e){const s=(this._endTime-new Date(e.last_changed).getTime())/we*this.points-this.hours*this.points,i=s<0?Math.floor(Math.abs(s)):0;return t[i]||(t[i]=[]),t[i].push(e),t}_calcPoints(t){const e=[];let s=this.drawArea.width/(this.hours*this.points-1);s=Number.isFinite(s)?s:this.drawArea.width;const i=t.filter(Boolean)[0];let a=[this._calcPoint(i),this._lastValue(i)];const o=(t,i)=>{const o=s*i+this.drawArea.x;return t&&(a=[this._calcPoint(t),this._lastValue(t)]),e.push([o,0,t?a[0]:a[1]])};for(let r=0;r<t.length;r+=1)o(t[r],r);return e}_calcY(t){const e=this._logarithmic?Math.log10(Math.max(1,this.max)):this.max,s=this._logarithmic?Math.log10(Math.max(1,this.min)):this.min,i=(e-s)/this.drawArea.height||1;return t.map((t=>{const e=this._logarithmic?Math.log10(Math.max(1,t[2])):t[2],a=s<0?Math.abs(s):0;e>0&&Math.max(0,s);this.drawArea.height,this.drawArea.y;const o=e>0?this.drawArea.height+1*this.drawArea.y-a/i-(e-Math.max(0,s))/i:this.drawArea.height+1*this.drawArea.y-(0-s)/i,r=this.drawArea.height+1*this.drawArea.y-(e-s)/i;return[t[0],r,t[2],o]}))}_calcLevelY(t){const e=this._logarithmic?Math.log10(Math.max(1,this.max)):this.max,s=this._logarithmic?Math.log10(Math.max(1,this.min)):this.min,i=(e-s)/this.drawArea.height||1,a=s<0?Math.abs(s):0;let o=[];return t[2].forEach(((t,e)=>{const r=t>=0?this.drawArea.height+1*this.drawArea.y-1*a/i-(t-Math.max(0,s))/i:this.drawArea.height+1*this.drawArea.y-(0-t)/i;return o.push(r),o})),o}getPoints(){let t,e,{coords:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coords);let i=s[0];s.shift();return s.map(((s,a)=>{t=s,e=this._smoothing?this._midPoint(i[0],i[1],t[0],t[1]):t;const o=this._smoothing?(t[2]+i[2])/2:t[2];return i=t,[e[0],e[1],o,a+1]}))}getPath(){let t,e,{coords:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coords);let i="",a=s[0];return i+=`M${a[0]},${a[1]}`,s.forEach((s=>{t=s,e=this._smoothing?this._midPoint(a[0],a[1],t[0],t[1]):t,i+=` ${e[0]},${e[1]}`,i+=` Q ${t[0]},${t[1]}`,a=t})),i+=` ${t[0]},${t[1]}`,i}getPathMin(){let t,e,{coordsMin:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coordsMin);let i="",a=s[0];return i+=`M${a[0]},${a[1]}`,s.forEach((s=>{t=s,e=t,i+=` ${e[0]},${e[1]}`,i+=` Q ${t[0]},${t[1]}`,a=t})),i+=` ${t[0]},${t[1]}`,i}getPathMax(){let t,e,{coordsMax:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coordsMax);let i="",a=s[s.length-1];return s.reverse().forEach(((s,o,r)=>{t=s,e=t,i+=` ${e[0]},${e[1]}`,i+=` Q ${t[0]},${t[1]}`,a=t})),i+=` ${t[0]},${t[1]}`,i+=`M${a[0]},${a[1]}`,i}computeGradient(t,e){const s=e?Math.log10(Math.max(1,this._max))-Math.log10(Math.max(1,this._min)):this._max-this._min;return t.map(((t,i,a)=>{let o,r;if(t.value>this._max&&a[i+1]){const e=(this._max-a[i+1].value)/(t.value-a[i+1].value);o=Mt.getGradientValue(a[i+1].color,t.color,e)}else if(t.value<this._min&&a[i-1]){const e=(a[i-1].value-this._min)/(a[i-1].value-t.value);o=Mt.getGradientValue(a[i-1].color,t.color,e)}return r=s<=0?0:e?(Math.log10(Math.max(1,this._max))-Math.log10(Math.max(1,t.value)))*(100/s):(this._max-t.value)*(100/s),{color:o||t.color,offset:r}}))}getFillMinMax(t,e){let s=t;return s+=` L ${this.coordsMax[this.coordsMax.length-1][0]},\n                ${this.coordsMax[this.coordsMax.length-1][1]}`,s+=e,s+=" z",s}getFill(t){const e=(this._min>=0?this.height:this.height+0-Math.abs(this._min)/(this._max-this._min)*this.height)+1.5*this.drawArea.y;let s=t;return s+=` L ${this.coords[this.coords.length-1][0]+this.drawArea.x}, ${e}`,s+=` L ${this.coords[0][0]}, ${e} z`,s}polarToCartesian(t,e,s,i,a){const o=(a-90)*Math.PI/180;return{x:t+s*Math.cos(o),y:e+i*Math.sin(o)}}_calcClockCoords(t,e,s,i,a,o){const r=this.drawArea.x+this.drawArea.width/2,n=this.drawArea.y+this.drawArea.height/2,h=this.polarToCartesian(r,n,i,a,e),l=this.polarToCartesian(r,n,i,a,t),c=Math.abs(e-t)<=180?"0":"1",d=s?"0":"1",g=i-o,u=a-o;return{start:h,end:l,start2:this.polarToCartesian(r,n,g,u,e),end2:this.polarToCartesian(r,n,g,u,t),largeArcFlag:c,sweepFlag:d}}_calcClock(t){const e=this._logarithmic?Math.log10(Math.max(1,this.max)):this.max,s=this._logarithmic?Math.log10(Math.max(1,this.min)):this.min,i=360/(this.hours*this.points);let a=0;const o=(e-s)/this.clockWidth;return t.map((t=>{let e,r;"sunburst"===this.config.show?.variant?(e=((this._logarithmic?Math.log10(Math.max(1,t[2])):t[2])-s)/o,r=this.drawArea.width/2-this.clockWidth+e):(e=this.clockWidth,r=this.drawArea.width/2);let n=[],h=[],l=[],c=[];const{start:d,end:g,start2:u,end2:m,largeArcFlag:p,sweepFlag:f}=this._calcClockCoords(a,a+i,true,r,r,e);return a+=i,n.push(d.x,g.x,u.x,m.x),h.push(d.y,g.y,u.y,m.y),l.push(this.drawArea.width/2,this.drawArea.width/2-this.clockWidth),c.push(this.drawArea.height/2,this.drawArea.height/2-this.clockWidth),[n,h,t[2],0,l,c,p,f]}))}getClock(t,e,s=4){return this._calcClock(this.coords).map(((t,e)=>({start:{x:t[0][0],y:t[1][0]},end:{x:t[0][1],y:t[1][1]},start2:{x:t[0][2],y:t[1][2]},end2:{x:t[0][3],y:t[1][3]},radius:{x:t[4][0],y:t[5][0]},radius2:{x:t[4][1],y:t[5][1]},largeArcFlag:t[6],sweepFlag:t[7],value:t[2]})))}getClockPaths(){return this.clock.map(((t,e)=>["M",t.start.x,t.start.y,"A",t.radius.x,t.radius.y,0,t.largeArcFlag,t.sweepFlag,t.end.x,t.end.y,"L",t.end2.x,t.end2.y,"A",t.radius2.x,t.radius2.y,0,t.largeArcFlag,"0"===t.sweepFlag?"1":"0",t.start2.x,t.start2.y,"Z"].join(" ")))}getTimeline(t,e,s=4){const i=this._logarithmic?Math.log10(Math.max(1,this.max)):this.max,a=this._logarithmic?Math.log10(Math.max(1,this.min)):this.min,o=this.coords,r=(this.drawArea.width+s)/Math.ceil(this.hours*this.points)/e,n=(i-a)/this.drawArea.height||1;return this.drawArea.height,this.bucketss.length,this.bucketss.length,"audio"===this.config.show.variant?o.map(((i,o)=>({x:r*o*e+r*t+this.drawArea.x,y:this.drawArea.height/2-((this._logarithmic?Math.log10(Math.max(1,i[2])):i[2])-a)/n/2,height:((this._logarithmic?Math.log10(Math.max(1,i[2])):i[2])-a)/n,width:r-s,value:i[2]}))):o.map(((i,a)=>({x:r*a*e+r*t+this.drawArea.x,y:0,height:this.drawArea.height,width:r-s,value:i[2]})))}getEqualizer(t,e,s=4){const i=(this.drawArea.width+s)/Math.ceil(this.hours*this.points)/e;this._max,this._min,this.drawArea.height;this._min<0&&Math.abs(this._min);const a=(this.drawArea.height-this.levelCount*s)/this.levelCount;let o;return this.coords.map(((t,e)=>{let s=[];const i=Math.trunc(t[2]/this.valuesPerBucket),a=Math.trunc(this._min/this.valuesPerBucket);o=i-a,s[0]=t[0],s[1]=[],s[2]=[];for(let r=0;r<o;r++)s[2][r]=this._min+r*this.valuesPerBucket;return s[1]=this._calcLevelY(s),s})).map(((o,r)=>({x:i*r*e+i*t+this.drawArea.x,y:o[1],height:a,width:i-s,value:o[2]})))}getTrafficLights(t,e,s=4){const i=(this.drawArea.width+s)/Math.ceil(this.hours*this.points)/e,a=(this.drawArea.height-this.bucketss.length*s)/this.bucketss.length;let o;return this.coords.map(((t,e)=>{let i=[];const r=this.bucketss.length;o=r-0,i[0]=t[0],i[1]=[],i[2]=[];let n=-1,h=0;for(let s=0;s<o;s++){h=0;for(let e=0;e<this.bucketss[s].rangeMin.length;e++)t[2]>=this.bucketss[s].rangeMin[e]&&t[2]<this.bucketss[s].rangeMax[e]&&(h=e,n=s)}for(let l=0;l<=o;l++)l<=n&&(i[2][l]=this.bucketss[l].length>h?this.bucketss[l].rangeMin[h]:this.bucketss[l].rangeMin[0]),i[1][l]=this.drawArea.height-l*(a+s);return i})).map(((o,r)=>({x:i*r*e+i*t+this.drawArea.x,y:o[1],height:a,width:i-s,value:o[2]})))}getBars(t,e,s=4){const i=this._calcY(this.coords),a=(this.drawArea.width+s)/Math.ceil(this.hours*this.points)/e,o=(this._max-this._min)/this.drawArea.height||1;return this._min<0&&Math.abs(this._min),i.map(((i,r)=>({x:a*r*e+a*t+this.drawArea.x,y:this._min>0?i[1]:i[3],height:i[2]>0?this._min<0?i[2]/o:(i[2]-this._min)/o:i[1]-i[3],width:a-s,value:i[2]})))}_midPoint(t,e,s,i){return[(t-s)/2+s,(e-i)/2+i]}_average(t){return t.reduce(((t,e)=>t+parseFloat(e.state)),0)/t.length}_median(t){const e=[...t].sort(((t,e)=>parseFloat(t)-parseFloat(e))),s=Math.floor((e.length-1)/2);return e.length%2==1?parseFloat(e[s].state):(parseFloat(e[s].state)+parseFloat(e[s+1].state))/2}_maximum(t){return Math.max(...t.map((t=>t.state)))}_minimum(t){return Math.min(...t.map((t=>t.state)))}_first(t){return parseFloat(t[0].state)}_last(t){return parseFloat(t[t.length-1].state)}_sum(t){return t.reduce(((t,e)=>t+parseFloat(e.state)),0)}_delta(t){return this._maximum(t)-this._minimum(t)}_diff(t){return this._last(t)-this._first(t)}_lastValue(t){return["delta","diff"].includes(this.aggregateFuncName)?0:parseFloat(t[t.length-1].state)||0}_updateEndTime(){if(this._endTime=new Date,"yesterday"===this.startOn)this._endTime.setHours(0,0,0,0);else switch(this._groupBy){case"month":this._endTime.setMonth(this._endTime.getMonth()+1),this._endTime.setDate(1);break;case"date":this._endTime.setDate(this._endTime.getDate()+1),this._endTime.setHours(0,0,0,0);break;case"hour":this._endTime.setHours(this._endTime.getHours()+1),this._endTime.setMinutes(0,0,0)}}}const ke=(t,e,s="en-US")=>t.toLocaleString(s,{hour:"numeric",minute:"numeric",...e}),Se=t=>3600*t*1e3,Me=["var(--accent-color)","#3498db","#e74c3c","#9b59b6","#f1c40f","#2ecc71","#1abc9c","#34495e","#e67e22","#7f8c8d","#27ae60","#2980b9","#8e44ad"],Ce=(t,e)=>{for(let s=e,i=t.length;s<i;s+=1)if(null!=t[s].value)return s;throw new Error('Error in threshold interpolation: could not find right-nearest valued stop. Do the first and last thresholds have a set "value"?')},Ee=(t,e)=>{const s=(t=>{if(!t||!t.length)return t;if(null==t[0].value||null==t[t.length-1].value)throw new Error('The first and last thresholds must have a set "value".\n See xyz manual');let e=0,s=null;return t.map(((i,a)=>{if(null!=i.value)return e=a,{...i};null==s?s=Ce(t,a):a>s&&(e=s,s=Ce(t,a));const o=t[e].value,r=(t[s].value-o)/(s-e);return{color:"string"==typeof i?i:i.color,value:r*a+o}}))})(t);if(s.sort(((t,e)=>e.value-t.value)),"smooth"===e)return s;return[].concat(...s.map(((t,e)=>[t,{value:t.value-1e-4,color:s[e+1]?s[e+1].color:t.color}])))};class Te extends Ct{constructor(t,e,s){const i={position:{cx:50,cy:50,height:25,width:25,margin:.5},x_axis:{hours_to_show:24,bins_per_hour:.5,group_by:"interval",start_on:"interval"},y_axis:{logarithmic:!1,value_factor:0,aggregate_func:"avg",smoothing:!0},_hours_to_show:24,_points_per_hour:.5,_bins_per_hour:.5,_group_by:"interval",_start_on:"interval",_logarithmic:!1,_value_factor:0,_aggregate_func:"avg",value_buckets:10,animate:!0,hour24:!1,font_size:10,line_color:[...Me],colorstops:[],colorstops_transition:"smooth",line_width:5,bar_spacing:4,state_map:[],cache:!0,color:"var(--primary-color)",clock:{size:5,line_width:0,face:{hour_marks_count:24}},classes:{tool:{"sak-graph":!0,hover:!0},bar:{},line:{"sak-graph__line":!0,hover:!0},traffic_light_background:{},traffic_light_foreground:{},clock_face_day_night:{"sak-graph__clock-face_day-night":!0},clock_face_hour_marks:{"sak-graph__clock-face_hour-marks":!0},clock_face_hour_numbers:{"sak-graph__clock-face_hour-numbers":!0}},styles:{tool:{},line:{},bar:{},traffic_light_background:{},traffic_light_foreground:{},clock_face_day_night:{},clock_face_hour_marks:{},clock_face_hour_numbers:{},area_mask_above:{fill:"url(#sak-graph-area-mask-tb-1)"},area_mask_below:{fill:"url(#sak-graph-area-mask-bt-1)"},bar_mask_above:{fill:"url(#sak-graph-bar-mask-tb-80)"},bar_mask_below:{fill:"url(#sak-graph-bar-mask-bt-80)"}},show:{style:"fixedcolor"}};if(super(t,yt.mergeDeep(i,e),s),this.svg.margin={},"object"==typeof this.config.position.margin?(this.svg.margin.t=bt.calculateSvgDimension(this.config.position.margin?.t)||bt.calculateSvgDimension(this.config.position.margin?.y),this.svg.margin.b=bt.calculateSvgDimension(this.config.position.margin?.b)||bt.calculateSvgDimension(this.config.position.margin?.y),this.svg.margin.r=bt.calculateSvgDimension(this.config.position.margin?.r)||bt.calculateSvgDimension(this.config.position.margin?.x),this.svg.margin.l=bt.calculateSvgDimension(this.config.position.margin?.l)||bt.calculateSvgDimension(this.config.position.margin?.x),this.svg.margin.x=this.svg.margin.l,this.svg.margin.y=this.svg.margin.t):(this.svg.margin.x=bt.calculateSvgDimension(this.config.position.margin),this.svg.margin.y=this.svg.margin.x,this.svg.margin.t=this.svg.margin.x,this.svg.margin.r=this.svg.margin.x,this.svg.margin.b=this.svg.margin.x,this.svg.margin.l=this.svg.margin.x),this.svg.clockface={},this.config?.clock?.face&&(!0===this.config.clock.face?.show_day_night&&(this.svg.clockface.dayNightRadius=bt.calculateSvgDimension(this.config.clock.face.day_night_radius)),!0===this.config.clock.face?.show_hour_marks&&(this.svg.clockface.hourMarksRadius=bt.calculateSvgDimension(this.config.clock.face.hour_marks_radius)),["absolute","relative"].includes(this.config.clock.face?.show_hour_numbers)&&(this.svg.clockface.hourNumbersRadius=bt.calculateSvgDimension(this.config.clock.face.hour_numbers_radius))),this._data=[],this._bars=[],this._scale={},this._needsRendering=!1,this.classes.tool={},this.classes.bar={},this.classes.clock_face_day_night={},this.classes.clock_face_hour_marks={},this.classes.clock_face_hour_numbers={},this.classes.timeline={},this.classes.timeline_graph={},this.styles.timeline={},this.styles.timeline_graph={},this.classes.traffic_light={},this.classes.traffic_light_background={},this.styles.traffic_light_background={},this.classes.traffic_light_foreground={},this.styles.traffic_light_foreground={},this.classes.clock={},this.classes.clock_graph={},this.styles.clock={},this.styles.clock_graph={},this.classes.helper_line1={},this.classes.helper_line2={},this.classes.helper_line3={},this.styles.helper_line1={},this.styles.helper_line2={},this.styles.helper_line3={},this.styles.tool={},this.styles.bar={},this.styles.line={},this.styles.clock_face_day_night={},this.styles.clock_face_hour_marks={},this.styles.clock_face_hour_numbers={},this.stylesBar={},this.seriesIndex=0,this.id=this.toolId,this.bound=[0,0],this.boundSecondary=[0,0],this.length=[],this.entity=[],this.line=[],this.lineMin=[],this.lineMax=[],this.bar=[],this.equalizer=[],this.trafficLight=[],this.abs=[],this.fill=[],this.fillMinMax=[],this.points=[],this.gradient=[],this.tooltip={},this.updateQueue=[],this.updating=!1,this.stateChanged=!1,this.initial=!0,this._md5Config=void 0,this.clock=[],this.timeline=[],this.config.width=this.svg.width,this.config.height=this.svg.height,this.svg.line_width=bt.calculateSvgDimension(this.config.line_width),this.trafficLights=[],this.config.colorstops.map(((t,e)=>this.trafficLights[e]=t.value)),this.buckets=[],this.config.colorstops.map(((t,e)=>{let s;s=void 0!==t.bucket?t.bucket:e,this.buckets[s]||(this.buckets[s]={},this.buckets[s].value=[],this.buckets[s].rangeMin=[],this.buckets[s].rangeMax=[]),this.buckets[s].bucket=s,this.buckets[s].color=t.color;let i=t.value,a=this.config.colorstops[e+1]?.value||1/0;return this.buckets[s].value.push(t.value),this.buckets[s].rangeMin.push(i),this.buckets[s].rangeMax.push(a),!0})),this.config.colorstops=Ee(this.config.colorstops,this.config.colorstops_transition),this.clockWidth=bt.calculateSvgDimension(this.config?.clock?.size||5),this.svg.graph={},this.svg.graph.height=this.svg.height-0*this.svg.margin.y,this.svg.graph.width=this.svg.width-0*this.svg.margin.x,this.config.state_map.forEach(((t,e)=>{"string"==typeof t&&(this.config.state_map[e]={value:t,label:t}),this.config.state_map[e].label=this.config.state_map[e].label||this.config.state_map[e].value})),this.helperLines=[],"object"==typeof this.config.helper_lines){let t=0;Object.keys(this.config.helper_lines).forEach((e=>{this.helperLines[t]={id:e,zpos:this.config.helper_lines[e]?.zpos||"above",yshift:bt.calculateSvgDimension(this.config.helper_lines[e]?.yshift)||0},t+=1}))}if(this.xLines={},this.xLines.lines=[],"object"==typeof this.config.x_lines?.lines){let t=0;this.config.x_lines.lines.forEach((e=>{this.xLines.lines[t]={id:e.name,zpos:e?.zpos||"above",yshift:bt.calculateSvgDimension(e?.yshift)||0},t+=1}))}"object"==typeof this.config.x_lines?.numbers&&(this.xLines.numbers={...this.config.x_lines.numbers});let{config:a}=this;this.Graph=[],this.Graph[0]=new $e(this.svg.graph.width,this.svg.graph.height,this.svg.margin,this.config.x_axis.start_on,this.config.x_axis.hours_to_show,this.config.x_axis.bins_per_hour,this.config.y_axis.aggregate_func,this.config.x_axis.group_by,((...t)=>t.find((t=>void 0!==t)))(this.config.y_axis.smoothing,!this._card.config.entities[this.defaultEntityIndex()].entity.startsWith("binary_sensor.")),this.config.y_axis.logarithmic,this.trafficLights,this.buckets,this.config.state_map,a)}set value(t){if(this._stateValue===t)return!1;const e=super.value=t;if(!0===this.config.y_axis.fixed_value){const e=[{state:t}];this.series=e}return e}set data(t){}set series(t){if(this.dev&&this.dev.fakeData){let e=40;for(let s=0;s<t.length;s++)s<t.length/2&&(e-=4*s),s>t.length/2&&(e+=3*s),t[s].state=e}if(!0===this._card.config.entities[0].fixed_value){const e=t[t.length-1];t=[e,e]}this.seriesIndex=0,this.Graph[this.seriesIndex].update(t),this.updateBounds();let{config:e}=this;if(e.show.graph){let t=0;const s=0;if(!this._card.config.entities[this.defaultEntityIndex()]||0===this.Graph[s].coords.length)return;const i="secondary"===this._card.config.entities[s].y_axis?this.boundSecondary:this.bound;[this.Graph[s].min,this.Graph[s].max]=[i[0],i[1]];const a=this.visibleEntities.length;if("bar"===e.show.graph)this.bar[s]=this.Graph[s].getBars(t,a,e.bar_spacing),t+=1,e.colorstops.length>0&&!this._card.config.entities[s].color&&(this.gradient[s]=this.Graph[s].computeGradient(e.colorstops,this.config.y_axis.logarithmic));else if(["area","line"].includes(e.show.graph)){const t=this.Graph[s].getPath();!1!==this._card.config.entities[s].show_line&&(this.line[s]=t)}if("area"===e.show.graph&&(this.fill[s]=this.Graph[s].getFill(this.line[s])),e?.line?.show_minmax){const t=this.Graph[s].getPathMin(),e=this.Graph[s].getPathMax();this.lineMin||(this.lineMin=[]),this.lineMax||(this.lineMax=[]),this.lineMin[s]=t,this.lineMax[s]=e,this.fillMinMax||(this.fillMinMax=[]),this.fillMinMax[s]=this.Graph[s].getFillMinMax(t,e)}"dots"===e.show.graph||!0===e?.area?.show_dots||!0===e?.line?.show_dots?this.points[s]=this.Graph[s].getPoints():"equalizer"===this.config.show.graph?(this.Graph[s].levelCount=this.config.value_buckets,this.Graph[s].valuesPerBucket=(this.Graph[s].max-this.Graph[s].min)/this.config.value_buckets,this.equalizer[s]=this.Graph[s].getEqualizer(0,this.visibleEntities.length,e.bar_spacing)):"trafficlight"===this.config.show.graph?(this.Graph[s].levelCount=this.config.value_buckets,this.Graph[s].valuesPerBucket=(this.Graph[s].max-this.Graph[s].min)/this.config.value_buckets,this.trafficLight[s]=this.Graph[s].getTrafficLights(0,this.visibleEntities.length,e.bar_spacing)):"clock"===this.config.show.graph?(this.clock[s]=this.Graph[s].getClock(0,this.visibleEntities.length,0),this.Graph[s].clock=this.clock[s]):"timeline"===this.config.show.graph&&(this.timeline[s]=this.Graph[s].getTimeline(0,this.visibleEntities.length,0),this.Graph[s].timeline=this.timeline[s]),e.colorstops.length>0&&!this._card.config.entities[s].color&&(this.gradient[s]=this.Graph[s].computeGradient(e.colorstops,this.config.y_axis.logarithmic)),this.line=[...this.line]}this.updating=!1,this._firstUpdatedCalled?this._firstUpdatedCalled=!1:this._firstUpdatedCalled=!0}hasSeries(){return this.defaultEntityIndex()}_convertState(t){const e=this.config.state_map.findIndex((e=>e.value===t.state));-1!==e&&(t.state=e)}processStateMap(t){this.config.state_map?.length>0&&t[0].forEach(((e,s)=>{this.config.state_map.length>0&&(t[0][s].haState=e.state),this._convertState(e),t[0][s].state=e.state})),"bin"===this.config.y_axis?.use_value&&t[0].forEach(((e,s)=>{let i=-1,a=!1;a=!1;for(let t=0;t<this.buckets.length;t++)for(let s=0;s<this.buckets[t].rangeMin.length;s++)e.state>=this.buckets[t].rangeMin[s]&&e.state<this.buckets[t].rangeMax[s]&&(a=!0,i=t);a||console.log("processStateMap - ILLEGAL value",e,s);const o=this.buckets[i].bucket;t[0][s].haState=e.state,t[0][s].state=o})),0!==this.config.y_axis.value_factor&&t[0].forEach(((e,s)=>{t[0][s].haState=e.state,t[0][s].state=e.state*this.config.y_axis.value_factor}))}get visibleEntities(){return[1]}get primaryYaxisEntities(){return this.visibleEntities.filter((t=>void 0===t.y_axis||"primary"===t.y_axis))}get secondaryYaxisEntities(){return this.visibleEntities.filter((t=>"secondary"===t.y_axis))}get visibleLegends(){return this.visibleEntities.filter((t=>!1!==t.show_legend))}get primaryYaxisSeries(){return this.primaryYaxisEntities.map(((t,e)=>this.Graph[e]))}get secondaryYaxisSeries(){return this.secondaryYaxisEntities.map((t=>this.Graph[t.index]))}getBoundary(t,e,s,i){if(!(t in Math))throw new Error(`The type "${t}" is not present on the Math object`);return void 0===s?Math[t](...e.map((e=>e[t])))||i:"~"!==s[0]?s:Math[t](Number(s.substr(1)),...e.map((e=>e[t])))}getBoundaries(t,e,s,i,a){let o=[this.getBoundary("min",t,e,i[0],a),this.getBoundary("max",t,s,i[1],a)];if(a){const t=Math.abs(o[0]-o[1]),e=parseFloat(a)-t;e>0&&(o=[o[0]-e/2,o[1]+e/2])}return o}updateBounds({config:t}=this){this.bound=this.getBoundaries(this.primaryYaxisSeries,t.y_axis.lower_bound,t.y_axis.upper_bound,this.bound,t.y_axis.min_bound_range),this.boundSecondary=this.getBoundaries(this.secondaryYaxisSeries,t.y_axis.lower_bound_secondary,t.y_axis.upper_bound_secondary,this.boundSecondary,t.y_axis.min_bound_range_secondary)}computeColor(t,e){const{colorstops:s,line_color:i}=this.config,a=Number(t)||0,o={color:i[e]||i[0],...s.slice(-1)[0],...s.find((t=>t.value<a))};return this._card.config.entities[e].color||o.color}intColor(t,e){const{colorstops:s,line_color:i}=this.config,a=Number(t)||0;let o;if(s.length>0)if("bar"===this.config.show.graph){const{color:t}=s.find((t=>t.value<a))||s.slice(-1)[0];o=t}else{const e=s.findIndex((t=>t.value<a)),i=s[e],r=s[e-1];if(r){const e=(r.value-t)/(r.value-i.value);o=Mt.getGradientValue(r.color,i.color,e)}else o=e?s[s.length-1].color:s[0].color}return this._card.config.entities[e].color||o||i[e]||i[0]}getEndDate(){const t=new Date;switch(this.config.x_axis.group_by){case"date":t.setDate(t.getDate()+1),t.setHours(0,0,0);break;case"hour":t.setHours(t.getHours()+1),t.setMinutes(0,0)}switch(this.config.x_axis.start_on){case"today":break;case"yesterday":t.setHours(0,0,0,0)}return t}setTooltip(t,e,s,i=null){const{bins_per_hour:a,hours_to_show:o,format:r}=this.config.x_axis,n=o<1&&a<1?a*o:1/a,h=Math.abs(e+1-Math.ceil(o*a)),l=this.getEndDate(),c=1/60;l.setMilliseconds(l.getMilliseconds()-Se(n*h+c));const d=ke(l,r,this._card._hass.language);l.setMilliseconds(l.getMilliseconds()-Se(n-c));const g=ke(l,r,this._card._hass.language);this.tooltip={value:s,id:h,entity:t,time:[g,d],index:e,label:i}}renderSvgAreaMask(t,e){if("area"!==this.config.show.graph)return;if(!t)return;const s="fade"===this.config.show.fill,i=this.length[e]||!1===this._card.config.entities[e].show_line,a=this.Graph[e]._min>=0?0:Math.abs(this.Graph[e]._min)/(this.Graph[e]._max-this.Graph[e]._min)*100;return B`
    <defs>
    ...
    <mask id=${`fill-${this.id}-${e}`}>
      <path class='fill'
        ...
        d=${this.fill[e]}
      />
      ${this.Graph[e]._min<0?B`<path class='fill'
            type=${this.config.show.fill}
            .id=${e} anim=${this.config.animate} ?init=${i}
            style="animation-delay: ${this.config.animate?.5*e+"s":"0s"}"
            fill='white'
            ...
            d=${this.fill[e]}
          />`:""}
    </mask>`}renderSvgAreaMinMaxMask(t,e){if("line"!==this.config.show.graph)return;if(!t)return;const s="fade"===this.config.show.fill,i=this.length[e]||!1===this._card.config.entities[e].show_line,a=this.Graph[e]._min>=0?0:Math.abs(this.Graph[e]._min)/(this.Graph[e]._max-this.Graph[e]._min)*100;return B`
    <defs>
      <linearGradient id=${`fill-grad-pos-${this.id}-${e}`} x1="0%" y1="0%" x2="0%" y2="100%">
        <stop stop-color='white' offset='0%' stop-opacity='1'/>
        <stop stop-color='white' offset='100%' stop-opacity='0.1'/>
    ...
    <mask id=${`fillMinMax-${this.id}-${e}`}>
      ...
      ${this.Graph[e]._min<0?B`<path class='fill'
            ...
            d=${this.fillMinMax[e]}
          />`:""}
    </mask>`}renderSvgLineMask(t,e){if(!t)return;const s=B`
    <path
      class='line'
      .id=${e}
  ...
  `}renderSvgLineMinMaxMask(t,e){if("line"!==this.config.show.graph)return;if(!t)return;const s=B`
    <path
      class='lineMinMax'
      .id=${e}
      anim=${this.config.animate} ?init=${this.length[e]}
  ...
  `}renderSvgPoints(t,e){if(!t)return;const s=this.computeColor(this._card.entities[e].state,e);return B`
    ...
    </g>`}renderSvgTrafficLight(t,e){let s;if(!0===this.config.square&&(s=Math.min(t.width,t.height),s<t.height)){let e=(this.svg.height-this.buckets.length*s)/(this.buckets.length-1);for(let i=0;i<this.buckets.length;i++)t.y[i]=this.svg.height-i*(s+e);t.height=s,t.width=s}const i=this.buckets.map(((e,s)=>{console.log("bgRect",e,s,t);const i=void 0!==t.value[s],a=i?this.classes.traffic_light_foreground:this.classes.traffic_light_background,o=i?this.styles.traffic_light_foreground:this.styles.traffic_light_background,r=i?this.computeColor(t.value[s]+.001,0):"var(--theme-sys-elevation-surface-neutral4)";return B`
    <rect class="${kt(a)}" style="${nt(o)}"
      x=${t.x+0+this.svg.line_width/2}
      y=${t.y[s]-1*t.height-this.svg.line_width/1e5}
      height=${Math.max(0,t.height-0-this.svg.line_width)}
      width=${Math.max(0,t.width-0-this.svg.line_width)}
    ...
    ${i}
    `}renderSvgTrafficLights(t,e){if(!t)return;const s=this.computeColor(this._card.entities[e].state,e),i=this.xLines.lines.map((t=>"below"===t.zpos?[B`
        ...
        `]:[""])),a=this.xLines.lines.map((t=>"above"===t.zpos?[B`
    ...
    <g class='traffic-lights'
      ...
      <linearGradient id=${`grad-${this.id}-${e}`} gradientTransform="rotate(90)">
        ...
        `))}
      </linearGradient>`}));return B`${e}`}renderSvgLineBackground(t,e){if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e);return B`
    <rect class='line--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`line-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#line-${this.id}-${e})`}
    />`}renderSvgLineMinMaxBackground(t,e){if("line"!==this.config.show.graph)return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e);return B`
    <rect class='line--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`line-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#lineMinMax-${this.id}-${e})`}
    />`}renderSvgAreaBackground(t,e){if("area"!==this.config.show.graph)return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e),i=this.xLines.lines.map((t=>"below"===t.zpos?[B`
          <line class=${kt(this.classes[t.id])}) style="${nt(this.styles[t.id])}"
          x1="${this.svg.margin.x}" y1="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
          x2="${this.svg.graph.width+this.svg.margin.x}" y2="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
          pathLength="240"
    ...
    />
    ${a}
    `}renderSvgAreaMinMaxBackground(t,e){if("line"!==this.config.show.graph)return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return B`
    <rect class='fill--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`fill-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#fillMinMax-${this.id}-${e})`}
    />`}renderSvgEqualizerMask(t,e){if("equalizer"!==this.config.show.graph)return;if(!t)return;const s="fade"===this.config.show.fill;this.id;const i=`url(#fill-grad-mask-pos-${this.id}-${e}})`,a=this.config.styles.bar_mask_below.fill,o=this.config.styles.bar_mask_above.fill;let r;if(!0===this.config.square&&(r=Math.min(t[0].width,t[0].height),r<t[0].height)){let e=(this.svg.height-this.config.value_buckets*r)/(this.config.value_buckets-1),s=t.map(((t,s)=>{let i={...t};for(let a=0;a<t.y.length;a++)i.y[a]=this.svg.height-a*(r+e);return i.width=r,i.height=r,i}));t=[...s]}const n=t.map(((t,i)=>{const n=t.value.map(((i,n)=>{const h=this.config.animate?B`
      ...
      <rect class='level'
        ...
        height=${Math.max(0,t.height-this.svg.line_width)}
        width=${Math.max(0,t.width-this.svg.line_width)}
  ...
  `}renderSvgBarsMask(t,e){if("bar"!==this.config.show.graph)return;if(!t)return;const s="fade"===this.config.show.fill;this.id;const i=`url(#fill-grad-mask-pos-${this.id}-${e}})`,a=this.config.styles.bar_mask_below.fill,o=this.config.styles.bar_mask_above.fill,r=t.map(((t,i)=>{const r=this.config.animate?B`
        <animate attributeName='y' from=${this.svg.height} to=${t.y} dur='1s' fill='remove'
          calcMode='spline' keyTimes='0; 1' keySplines='0.215 0.61 0.355 1'>
        </animate>`:"";return B` 

      <rect class='bar' x=${t.x} y=${t.y+(t.value>0?+this.svg.line_width/2:-this.svg.line_width/2)}
        height=${Math.max(0,t.height-this.svg.line_width/1-0)} width=${t.width}
        fill=${s?t.value>0?o:a:"white"}
        stroke=${s?t.value>0?o:a:"white"}
        stroke-width="${this.svg.line_width?this.svg.line_width:0}"
  ...
  `}renderSvgEqualizerBackground(t,e){if("equalizer"!==this.config.show.graph)return;if(!t)return;if("fadenever"===this.config.show.fill){this.length[e]||this._card.config.entities[e].show_line;const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return this.gradient[e]?this.id:this.intColor(this._card.entities[e].state,e),B`
      <defs>
      ...
      <g mask = ${`url(#fill-grad-mask-${this.id}-${e})`}>
        ...
        />
      /g>`}{const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e);return B`
      <rect class='equalizer--bg'
        ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
        id=${`equalizer-bg-${this.id}-${e}`}
        fill=${t} height="100%" width="100%"
        mask=${`url(#equalizer-bg-${this.id}-${e})`}
      />`}}renderSvgBarsBackground(t,e){if("bar"!==this.config.show.graph)return;if(!t)return;if("fadenever"===this.config.show.fill){this.length[e]||this._card.config.entities[e].show_line;const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return this.gradient[e]?this.id:this.intColor(this._card.entities[e].state,e),B`
      <defs>
        <linearGradient id=${`fill-grad-${this.id}-${e}`} x1="0%" y1="0%" x2="0%" y2="100%">
          <stop stop-color='white' offset='0%' stop-opacity='1'/>
          <stop stop-color='white' offset='100%' stop-opacity='.1'/>
      ...
      <rect class='bars--bg'
        ...
        fill=${t} height="100%" width="100%"
        mask=${`url(#bars-bg-${this.id}-${e})`}
      />`}}renderSvgBars(t,e){if(!t)return;const s=t.map(((t,s)=>{const i=this.config.animate?B`
        <animate attributeName='y' from=${this.svg.height} to=${t.y} dur='1s' fill='remove'
          calcMode='spline' keyTimes='0; 1' keySplines='0.215 0.61 0.355 1'>
        </animate>`:"",a=this.computeColor(t.value,e);return B` 
      <rect class='bar' x=${t.x} y=${t.y}
        height=${t.height} width=${t.width} fill=${a}
        @mouseover=${()=>this.setTooltip(e,s,t.value)}
        @mouseout=${()=>this.tooltip={}}>
        ${i}
      </rect>`}));return B`<g class='bars' ?anim=${this.config.animate}>${s}</g>`}renderSvgClockBin(t,e,s){const i=this.intColor(t.value,0);return B`
  <path class="${kt(this.classes.clock_graph)}"
    ...
    stroke=${i}
  >
  `}renderSvgClockBackground(t){const{start:e,end:s,start2:i,end2:a,largeArcFlag:o,sweepFlag:r}=this.Graph[0]._calcClockCoords(0,359.9,!0,t,t,this.clockWidth),n={x:t-this.clockWidth,y:t-this.clockWidth},h=["M",e.x,e.y,"A",t,t,0,o,r,s.x,s.y,"L",a.x,a.y,"A",n.x,n.y,0,o,"0"===r?"1":"0",i.x,i.y,"Z"].join(" ");return B`
    <path class="graph-clock--background"
      d="${h}"
      style="fill: var(--theme-sys-elevation-surface-neutral4); stroke-width: 0; opacity: 0.1;"
    />
  `}renderSvgClockFace(t){if(!this.config?.clock?.face)return B``;return B`
    ${(()=>!0===this.config.clock.face?.show_day_night?B`
          <circle pathLength="1"
          class="${kt(this.classes.clock_face_day_night)}" style="${nt(this.styles.clock_face_day_night)}"
          r="${this.svg.clockface.dayNightRadius}" cx=${this.svg.width/2} cy="${this.svg.height/2}"
          />
        `:"")()}
    ${(()=>!0===this.config.clock.face?.show_hour_marks?B`
        <circle pathLength=${this.config.clock.face.hour_marks_count}
        class="${kt(this.classes.clock_face_hour_marks)}" style="${nt(this.styles.clock_face_hour_marks)}"
        r="${this.svg.clockface.hourMarksRadius}" cx=${this.svg.width/2} cy="${this.svg.height/2}"
        />
       `:"")()}
    ${(()=>"absolute"===this.config.clock.face?.show_hour_numbers?B`
        <g>
          <text class="${kt(this.classes.clock_face_hour_numbers)}" style="${nt(this.styles.clock_face_hour_numbers)}"
    ...
    ${(()=>"relative"===this.config.clock.face?.show_hour_numbers?B`
        <g>
          <text class="${kt(this.classes.clock_face_hour_numbers)}" style="${nt(this.styles.clock_face_hour_numbers)}"
            x="${this.svg.width/2}" y="${this.svg.height/2-this.svg.clockface.hourNumbersRadius}"
            >0</text>
  ...
  `}renderSvgClock(t,e){if(!t)return;const s=this.Graph[e].getClockPaths();return B`
    <g class='graph-clock'
      ?tooltip=${this.tooltip.entity===e}
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      ?init=${this.length[e]}
      ...
      ${t.map(((t,e)=>this.renderSvgClockBin(t,s[e],e)))}
      ${this.renderSvgClockFace(this.svg.width/2-40)}
    </g>`}renderSvgTimeline(t,e){if(!t)return;const s=t.map(((t,s)=>{let i;if("bin"===this.config.y_axis?.use_value){const e=Math.floor(t.value);if(this.buckets[e]?.value){const s=this.buckets[e].value[0]+(this.buckets[e].rangeMax[0]-this.buckets[e].rangeMin[0])*(t.value-e);i=this.intColor(s,0)}else console.log("rendertimeline, illegal value",t.value)}else i=this.intColor(t.value,0);const a=this.config.animate?B`
        <animate attributeName='y' from=${this.svg.height} to=${t.y} dur='1s' fill='remove'
          calcMode='spline' keyTimes='0; 1' keySplines='0.215 0.61 0.355 1'>
        </animate>`:"";return B` 
      <rect class=${kt(this.classes.timeline_graph)}) style="${nt(this.styles.timeline_graph)}"
        x=${t.x} y=${t.y+(t.value>0?+this.svg.line_width/2:-this.svg.line_width/2)}
        height=${Math.max(1,t.height-this.svg.line_width)}
        width=${Math.max(t.width-this.svg.line_width,1)}
        fill=${i}
        stroke=${i}
        stroke-width="${this.svg.line_width?this.svg.line_width:0}"
        @mouseover=${()=>this.setTooltip(e,s,t.value)}
        @mouseout=${()=>this.tooltip={}}>
        ${a}
      </rect>`})),i=this.xLines.lines.map((t=>"below"===t.zpos?[B`
        <line class=${kt(this.classes[t.id])}) style="${nt(this.styles[t.id])}"
        x1="${this.svg.margin.x}" y1="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
        x2="${this.svg.graph.width+this.svg.margin.x}" y2="${this.svg.margin.y+this.svg.graph.height/2+t.yshift}"
        pathLength="240"
    ...
    ${s}
    ${a}
  `}renderSvg(){return this.svg.height,this.svg.margin.y,this.svg.width,this.svg.margin.x,this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),B`
  <svg width="${this.svg.width}" height="${this.svg.height}" overflow="visible"
    ...
    <g>
        ...
        ${this.fillMinMax.map(((t,e)=>this.renderSvgAreaMinMaxMask(t,e)))}
        ${this.fillMinMax.map(((t,e)=>this.renderSvgAreaMinMaxBackground(t,e)))}
        ...
        ${this.clock.map(((t,e)=>this.renderSvgClock(t,e)))}
    ...
    `}}class Pe extends Ct{constructor(t,e,s){super(t,yt.mergeDeep({position:{cx:50,cy:50,radius:50,side_count:6,side_skip:1,angle_offset:0},classes:{tool:{"sak-polygon":!0,hover:!0},regpoly:{"sak-polygon__regpoly":!0}},styles:{tool:{},regpoly:{}}},e),s),this.svg.radius=bt.calculateSvgDimension(e.position.radius),this.classes.regpoly={},this.styles.regpoly={},this.dev.debug&&console.log("RegPolyTool constructor config, svg",this.toolId,this.config,this.svg)}set value(t){super.value=t}_renderRegPoly(){return this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.regpoly),B`
    ...
    `}}class ze extends Ct{constructor(t,e,s){super(t,yt.mergeDeep({classes:{tool:{"sak-text":!0},text:{"sak-text__text":!0,hover:!1}},styles:{tool:{},text:{}}},e),s),this.EnableHoverForInteraction(),this.text=this.config.text,this.classes.tool={},this.classes.text={},this.styles.tool={},this.styles.text={},this.dev.debug&&console.log("TextTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}_renderText(){return this.MergeAnimationClassIfChanged(),this.MergeColorFromState(this.styles.text),this.MergeAnimationStyleIfChanged(),B`
        <text>
 ...
 */var Be=/; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g,Ge=/\\([\u000b\u0020-\u00ff])/g,Ue=/^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/,je=function(t){if(!t)throw new TypeError("argument string is required");var e="object"==typeof t?function(t){var e;"function"==typeof t.getHeader?e=t.getHeader("content-type"):"object"==typeof t.headers&&(e=t.headers&&t.headers["content-type"]);if("string"!=typeof e)throw new TypeError("content-type header is missing from object");return e}(t):t;if("string"!=typeof e)throw new TypeError("argument string is required to be a string");var s=e.indexOf(";"),i=-1!==s?e.slice(0,s).trim():e.trim();if(!Ue.test(i))throw new TypeError("invalid media type");var a=new qe(i.toLowerCase());if(-1!==s){var o,r,n;for(Be.lastIndex=s;r=Be.exec(e);){if(r.index!==s)throw new TypeError("invalid parameter format");s+=r[0].length,o=r[1].toLowerCase(),34===(n=r[2]).charCodeAt(0)&&-1!==(n=n.slice(1,-1)).indexOf("\\")&&(n=n.replace(Ge,"$1")),a.parameters[o]=n}if(s!==e.length)throw new TypeError("invalid parameter format")}return a};function qe(t){this.parameters=Object.create(null),this.type=t}var He=new Map,We=function(t){return t.cloneNode(!0)},Ye=function(){return"file:"===window.location.protocol},Je=function(t,e,s){var i=new XMLHttpRequest;i.onreadystatechange=function(){try{if(!/\.svg/i.test(t)&&2===i.readyState){var e=i.getResponseHeader("Content-Type");if(!e)throw new Error("Content type not found");var a=je(e).type;if("image/svg+xml"!==a&&"text/plain"!==a)throw new Error("Invalid content type: ".concat(a))}if(4===i.readyState){if(404===i.status||null===i.responseXML)throw new Error(Ye()?"Note: SVG injection ajax calls do not work locally without adjusting security settings in your browser. Or consider using a local webserver.":"Unable to load SVG file: "+t);if(!(200===i.status||Ye()&&0===i.status))throw new Error("There was a problem injecting the SVG: "+i.status+" "+i.statusText);s(null,i)}}catch(o){if(i.abort(),!(o instanceof Error))throw o;s(o,i)}},i.open("GET",t),i.withCredentials=e,i.overrideMimeType&&i.overrideMimeType("text/xml"),i.send()},Xe={},Ze=function(t,e){Xe[t]=Xe[t]||[],Xe[t].push(e)},Ke=function(t,e,s){if(He.has(t)){var i=He.get(t);if(void 0===i)return void Ze(t,s);if(i instanceof SVGSVGElement)return void s(null,We(i))}He.set(t,void 0),Ze(t,s),Je(t,e,(function(e,s){var i;e?He.set(t,e):(null===(i=s.responseXML)||void 0===i?void 0:i.documentElement)instanceof SVGSVGElement&&He.set(t,s.responseXML.documentElement),function(t){for(var e=function(e,s){setTimeout((function(){if(Array.isArray(Xe[t])){var s=He.get(t),i=Xe[t][e];s instanceof SVGSVGElement&&i(null,We(s)),s instanceof Error&&i(s),e===Xe[t].length-1&&delete Xe[t]}}),0)},s=0,i=Xe[t].length;s<i;s++)e(s)}(t)}))},Qe=function(t,e,s){Je(t,e,(function(t,e){var i;t?s(t):(null===(i=e.responseXML)||void 0===i?void 0:i.documentElement)instanceof SVGSVGElement&&s(null,e.responseXML.documentElement)}))},ts=0,es=[],ss={},is="http://www.w3.org/1999/xlink",as=function(t,e,s,i,a,o,r){var n=t.getAttribute("data-src")||t.getAttribute("src");if(n){if(-1!==es.indexOf(t))return es.splice(es.indexOf(t),1),void(t=null);es.push(t),t.setAttribute("src",""),(i?Ke:Qe)(n,a,(function(i,a){if(!a)return es.splice(es.indexOf(t),1),t=null,void r(i);var h=t.getAttribute("id");h&&a.setAttribute("id",h);var l=t.getAttribute("title");l&&a.setAttribute("title",l);var c=t.getAttribute("width");c&&a.setAttribute("width",c);var d=t.getAttribute("height");d&&a.setAttribute("height",d);var g=Array.from(new Set(Fe(Fe(Fe([],(a.getAttribute("class")||"").split(" "),!0),["injected-svg"],!1),(t.getAttribute("class")||"").split(" "),!0))).join(" ").trim();a.setAttribute("class",g);var u=t.getAttribute("style");u&&a.setAttribute("style",u),a.setAttribute("data-src",n);var m=[].filter.call(t.attributes,(function(t){return/^data-\w[\w-]*$/.test(t.name)}));if(Array.prototype.forEach.call(m,(function(t){t.name&&t.value&&a.setAttribute(t.name,t.value)})),s){var p,f,v,_,y,b={clipPath:["clip-path"],"color-profile":["color-profile"],cursor:["cursor"],filter:["filter"],linearGradient:["fill","stroke"],marker:["marker","marker-start","marker-mid","marker-end"],mask:["mask"],path:[],pattern:["fill","stroke"],radialGradient:["fill","stroke"]};Object.keys(b).forEach((function(t){p=t,v=b[t];for(var e=function(t,e){var s;_=f[t].id,y=_+"-"+ ++ts,Array.prototype.forEach.call(v,(function(t){for(var e=0,i=(s=a.querySelectorAll("["+t+'*="'+_+'"]')).length;e<i;e++){var o=s[e].getAttribute(t);o&&!o.match(new RegExp('url\\("?#'+_+'"?\\)'))||s[e].setAttribute(t,"url(#"+y+")")}}));for(var i=a.querySelectorAll("[*|href]"),o=[],r=0,n=i.length;r<n;r++){var h=i[r].getAttributeNS(is,"href");h&&h.toString()==="#"+f[t].id&&o.push(i[r])}for(var l=0,c=o.length;l<c;l++)o[l].setAttributeNS(is,"href","#"+y);f[t].id=y},s=0,i=(f=a.querySelectorAll(p+"[id]")).length;s<i;s++)e(s)}))}a.removeAttribute("xmlns:a");for(var x,w,$=a.querySelectorAll("script"),k=[],S=0,M=$.length;S<M;S++)(w=$[S].getAttribute("type"))&&"application/ecmascript"!==w&&"application/javascript"!==w&&"text/javascript"!==w||((x=$[S].innerText||$[S].textContent)&&k.push(x),a.removeChild($[S]));if(k.length>0&&("always"===e||"once"===e&&!ss[n])){for(var C=0,E=k.length;C<E;C++)new Function(k[C])(window);ss[n]=!0}var T=a.querySelectorAll("style");if(Array.prototype.forEach.call(T,(function(t){t.textContent+=""})),a.setAttribute("xmlns","http://www.w3.org/2000/svg"),a.setAttribute("xmlns:xlink",is),o(a),!t.parentNode)return es.splice(es.indexOf(t),1),t=null,void r(new Error("Parent node is null"));t.parentNode.replaceChild(a,t),es.splice(es.indexOf(t),1),t=null,r(null,a)}))}else r(new Error("Invalid data-src or src attribute"))};class os extends Ct{constructor(t,e,s){if(super(t,yt.mergeDeep({position:{cx:50,cy:50,height:50,width:50},options:{svginject:!0},styles:{usersvg:{},mask:{fill:"white"}}},e),s),this.images={},this.images=Object.assign({},...this.config.images),this.item={},this.item.image="default",this.imageCur="none",this.imagePrev="none",this.classes={},this.classes.tool={},this.classes.usersvg={},this.classes.mask={},this.styles={},this.styles.tool={},this.styles.usersvg={},this.styles.mask={},this.injector={},this.injector.svg=null,this.injector.cache=[],this.clipPath={},this.config.clip_path){this.svg.cp_cx=bt.calculateSvgCoordinate(this.config.clip_path.position.cx||this.config.position.cx,0),this.svg.cp_cy=bt.calculateSvgCoordinate(this.config.clip_path.position.cy||this.config.position.cy,0),this.svg.cp_height=bt.calculateSvgDimension(this.config.clip_path.position.height||this.config.position.height),this.svg.cp_width=bt.calculateSvgDimension(this.config.clip_path.position.width||this.config.position.width);const t=Math.min(this.svg.cp_height,this.svg.cp_width)/2;this.svg.radiusTopLeft=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.top_left||this.config.clip_path.position.radius.left||this.config.clip_path.position.radius.top||this.config.clip_path.position.radius.all)))||0,this.svg.radiusTopRight=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.top_right||this.config.clip_path.position.radius.right||this.config.clip_path.position.radius.top||this.config.clip_path.position.radius.all)))||0,this.svg.radiusBottomLeft=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.bottom_left||this.config.clip_path.position.radius.left||this.config.clip_path.position.radius.bottom||this.config.clip_path.position.radius.all)))||0,this.svg.radiusBottomRight=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.bottom_right||this.config.clip_path.position.radius.right||this.config.clip_path.position.radius.bottom||this.config.clip_path.position.radius.all)))||0}this.dev.debug&&console.log("UserSvgTool constructor config, svg",this.toolId,this.config,this.svg)}set value(t){super.value=t}updated(t){var e=this;this.config.options.svginject&&!this.injector.cache[this.imageCur]&&(this.injector.elementsToInject=this._card.shadowRoot.getElementById("usersvg-".concat(this.toolId)).querySelectorAll("svg[data-src]:not(.injected-svg)"),0!==this.injector.elementsToInject.length&&function(t,e){var s=void 0===e?{}:e,i=s.afterAll,a=void 0===i?function(){}:i,o=s.afterEach,r=void 0===o?function(){}:o,n=s.beforeEach,h=void 0===n?function(){}:n,l=s.cacheRequests,c=void 0===l||l,d=s.evalScripts,g=void 0===d?"never":d,u=s.httpRequestWithCredentials,m=void 0!==u&&u,p=s.renumerateIRIElements,f=void 0===p||p;if(t&&"length"in t)for(var v=0,_=0,y=t.length;_<y;_++)as(t[_],g,f,c,m,h,(function(e,s){r(e,s),t&&"length"in t&&t.length===++v&&a(v)}));else t?as(t,g,f,c,m,h,(function(e,s){r(e,s),a(1),t=null})):a(0)}(this.injector.elementsToInject,{afterAll(t){setTimeout((()=>{e._card.requestUpdate()}),0)},afterEach(t,s){if(t)throw e.injector.error=t,e.config.options.svginject=!1,t;e.injector.error="",e.injector.cache[e.imageCur]=s},beforeEach(t){t.removeAttribute("height"),t.removeAttribute("width")},cacheRequests:!1,evalScripts:"once",httpRequestWithCredentials:!1,renumerateIRIElements:!1}))}_renderUserSvg(){this.MergeAnimationStyleIfChanged();const t=xt.getJsTemplateOrValue(this,this._stateValue,yt.mergeDeep(this.images));if(this.imagePrev=this.imageCur,this.imageCur=t[this.item.image],"none"===t[this.item.image])return B``;let e=this.injector.cache[this.imageCur],s=B``,i="",a="";this.config.clip_path&&(i=`url(#clip-path-${this.toolId})`,a=`url(#mask-${this.toolId})`,s=B`
        ...
        `);const o=t[this.item.image].lastIndexOf(".");return"svg"!==t[this.item.image].substring(-1===o?1/0:o+1)?B`
    ...
    `}_renderCardAttributes(){let t;const e=[];this._attributes="";for(let s=0;s<this.entities.length;s++)t=this.attributesStr[s]?this.attributesStr[s]:this.secondaryInfoStr[s]?this.secondaryInfoStr[s]:this.entitiesStr[s],e.push(t);return this._attributes=e,e}_renderSvg(){const t=this.config.card_filter?this.config.card_filter:"card--filter-none",e=[];this._renderCardAttributes();const s=this._RenderToolsets();return e.push(B`
      ...
      </svg>`),B`${e}`}_buildUom(t,e,s){return t?.unit||s?.unit||e?.attributes.unit_of_measurement||""}toLocale(t,e="unknown"){const s=this._hass.selectedLanguage||this._hass.language,i=this._hass.resources[s];return i&&i[t]?i[t]:e}_buildStateString(t,e){if(void 0===t)return t;if(e.convert){let s,i,a=e.convert.match(/(^\w+)\((\d+)\)/);switch(null===a?s=e.convert:3===a.length&&(s=a[1],i=Number(a[2])),s){case"brightness_pct":t="undefined"===t?"undefined":`${Math.round(t/255*100)}`;break;case"multiply":t=`${Math.round(t*i)}`;break;case"divide":t=`${Math.round(t/i)}`;break;case"rgb_csv":case"rgb_hex":if(e.attribute){let i=this._hass.states[e.entity];switch(i.attributes.color_mode){case"unknown":case"onoff":case"brightness":case"white":break;case"color_temp":if(i.attributes.color_temp_kelvin){let e=fs(i.attributes.color_temp_kelvin);const a=ls(e);a[1]<.4&&(a[1]<.1?a[2]=225:a[1]=.4),e=cs(a),e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:hs(e)}else t="rgb_csv"===s?"255,255,255":"#ffffff00";break;case"hs":{let e=ds([i.attributes.hs_color[0],i.attributes.hs_color[1]/100]);e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:hs(e)}break;case"rgb":{const e=ls(this.stateObj.attributes.rgb_color);e[1]<.4&&(e[1]<.1?e[2]=225:e[1]=.4);const i=cs(e);t="rgb_csv"===s?i.toString():hs(i)}break;case"rgbw":{let e=(t=>{const[e,s,i,a]=t;return vs([e,s,i,a],[e+a,s+a,i+a])})(i.attributes.rgbw_color);e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:hs(e)}break;case"rgbww":{let e=ys(i.attributes.rgbww_color,i.attributes?.min_color_temp_kelvin,i.attributes?.max_color_temp_kelvin);e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:hs(e)}break;case"xy":if(i.attributes.hs_color){let e=ds([i.attributes.hs_color[0],i.attributes.hs_color[1]/100]);const a=ls(e);a[1]<.4&&(a[1]<.1?a[2]=225:a[1]=.4),e=cs(a),e[0]=Math.round(e[0]),e[1]=Math.round(e[1]),e[2]=Math.round(e[2]),t="rgb_csv"===s?`${e[0]},${e[1]},${e[2]}`:hs(e)}else if(i.attributes.color){let e={};e.l=i.attributes.brightness,e.h=i.attributes.color.h||i.attributes.color.hue,e.s=i.attributes.color.s||i.attributes.color.saturation;let{r:a,g:o,b:r}=Mt.hslToRgb(e);if("rgb_csv"===s)t=`${a},${o},${r}`;else{t=`#${Mt.padZero(a.toString(16))}${Mt.padZero(o.toString(16))}${Mt.padZero(r.toString(16))}`}}else i.attributes.xy_color}}break;default:console.error(`Unknown converter [${s}] specified for entity [${e.entity}]!`)}}return void 0!==t?Number.isNaN(t)?t:t.toString():void 0}_computeEntity(t){return t.substr(t.indexOf(".")+1)}updateOnInterval(){this._hass?(this.updateData(),this.entityHistory.needed?(window.clearInterval(this.interval),this.interval=setInterval((()=>this.updateOnInterval()),1e3*this.entityHistory.update_interval)):this.interval&&(window.clearInterval(this.interval),this.interval=0)):this.dev.debug&&console.log("UpdateOnInterval - NO hass, returning")}async fetchRecent(t,e,s,i){let a="history/period";return e&&(a+=`/${e.toISOString()}`),a+=`?filter_entity_id=${t}`,s&&(a+=`&end_time=${s.toISOString()}`),i&&(a+="&skip_initial_state"),a+="&minimal_response",this._hass.callApi("GET",a)}async updateData(){this.entityHistory.updating=!0,this.dev.debug&&console.log("card::updateData - ENTRY",this.cardId);const t=[];let e=0;this.toolsets.map(((s,i)=>(s.tools.map(((s,a)=>{if("bar"===s.type||"graph"===s.type){const o=new Date,r=new Date;"yesterday"===s.tool.config.x_axis?.start_on?(r.setHours(0,0,0,0),r.setHours(r.getHours()-24),o.setHours(0,0,0,0),console.log("updateData, yesterday, setting hours",r,o)):"today"===s.tool.config.today||"today"===s.tool.config.x_axis?.start_on?r.setHours(0,0,0,0):r.setHours(o.getHours()-(s.tool.config.x_axis?.hours_to_show||s.tool.config.hours));const n=this.config.entities[s.tool.config.entity_index].attribute?this.config.entities[s.tool.config.entity_index].attribute:null;t[e]={tsidx:i,entityIndex:s.tool.config.entity_index,entityId:this.entities[s.tool.config.entity_index].entity_id,attrId:n,start:r,end:o,type:s.type,idx:a},e+=1}return!0})),!0))),this.dev.debug&&console.log("card::updateData - LENGTH",this.cardId,t.length,t),this.stateChanged=!1,this.dev.debug&&console.log("card::updateData, entityList from tools",t);try{const e=t.map(((t,e)=>this.updateEntity(t,e,t.start,t.end)));await Promise.all(e)}finally{this.entityHistory.updating=!1}this.entityHistory.updating=!1}async updateEntity(t,e,s,i){let a=[];const o=s;let r,n=await this.fetchRecent(t.entityId,o,i,!1);"graph"===t.type&&this.toolsets[t.tsidx].tools[t.idx].tool.processStateMap(n),n[0]&&n[0].length>0&&(t.attrId&&(r=this.entities[t.entityIndex].attributes[this.config.entities[t.entityIndex].attribute],t.state=r),n=n[0].filter((e=>t.attrId?!isNaN(parseFloat(e.attributes[t.attrId])):!isNaN(parseFloat(e.state)))),n=n.map((e=>({last_changed:e.last_changed,state:t.attrId?Number(e.attributes[t.attrId]):Number(e.state)})))),a=[...a,...n],"graph"===t.type?(this.toolsets[t.tsidx].tools[t.idx].tool.data=t.entityIndex,this.toolsets[t.tsidx].tools[t.idx].tool.series=[...a],this.requestUpdate()):this.uppdate(t,a)}uppdate(t,e){if(!e)return;const s=(new Date).getTime();let i=24,a=2;"bar"!==t.type&&"graph"!==t.type||(this.dev.debug&&console.log("entity.type == bar",t),i=this.toolsets[t.tsidx].tools[t.idx].tool.config.hours,a=this.toolsets[t.tsidx].tools[t.idx].tool.config.barhours);const o=e.reduce(((t,e)=>((t,e)=>{const o=(s-new Date(e.last_changed).getTime())/36e5/a-i/a,r=Math.floor(Math.abs(o));return t[r]||(t[r]=[]),t[r].push(e),t})(t,e)),[]);if(o.length=Math.ceil(i/a),0===Object.keys(o).length)return;const r=Object.keys(o)[0];"0"!==r&&(o[0]=[],o[0].push(o[r][0]));for(let h=0;h<i/a;h++)o[h]||(o[h]=[],o[h].push(o[h-1][o[h-1].length-1]));this.coords=o;let n=[];n=[],n=o.map((t=>{return s="state",(e=t).reduce(((t,e)=>t+Number(e[s])),0)/e.length;var e,s})),["bar"].includes(t.type)&&(this.toolsets[t.tsidx].tools[t.idx].tool.series=[...n]),this.requestUpdate()}getCardSize(){return 4}}customElements.define("swiss-army-knife-card",bs);
