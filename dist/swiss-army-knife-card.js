...
%c     Version 1.0.0-rc1     `,"color: yellow; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray","color: white; font-weight: bold; background: dimgray");const SCALE_DIMENSIONS=2,SVG_DEFAULT_DIMENSIONS=200*SCALE_DIMENSIONS,SVG_DEFAULT_DIMENSIONS_HALF=SVG_DEFAULT_DIMENSIONS/2,SVG_VIEW_BOX=SVG_DEFAULT_DIMENSIONS,FONT_SIZE=SVG_DEFAULT_DIMENSIONS/100;class Merge{static mergeDeep(...t){const a=t=>t&&"object"==typeof t;return t.reduce((i,o)=>(Object.keys(o).forEach(t=>{const s=i[t];var e=o[t];Array.isArray(s)&&Array.isArray(e)?i[t]=s.concat(...e):a(s)&&a(e)?i[t]=this.mergeDeep(s,e):i[t]=e}),i),{})}}class Utils{static calculateValueBetween(t,s,e){return!isNaN(e)&&e?(Math.min(Math.max(e,t),s)-t)/(s-t):0}static calculateSvgCoordinate(t,s){return t/100*SVG_DEFAULT_DIMENSIONS+(s-SVG_DEFAULT_DIMENSIONS_HALF)}static calculateSvgDimension(t){return t/100*SVG_DEFAULT_DIMENSIONS}}class Templates{static replaceVariables3(t,s){if(!t&&!s.template.defaults)return s[s.template.type];let e=t?.slice(0)??[],o=(s.template.defaults&&(e=e.concat(s.template.defaults)),JSON.stringify(s[s.template.type]));return e.forEach(t=>{var s,e,i=Object.keys(t)[0];"number"!=typeof(t=Object.values(t)[0])&&"boolean"!=typeof t||(e=new RegExp(`"\\[\\[${i}\\]\\]"`,"gm"),o=o.replace(e,t)),o="object"==typeof t?(e=new RegExp(`"\\[\\[${i}\\]\\]"`,"gm"),s=JSON.stringify(t),o.replace(e,s)):(e=new RegExp(`\\[\\[${i}\\]\\]`,"gm"),o.replace(e,t))}),JSON.parse(o)}static evaluateJsTemplate(t,s,e){try{return new Function("state","states","entity","user","hass","config","'use strict'; "+e).call(this,s,t._card._hass.states,t.config.entity_index?t._card.entities[t.config.entity_index]:void 0,t._card._hass.user,t._card._hass,t.config)}catch(t){throw t.name="Sak-evaluateJsTemplate-Error",t}}static getJsTemplateOrValue(s,e,i){if(!i)return i;if(["number","boolean","bigint","symbol"].includes(typeof i))return i;if("object"==typeof i)return Object.keys(i).forEach(t=>{i[t]=Templates.getJsTemplateOrValue(s,e,i[t])}),i;const t=i.trim();return"[[["===t.substring(0,3)&&"]]]"===t.slice(-3)?Templates.evaluateJsTemplate(s,e,t.slice(3,-3)):i}}class Toolset{constructor(t,s){this.toolsetId=Math.random().toString(36).substr(2,9),this._card=t,this.dev={...this._card.dev},this.dev.performance&&console.time("--\x3e "+this.toolsetId+" PERFORMANCE Toolset::constructor"),this.config=s,this.tools=[],this.svg={},this.svg.cx=Utils.calculateSvgCoordinate(s.position.cx,SVG_DEFAULT_DIMENSIONS_HALF),this.svg.cy=Utils.calculateSvgCoordinate(s.position.cy,SVG_DEFAULT_DIMENSIONS_HALF),this.svg.x=this.svg.cx-SVG_DEFAULT_DIMENSIONS_HALF,this.svg.y=this.svg.cy-SVG_DEFAULT_DIMENSIONS_HALF,this.transform={},this.transform.scale={},this.transform.scale.x=this.transform.scale.y=1,this.transform.rotate={},this.transform.rotate.x=this.transform.rotate.y=0,this.transform.skew={},this.transform.skew.x=this.transform.skew.y=0,this.config.position.scale&&(this.transform.scale.x=this.transform.scale.y=this.config.position.scale),this.config.position.rotate&&(this.transform.rotate.x=this.transform.rotate.y=this.config.position.rotate),this.transform.scale.x=this.config.position.scale_x||this.config.position.scale||1,this.transform.scale.y=this.config.position.scale_y||this.config.position.scale||1,this.transform.rotate.x=this.config.position.rotate_x||this.config.position.rotate||0,this.transform.rotate.y=this.config.position.rotate_y||this.config.position.rotate||0,this.dev.debug&&console.log("Toolset::constructor config/svg",this.toolsetId,this.config,this.svg);const i={area:EntityAreaTool,badge:BadgeTool,bar:SparklineBarChartTool,circle:CircleTool,ellipse:EllipseTool,horseshoe:HorseshoeTool,icon:EntityIconTool,line:LineTool,name:EntityNameTool,rectangle:RectangleTool,rectex:RectangleToolEx,regpoly:RegPolyTool,segarc:SegmentedArcTool,state:EntityStateTool,slider:RangeSliderTool,switch:SwitchTool,text:TextTool,usersvg:UserSvgTool};this.config.tools.map(t=>{var s={...t},e={cx:0*SVG_DEFAULT_DIMENSIONS,cy:0*SVG_DEFAULT_DIMENSIONS,scale:this.config.position.scale||1},s=(this.dev.debug&&console.log("Toolset::constructor toolConfig",this.toolsetId,s,e),new i[t.type](this,s,e));this._card.entityHistory.needed|="bar"==t.type,this.tools.push({type:t.type,index:t.id,tool:s})}),this.dev.performance&&console.timeEnd("--\x3e "+this.toolsetId+" PERFORMANCE Toolset::constructor")}updateValues(){this.dev.performance&&console.time("--\x3e "+this.toolsetId+" PERFORMANCE Toolset::updateValues"),this.tools&&this.tools.map((s,t)=>{if(s.tool.config.hasOwnProperty("entity_index")&&(this.dev.debug&&console.log("Toolset::updateValues",s,t),s.tool.value=this._card.attributesStr[s.tool.config.entity_index]||this._card.secondaryInfoStr[s.tool.config.entity_index]||this._card.entitiesStr[s.tool.config.entity_index]),s.tool.config.hasOwnProperty("entity_indexes")){var e={};for(let t=0;t<s.tool.config.entity_indexes.length;++t)e[t]=this._card.attributesStr[s.tool.config.entity_indexes[t]]||this._card.secondaryInfoStr[s.tool.config.entity_indexes[t]]||this._card.entitiesStr[s.tool.config.entity_indexes[t]];s.tool.values=e}}),this.dev.performance&&console.timeEnd("--\x3e "+this.toolsetId+" PERFORMANCE Toolset::updateValues")}connectedCallback(){this.dev.performance&&console.time("--\x3e "+this.toolsetId+" PERFORMANCE Toolset::connectedCallback"),this.dev.debug&&console.log("*****Event - connectedCallback",this.toolsetId,(new Date).getTime()),this.dev.performance&&console.timeEnd("--\x3e "+this.toolsetId+" PERFORMANCE Toolset::connectedCallback")}disconnectedCallback(){this.dev.performance&&console.time("--\x3e "+this.cardId+" PERFORMANCE Toolset::disconnectedCallback"),this.dev.debug&&console.log("*****Event - disconnectedCallback",this.toolsetId,(new Date).getTime()),this.dev.performance&&console.timeEnd("--\x3e "+this.cardId+" PERFORMANCE Toolset::disconnectedCallback")}firstUpdated(e){this.dev.debug&&console.log("*****Event - Toolset::firstUpdated",this.toolsetId,(new Date).getTime()),this.tools&&this.tools.map((t,s)=>{"segarc"==t.type&&(this.dev.debug&&console.log("Toolset::firstUpdated - calling SegmentedArcTool firstUpdated"),t.tool.firstUpdated(e)),"slider"==t.type&&(this.dev.debug&&console.log("Toolset::firstUpdated - calling Slider firstUpdated"),t.tool.firstUpdated(e)),"slider2"==t.type&&(this.dev.debug&&console.log("Toolset::firstUpdated - calling Slider firstUpdated"),t.tool.firstUpdated(e)),"icon"==t.type&&(this.dev.debug&&console.log("Toolset::firstUpdated - calling Icon firstUpdated"),t.tool.firstUpdated(e)),"state"==t.type&&(this.dev.debug&&console.log("Toolset::firstUpdated - calling State firstUpdated"),t.tool.firstUpdated(e))})}updated(e){this.dev.debug&&console.log("*****Event - Updated",this.toolsetId,(new Date).getTime()),this.tools&&this.tools.map((t,s)=>{"state"==t.type&&(this.dev.debug&&console.log("Toolset::updated - calling State firstUpdated"),t.tool.updated(e)),"usersvg"==t.type&&(this.dev.debug&&console.log("Toolset::updated - calling Usersvg firstUpdated"),t.tool.updated(e))})}renderToolset(){this.dev.debug&&console.log("*****Event - renderToolset",this.toolsetId,(new Date).getTime());var t=this.tools.map(t=>svg`
      ...
      <text id="rs-label">
        ...
        `:"position"!=this.config.position.label.placement||t?void 0:svg`
          ...
          `}this.svg.thumb.cx=t,this.svg.thumb.cy=s;const i=[];return i.push(svg`
        ...
        <foreignObject width="0px" height="0px" x="${this.svg.xpx}" y="${this.svg.ypx}" overflow="visible">
          <body>
            <div class="div__icon, hover" xmlns="http://www.w3.org/1999/xhtml"
                ...
                <ha-icon icon=${t} id="icon-${this.toolId}" class="${classMap(this.classes.icon)}"
    ...
    `}_renderScale(){if(this._segmentedArcScale)return this._segmentedArcScale.render()}_renderSegments(){if(this.skipOriginal){var g,d,s,u=this.svg.width,v=this.svg.radiusX,m=this.svg.radiusY,t=(this.dev.debug&&console.log("RENDERNEW - IN _arcId, firstUpdatedCalled",this._arcId,this._firstUpdatedCalled),Utils.calculateValueBetween(this.config.scale.min,this.config.scale.max,this._stateValue)),e=Utils.calculateValueBetween(this.config.scale.min,this.config.scale.max,this._stateValuePrev),i=(this.dev.debug&&!this._stateValuePrev&&console.log("*****UNDEFINED",this._stateValue,this._stateValuePrev,e),t!=e&&this.dev.debug&&console.log("RENDERNEW _renderSegments diff value old new",this.toolId,e,t),t=t*this._arc.size*this._arc.direction+this.config.position.start_angle,e=e*this._arc.size*this._arc.direction+this.config.position.start_angle,[]);if(!this.config.isScale)for(var o=0;o<this._segmentAngles.length;o++)g=this.buildArcPath(this._segmentAngles[o].drawStart,this._segmentAngles[o].drawEnd,this._arc.clockwise,this.svg.radiusX,this.svg.radiusY,this.svg.width),i.push(svg`<path id="arc-segment-bg-${this.toolId}-${o}" class="sak-segarc__background"
                              style="${styleMap(this.config.styles.background)}"
                              d="${g}"
                              />`);if(this._firstUpdatedCalled)return this.dev.debug&&console.log("RENDERNEW _arcId DOES exist",this._arcId,this.toolId,this._firstUpdatedCalled),this._cache.forEach((t,s)=>{g=t,this.config.isScale&&(t=this.config.color,"colorlist"==this.config.show.style&&(t=this.config.segments.colorlist.colors[s]),"colorstops"==this.config.show.style&&(t=this._segments.colorStops[this._segments.sortedStops[s]]),this.styles.foreground[s]||(this.styles.foreground[s]=Merge.mergeDeep(this.config.styles.foreground)),this.styles.foreground[s].fill=t),i.push(svg`<path id="arc-segment-${this.toolId}-${s}" class="sak-segarc__foreground"
                            style="${styleMap(this.styles.foreground[s])}"
                            d="${g}"
                            />`)}),d={},1==(s=this)._card.connected&&this._renderTo!=this._stateValue&&(this._renderTo=this._stateValue,this.rAFid&&cancelAnimationFrame(this.rAFid),d.fromAngle=e,d.toAngle=t,d.runningAngle=e,d.duration=Math.min(Math.max(this._initialDraw?100:500,this._initialDraw?16:1e3*this.config.animation.duration),5e3),d.startTime=null,this.dev.debug&&console.log("RENDERNEW - tween",this.toolId,d),this.rAFid=requestAnimationFrame(function(t){!function s(t,e){var t=t||(new Date).getTime(),t=(d.startTime||(d.startTime=t,d.runningAngle=d.fromAngle),e.debug&&console.log("RENDERNEW - in animateSegmentsNEW",e.toolId,d),t-d.startTime),i=(d.progress=Math.min(t/d.duration,1),d.progress=(t=d.progress,Math.pow(--t,5)+1),e._arc.clockwise?d.toAngle>d.fromAngle:d.fromAngle>d.toAngle);d.frameAngle=d.fromAngle+(d.toAngle-d.fromAngle)*d.progress,-1==e._segmentAngles.findIndex((t,s)=>e._arc.clockwise?d.frameAngle<=t.boundsEnd&&d.frameAngle>=t.boundsStart:d.frameAngle<=t.boundsStart&&d.frameAngle>=t.boundsEnd)&&console.log("RENDERNEW animateSegments frameAngle not found",d,e._segmentAngles),c=e._segmentAngles.findIndex((t,s)=>e._arc.clockwise?d.runningAngle<=t.boundsEnd&&d.runningAngle>=t.boundsStart:d.runningAngle<=t.boundsStart&&d.runningAngle>=t.boundsEnd);do{var o=e._segmentAngles[c].drawStart,a=e._arc.clockwise?Math.min(e._segmentAngles[c].boundsEnd,d.frameAngle):Math.max(e._segmentAngles[c].boundsEnd,d.frameAngle),r=e._arc.clockwise?Math.min(e._segmentAngles[c].drawEnd,d.frameAngle):Math.max(e._segmentAngles[c].drawEnd,d.frameAngle);g=e.buildArcPath(o,r,e._arc.clockwise,v,m,u),e.myarc||(e.myarc={}),e.as||(e.as={});let t;if(o="arc-segment-".concat(e.toolId).concat("-").concat(c),e.as[c]||(e.as[c]=e._card.shadowRoot.getElementById(o)),t=e.as[c],e.myarc[c]=o,t&&(t.setAttribute("d",g),"colorlist"==e.config.show.style&&(t.style.fill=e.config.segments.colorlist.colors[c],e.styles.foreground[c].fill=e.config.segments.colorlist.colors[c]),e.config.show.lastcolor)){var r=e._arc.clockwise?e._segmentAngles[c].drawStart:e._segmentAngles[c].drawEnd,o=e._arc.clockwise?e._segmentAngles[c].drawEnd:e._segmentAngles[c].drawStart,o=Math.min(Math.max(0,(a-r)/(o-r)),1),n=e._card._getGradientValue(e._segments.colorStops[e._segments.sortedStops[c]],e._segments.colorStops[e._segments.sortedStops[c+1]],o);if(e.styles.foreground[0].fill=n,e.as[0].style.fill=n,0<c)for(var h=c+1;h--;)e.styles.foreground[h].fill!=n&&(e.styles.foreground[h].fill=n,e.as[h].style.fill=n),e.styles.foreground[h].fill=n,e.as[h].style.fill=n}e._cache[c]=g,d.frameAngle!=a&&(a+=1e-6*e._arc.direction);var l=c,c=e._segmentAngles.findIndex((t,s)=>e._arc.clockwise?a<=t.boundsEnd&&a>=t.boundsStart:a<=t.boundsStart&&a>=t.boundsEnd);i||l!=c&&(e.debug&&console.log("RENDERNEW movit - remove path",e.toolId,l),e._arc.clockwise,t.removeAttribute("d"),e._cache[l]=null),d.runningAngle=a,e.debug&&console.log("RENDERNEW - animation loop tween",e.toolId,d,c,l)}while(d.runningAngle!=d.frameAngle);1!=d.progress?e.rAFid=requestAnimationFrame(function(t){s(t,e)}):(d.startTime=null,e.debug&&console.log("RENDERNEW - animation loop ENDING tween",e.toolId,d,c,l))}(t,s)}),this._initialDraw=!1),svg`${i}`;this.dev.debug&&console.log("RENDERNEW _arcId does NOT exist",this._arcId,this.toolId);for(var a=0;a<this._segmentAngles.length;a++){g=this.buildArcPath(this._segmentAngles[a].drawStart,this._segmentAngles[a].drawEnd,this._arc.clockwise,this.svg.radiusX,this.svg.radiusY,this.config.isScale?this.svg.width:0),this._cache[a]=g;var r=this.config.color;if("colorlist"==this.config.show.style&&(r=this.config.segments.colorlist.colors[a]),"colorstops"==this.config.show.style&&(r=this._segments.colorStops[this._segments.sortedStops[a]]),this.styles.foreground||(this.styles.foreground={}),this.styles.foreground[a]||(this.styles.foreground[a]=Merge.mergeDeep(this.config.styles.foreground)),this.styles.foreground[a].fill=r,this.config.show.lastcolor&&0<a)for(var n=a-1;n--;)this.styles.foreground[n].fill=r;i.push(svg`<path id="arc-segment-${this.toolId}-${a}" class="arc__segment"
                            style="${styleMap(this.styles.foreground[a])}"
                            d="${g}"
                            />`)}return this.dev.debug&&console.log("RENDERNEW - svgItems",i,this._firstUpdatedCalled),svg`${i}`}}polarToCartesian(t,s,e,i,o){return o=(o-90)*Math.PI/180,{x:t+e*Math.cos(o),y:s+i*Math.sin(o)}}buildArcPath(t,s,e,i,o,a){var r=this.polarToCartesian(this.svg.cx,this.svg.cy,i,o,s),n=this.polarToCartesian(this.svg.cx,this.svg.cy,i,o,t),h=Math.abs(s-t)<=180?"0":"1";const l=e?"0":"1";return s=this.polarToCartesian(this.svg.cx,this.svg.cy,e=i-a,a=o-a,s),t=this.polarToCartesian(this.svg.cx,this.svg.cy,e,a,t),["M",r.x,r.y,"A",i,o,0,h,l,n.x,n.y,"L",t.x,t.y,"A",e,a,0,h,"0"==l?"1":"0",s.x,s.y,"Z"].join(" ")}}class SwissArmyKnifeCard extends LitElement{constructor(){super(),this.connected=!1,this.cardId=Math.random().toString(36).substr(2,9),this.entities=[],this.entitiesStr=[],this.attributesStr=[],this.secondaryInfoStr=[],this.viewBoxSize=SVG_VIEW_BOX,this.viewBox={width:SVG_VIEW_BOX,height:SVG_VIEW_BOX},this.toolsets=[],this.tools=[],this.styles={},this.styles.card={},this.entityHistory={},this.entityHistory.needed=!1,this.stateChanged=!0,this.entityHistory.updating=!1,this.entityHistory.update_interval=300,this.dev={},this.dev.debug=!1,this.dev.performance=!1,this.dev.m3=!1,this.configIsSet=!1,this.isSafari=!!navigator.userAgent.match(/Version\/[\d\.]+.*Safari/),this.iOS=(/iPad|iPhone|iPod/.test(navigator.userAgent)||"MacIntel"===navigator.platform&&1<navigator.maxTouchPoints)&&!window.MSStream,this.lovelace=SwissArmyKnifeCard.lovelace,this.lovelace||console.error("card::constructor - Can't get Lovelace panel"),SwissArmyKnifeCard.sakIconCache||(SwissArmyKnifeCard.sakIconCache={}),SwissArmyKnifeCard.colorCache||(SwissArmyKnifeCard.colorCache=[]),this.dev.debug&&console.log("*****Event - card - constructor",this.cardId,(new Date).getTime())}static getSystemStyles(){return css`
      :host {
        cursor: default;
    ...
    `}set hass(t){if(this.counter||(this.counter=0),this.counter++,t.themes.darkMode!=this.darkMode&&(this.darkMode=t.themes.darkMode),this.dev.debug&&console.log("*****Event - card::set hass",this.cardId,(new Date).getTime()),this._hass=t,this.connected||this.dev.debug&&console.log("set hass but NOT connected",this.cardId),this.config.entities){var s,i=!1,o=0,e=!1,a=!1;for(s of this.config.entities){if(this.entities[o]=t.states[this.config.entities[o].entity],this.config.entities[o].secondary_info&&(e=!0,n=this.entities[o][this.config.entities[o].secondary_info],(n=this._buildSecondaryInfo(n,this.config.entities[o]))!=this.secondaryInfoStr[o]&&(this.secondaryInfoStr[o]=n,i=!0)),this.config.entities[o].attribute){let t=this.config.entities[o].attribute,s="",e="";var r,n=this.config.entities[o].attribute.indexOf("["),h=this.config.entities[o].attribute.indexOf("."),l="";-1!=n?(t=this.config.entities[o].attribute.substr(0,n),r=(s=this.config.entities[o].attribute.substr(n,this.config.entities[o].attribute.length-n))[1],l=s.substr(4,s.length-4),e=this.entities[o].attributes[t][r][l]):-1!=h?(t=this.config.entities[o].attribute.substr(0,h),l=(s=this.config.entities[o].attribute.substr(n,this.config.entities[o].attribute.length-n)).substr(1,s.length-1),e=this.entities[o].attributes[t][l],console.log("set hass, attributes with map",this.config.entities[o].attribute,t,s)):e=this.entities[o].attributes[t],(r=this._buildState(e,this.config.entities[o]))!=this.attributesStr[o]&&(this.attributesStr[o]=r,i=!0),a=!0}a||e||((r=this._buildState(this.entities[o].state,this.config.entities[o]))!=this.entitiesStr[o]&&(this.entitiesStr[o]=r,i=!0),this.dev.debug&&console.log("set hass - attrSet=false",this.cardId,(new Date).getSeconds().toString()+"."+(new Date).getMilliseconds().toString(),r)),o++,e=a=!1}i&&(this.toolsets&&this.toolsets.map((t,s)=>{t.updateValues()}),this.requestUpdate(),this.counter--)}}setConfig(t){this.dev.performance&&console.time("--\x3e "+this.cardId+" PERFORMANCE card::setConfig"),this.dev.debug&&console.log("*****Event - setConfig",this.cardId,(new Date).getTime()),(t=JSON.parse(JSON.stringify(t))).dev&&(this.dev={...this.dev,...t.dev}),this.dev.debug&&console.log("setConfig",this.cardId),this.aspectratio=t.aspectratio||"1/1";var s=t.aspectratio.trim().split("/");if(this.viewBox||(this.viewBox={}),this.viewBox.width=s[0]*SVG_DEFAULT_DIMENSIONS,this.viewBox.height=s[1]*SVG_DEFAULT_DIMENSIONS,!t.layout)throw Error("card::setConfig - No layout defined");if(!t.layout.toolsets)throw Error("card::setConfig - No toolsets defined");if(t.entities&&"sensor"!=(s=this._computeDomain(t.entities[0].entity))&&t.entities[0].attribute&&!isNaN(t.entities[0].attribute))throw Error("card::setConfig - First entity or attribute must be a numbered sensorvalue, but is NOT");var s=Merge.mergeDeep(t),i=(this.config=s,this.toolset=[],this);function h(t,s){var e;return s.template?(e=i.lovelace.config.sak_user_templates.templates[s.template.name],e=Templates.replaceVariables3(s.template.variables,e),(e=Merge.mergeDeep(e)).from_template="replaced",e):("template"==t&&console.log("findTemplate return key=template/value",t,void 0),s)}var t=JSON.stringify(this.config.layout.toolsets,h),l=JSON.parse(t);if(this.config.layout.toolsets.map((o,a)=>{var r=null,n=(this.toolsets||(this.toolsets=[]),!1),t=[],r=l[a].tools,s=(o.tools&&o.tools.map((e,i)=>{l[a].tools.map((t,s)=>{e.id==t.id&&(o.template&&(this.config.layout.toolsets[a].position&&(l[a].position=Merge.mergeDeep(this.config.layout.toolsets[a].position)),r[s]=Merge.mergeDeep(r[s],e),r[s]=JSON.parse(JSON.stringify(r[s],h)),n=!0),this.dev.debug&&console.log("card::setConfig - got toolsetCfg toolid",e,i,t,s,e))}),n||(t=t.concat(o.tools[i]))}),r=r.concat(t),o=l[a],new Toolset(this,o));this.toolsets.push(s)}),this.dev.m3&&(console.log("*** M3 - Checking for m3.yaml template to convert..."),this.lovelace.config.sak_user_templates.templates.m3)){var e,o,s=this.lovelace.config.sak_user_templates.templates.m3,a=(console.log("*** M3 - Found. Material 3 conversion starting..."),""),r="",n="",c="",g="",d="",u={},v={},m={};s.entities.map((t,s)=>{["ref.palette","sys.color","sys.color.light","sys.color.dark"].includes(t.category_id)&&!t.tags.includes("alias")&&(u[t.id]={value:t.value,tags:t.tags}),"ref.palette"===t.category_id&&(t.id,t.value,"md.ref.palette.primary40"===t.id&&(r=t.value),"md.ref.palette.primary80"===t.id&&(g=t.value),"md.ref.palette.neutral40"===t.id&&(n=t.value),"md.ref.palette.neutral80"===t.id&&(d=t.value)),"sys.color"===t.category_id&&(t.id,t.value),"sys.color.light"===t.category_id&&(t.id,t.value,"md.sys.color.surface.light"===t.id&&(a=t.value)),"sys.color.dark"===t.category_id&&(t.id,t.value,"md.sys.color.surface.dark"===t.id&&(c=t.value))}),["primary","secondary","tertiary","error","neutral","neutral-variant"].forEach(s=>{[5,15,25,35,45,65,75,85].forEach(t=>{u["md.ref.palette."+s+t.toString()]={value:this._getGradientValue(u["md.ref.palette."+s+(t-5).toString()].value,u["md.ref.palette."+s+(t+5).toString()].value,.5),tags:[...u["md.ref.palette."+s+(t-5).toString()].tags]},u["md.ref.palette."+s+t.toString()].tags[3]=s+t.toString()}),u["md.ref.palette."+s+"7"]={value:this._getGradientValue(u["md.ref.palette."+s+"5"].value,u["md.ref.palette."+s+"10"].value,.5),tags:[...u["md.ref.palette."+s+"10"].tags]},u["md.ref.palette."+s+"7"].tags[3]=s+"7",u["md.ref.palette."+s+"92"]={value:this._getGradientValue(u["md.ref.palette."+s+"90"].value,u["md.ref.palette."+s+"95"].value,.5),tags:[...u["md.ref.palette."+s+"90"].tags]},u["md.ref.palette."+s+"92"].tags[3]=s+"92",u["md.ref.palette."+s+"97"]={value:this._getGradientValue(u["md.ref.palette."+s+"95"].value,u["md.ref.palette."+s+"99"].value,.5),tags:[...u["md.ref.palette."+s+"90"].tags]},u["md.ref.palette."+s+"97"].tags[3]=s+"97"});for([e,o]of Object.entries(u))v[e]="theme-"+o.tags[1]+"-"+o.tags[2]+"-"+o.tags[3]+": rgb("+p(o.value)+")",m[e]="theme-"+o.tags[1]+"-"+o.tags[2]+"-"+o.tags[3]+"-rgb: "+p(o.value);function p(t){var s={};return s.r=Math.round(parseInt(t.substr(1,2),16)),s.g=Math.round(parseInt(t.substr(3,2),16)),s.b=Math.round(parseInt(t.substr(5,2),16)),t=s.r+","+s.g+","+s.b}function f(t,s,e,i,o){var a,r,n,h={},l={},c=(h.r=Math.round(parseInt(t.substr(1,2),16)),h.g=Math.round(parseInt(t.substr(3,2),16)),h.b=Math.round(parseInt(t.substr(5,2),16)),l.r=Math.round(parseInt(s.substr(1,2),16)),l.g=Math.round(parseInt(s.substr(3,2),16)),l.b=Math.round(parseInt(s.substr(5,2),16)),"");return e.forEach((t,s)=>{a=Math.round(t*l.r+(1-t)*h.r),r=Math.round(t*l.g+(1-t)*h.g),n=Math.round(t*l.b+(1-t)*h.b),c=(c+=i+(s+1).toString()+"-"+o+": rgb("+a+","+r+","+n+")\n")+(i+(s+1).toString())+"-"+o+"-rgb: "+a+","+r+","+n+"\n"}),c}var _,y,s=[.05,.08,.11,.15,.19,.24,.29,.35,.4,.45],b=f(a,n,t=[.03,.05,.08,.11,.15,.19,.24,.29,.35,.4],"  theme-ref-elevation-surface-neutral","light"),x=u["md.ref.palette.neutral-variant40"].value,x=f(a,x,t,"  theme-ref-elevation-surface-neutral-variant","light"),S=f(a,r,t,"  theme-ref-elevation-surface-primary","light"),w=u["md.ref.palette.secondary40"].value,w=f(a,w,t,"  theme-ref-elevation-surface-secondary","light"),$=u["md.ref.palette.tertiary40"].value,$=f(a,$,t,"  theme-ref-elevation-surface-tertiary","light"),k=u["md.ref.palette.error40"].value,k=f(a,k,t,"  theme-ref-elevation-surface-error","light"),t=f(c,d,s,"  theme-ref-elevation-surface-neutral","dark"),M=u["md.ref.palette.neutral-variant80"].value,M=f(c,M,s,"  theme-ref-elevation-surface-neutral-variant","dark"),I=f(c,g,s,"  theme-ref-elevation-surface-primary","dark"),T=u["md.ref.palette.secondary80"].value,T=f(c,T,s,"  theme-ref-elevation-surface-secondary","dark"),E=u["md.ref.palette.tertiary80"].value,E=f(c,E,s,"  theme-ref-elevation-surface-tertiary","dark"),C=u["md.ref.palette.error80"].value,C=f(c,C,s,"  theme-ref-elevation-surface-error","dark"),A="";for([_,y]of Object.entries(v))"theme-ref"==y.substring(0,9)&&(A=(A+="  "+y+"\n")+"  "+m[_]+"\n");console.log(b+x+S+w+$+k+t+M+I+T+E+C+A),console.log("*** M3 - Material 3 conversion DONE. You should copy the above output...")}this.dev.debug&&console.log("Step 5: toolconfig, list of toolsets",this.toolsets),this.dev.debug&&console.log("debug - setConfig",this.cardId,this.config),this.dev.performance&&console.timeEnd("--\x3e "+this.cardId+" PERFORMANCE card::setConfig"),this.configIsSet=!0}connectedCallback(){this.dev.performance&&console.time("--\x3e "+this.cardId+" PERFORMANCE card::connectedCallback"),this.dev.debug&&console.log("*****Event - connectedCallback",this.cardId,(new Date).getTime()),this.connected=!0,super.connectedCallback(),this.entityHistory.update_interval&&(this.updateOnInterval(),clearInterval(this.interval),this.interval=setInterval(()=>this.updateOnInterval(),this._hass?1e3*this.entityHistory.update_interval:1e3)),this.dev.debug&&console.log("ConnectedCallback",this.cardId),this.requestUpdate(),this.dev.performance&&console.timeEnd("--\x3e "+this.cardId+" PERFORMANCE card::connectedCallback")}disconnectedCallback(){this.dev.performance&&console.time("--\x3e "+this.cardId+" PERFORMANCE card::disconnectedCallback"),this.dev.debug&&console.log("*****Event - disconnectedCallback",this.cardId,(new Date).getTime()),this.interval&&(clearInterval(this.interval),this.interval=0),super.disconnectedCallback(),this.dev.debug&&console.log("disconnectedCallback",this.cardId),this.connected=!1,this.dev.performance&&console.timeEnd("--\x3e "+this.cardId+" PERFORMANCE card::disconnectedCallback")}firstUpdated(e){this.dev.debug&&console.log("*****Event - card::firstUpdated",this.cardId,(new Date).getTime()),this.toolsets&&this.toolsets.map(async(t,s)=>{t.firstUpdated(e)})}updated(e){this.dev.debug&&console.log("*****Event - Updated",this.cardId,(new Date).getTime()),this.toolsets&&this.toolsets.map(async(t,s)=>{t.updated(e)})}render(){if(this.dev.performance&&console.time("--\x3e "+this.cardId+" PERFORMANCE card::render"),this.dev.debug&&console.log("*****Event - render",this.cardId,(new Date).getTime()),this.connected){var t;try{t=this.config.disable_card?html`
                  ...
                  `}catch(t){console.error(t)}return this.dev.performance&&console.timeEnd("--\x3e "+this.cardId+" PERFORMANCE card::render"),t}this.dev.debug&&console.log("render but NOT connected",this.cardId,(new Date).getTime())}_renderTickMarks(){var t=this.config;if(t&&t.show&&t.show.scale_tickmarks){for(var s,e=t.horseshoe_scale.color||"var(--primary-background-color)",i=t.horseshoe_scale.ticksize||(t.horseshoe_scale.max-t.horseshoe_scale.min)/10,o=t.horseshoe_scale.min%i,a=((o=t.horseshoe_scale.min+(0==o?0:i-o))-t.horseshoe_scale.min)/(t.horseshoe_scale.max-t.horseshoe_scale.min)*260,r=(t.horseshoe_scale.max-o)/i,n=Math.floor(r),h=(260-a)/r,l=(Math.floor(n*i+o)<=t.horseshoe_scale.max&&n++,t.horseshoe_scale.width?t.horseshoe_scale.width/2:3),c=[],g=0;g<n;g++)s=a+(360-g*h-230)*Math.PI/180,c[g]=svg`
        <circle cx="${100-Math.sin(s)*TICKMARKS_RADIUS_SIZE}"
                cy="${100-Math.cos(s)*TICKMARKS_RADIUS_SIZE}" r="${l}"
                fill="${e}">
      `;return svg`${c}`}}_renderSakSvgDefinitions(){return svg`
    ${SwissArmyKnifeCard.sakSvgContent}
    `}_renderUserSvgDefinitions(){return svg`
    ${SwissArmyKnifeCard.userSvgContent}
    `}_RenderToolsets(){return this.dev.debug&&console.log("all the tools in renderTools",this.tools),svg`
    ...
    `}_renderCardAttributes(){var s,e=[];this._attributes="";for(let t=0;t<this.entities.length;t++)s=this.attributesStr[t]||this.secondaryInfoStr[t]||this.entitiesStr[t],e.push(s);return this._attributes=e}_renderSvg(){var t=this.config.card_filter||"card--filter-none";const s=[];this._renderCardAttributes();var e=this._RenderToolsets();return s.push(svg`
    ...
    </svg>`),svg`${s}`}_buildUom(t,s,e){return t?.unit||e?.unit||s?.attributes.unit_of_measurement||""}toLocale(t,s="unknown"){var e=this._hass.selectedLanguage||this._hass.language;return(e=this._hass.resources[e])&&e[t]?e[t]:s}_buildState(t,s){if(isNaN(t))return"unavailable"===t?"-ua-":t;var e=Number(t),t=Math.sign(t);if(void 0===s.decimals||Number.isNaN(s.decimals)||Number.isNaN(e))return"-0"==t?"-"+(Math.round(100*e)/100).toString():(Math.round(100*e)/100).toString();var i=10**s.decimals;return"-0"==t?"-"+(Math.round(e*i)/i).toFixed(s.decimals).toString():(Math.round(e*i)/i).toFixed(s.decimals).toString()}_buildSecondaryInfo(t,s){var e,i=t=>t<10?"0"+t:t,o=this._hass.selectedLanguage||this._hass.language;if(["relative","total","date","time","datetime"].includes(s.format)){const n=new Date(t);if(!(n instanceof Date)||isNaN(n.getTime()))return t;switch(s.format){case"relative":var a=selectUnit(n,new Date),r=new Intl.RelativeTimeFormat(o,{numeric:"auto"}).format(a.value,a.unit);break;case"total":case"precision":r="Not Yet Supported";break;case"date":r=new Intl.DateTimeFormat(o,{year:"numeric",month:"numeric",day:"numeric"}).format(n);break;case"time":r=new Intl.DateTimeFormat(o,{hour:"numeric",minute:"numeric",second:"numeric"}).format(n);break;case"datetime":r=new Intl.DateTimeFormat(o,{year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric",second:"numeric"}).format(n)}return r}return isNaN(parseFloat(t))||!isFinite(t)?t:"brightness"===config.format?Math.round(t/255*100)+" %":"duration"===config.format?(s=t,t=Math.floor(s/3600),e=Math.floor(s%3600/60),s=Math.floor(s%3600%60),0<t?`${t}:${i(e)}:`+i(s):0<e?e+":"+i(s):0<s?""+s:null):void 0}_computeState(t,s){if(isNaN(t))return t;if(t=Number(t),void 0===s||Number.isNaN(s)||Number.isNaN(t))return Math.round(100*t)/100;var e=10**s;return(Math.round(t*e)/e).toFixed(s)}_calculateColor(s,e,i){var o=Object.keys(e).map(t=>Number(t)).sort((t,s)=>t-s);let a,r,n;var h=o.length;if(s<=o[0])return e[o[0]];if(s>=o[h-1])return e[o[h-1]];for(let t=0;t<h-1;t++){var l=o[t],c=o[t+1];if(l<=s&&s<c){if([a,r]=[e[l],e[c]],!i)return a;n=this._calculateValueBetween(l,c,s);break}}return this._getGradientValue(a,r,n)}_calculateColor2(s,e,i,o,a){var r=Object.keys(e).map(t=>Number(t)).sort((t,s)=>t-s);let n,h,l;var c=r.length;if(s<=r[0])return e[r[0]];if(s>=r[c-1])return e[r[c-1]];for(let t=0;t<c-1;t++){var g=r[t],d=r[t+1];if(g<=s&&s<d){if([n,h]=[e[g].styles[i][o],e[d].styles[i][o]],!a)return n;l=this._calculateValueBetween(g,d,s);break}}return this._getGradientValue(n,h,l)}_calculateValueBetween(t,s,e){return(Math.min(Math.max(e,t),s)-t)/(s-t)}_getColorVariable(t){return t=t.substr(4,t.length-5),window.getComputedStyle(this).getPropertyValue(t)}_getGradientValue(t,s,e){var t=this._colorToRGBA(t),s=this._colorToRGBA(s),i=1-e;const o=Math.floor(t[0]*i+s[0]*e),a=Math.floor(t[1]*i+s[1]*e),r=Math.floor(t[2]*i+s[2]*e),n=Math.floor(t[3]*i+s[3]*e);return"#"+this._padZero(o.toString(16))+this._padZero(a.toString(16))+this._padZero(r.toString(16))+this._padZero(n.toString(16))}_padZero(t){return(t=t.length<2?"0"+t:t).substr(0,2)}_computeDomain(t){return t.substr(0,t.indexOf("."))}_computeEntity(t){return t.substr(t.indexOf(".")+1)}_colorToRGBA(t){if(i=SwissArmyKnifeCard.colorCache[t])return i;let s=(i=t).substr(0,3);"var"===s.valueOf()&&(i=this._getColorVariable(t));var e=document.createElement("canvas");e.width=e.height=1;(e=e.getContext("2d")).clearRect(0,0,1,1),e.fillStyle=i,e.fillRect(0,0,1,1);var i=[...e.getImageData(0,0,1,1).data];return SwissArmyKnifeCard.colorCache[t]=i}updateOnInterval(){this._hass?(this.stateChanged&&!this.entityHistory.updating&&this.updateData(),this.entityHistory.needed?(window.clearInterval(this.interval),this.interval=setInterval(()=>this.updateOnInterval(),1e3*this.entityHistory.update_interval)):this.interval&&(window.clearInterval(this.interval),this.interval=0)):this.dev.debug&&console.log("UpdateOnInterval - NO hass, returning")}async fetchRecent(t,s,e,i){let o="history/period";return s&&(o+="/"+s.toISOString()),o+="?filter_entity_id="+t,e&&(o+="&end_time="+e.toISOString()),i&&(o+="&skip_initial_state"),o+="&minimal_response",this._hass.callApi("GET",o)}async updateData({}=this){this.entityHistory.updating=!0,this.dev.debug&&console.log("card::updateData - ENTRY",this.cardId);let r=[];var n=0;this.toolsets.map((t,a)=>{t.tools.map((t,s)=>{if("bar"==t.type){const i=new Date,o=new Date;o.setHours(i.getHours()-t.tool.config.hours);var e=this.config.entities[t.tool.config.entity_index].attribute||null;r[n]={tsidx:a,entityIndex:t.tool.config.entity_index,entityId:this.entities[t.tool.config.entity_index].entity_id,attrId:e,start:o,end:i,type:"bar",idx:s},n++}})}),this.dev.debug&&console.log("card::updateData - LENGTH",this.cardId,r.length,r),this.stateChanged=!1,this.dev.debug&&console.log("card::updateData, entityList from tools",r);try{var t=r.map((t,s)=>this.updateEntity(t,s,t.start,t.end));await Promise.all(t)}finally{this.entityHistory.updating=!1}}async updateEntity(s,t,e,i){var o=[];let a=await this.fetchRecent(s.entityId,e,i,!1);a[0]&&0<a[0].length&&(s.attrId&&(e=this.entities[s.entityIndex].attributes[this.config.entities[s.entityIndex].attribute],s.state=e),a=(a=a[0].filter(t=>s.attrId?!Number.isNaN(parseFloat(t.attributes[s.attrId])):!Number.isNaN(parseFloat(t.state)))).map(t=>({last_changed:t.last_changed,state:s.attrId?Number(t.attributes[s.attrId]):Number(t.state)}))),o=[...o,...a],this.uppdate(s,o)}uppdate(t,s){if(s){const a=(new Date).getTime();var i=24,o=2;"bar"==t.type&&(this.dev.debug&&console.log("entity.type == bar",t),i=this.toolsets[t.tsidx].tools[t.idx].tool.config.hours,o=this.toolsets[t.tsidx].tools[t.idx].tool.config.barhours);const r=s.reduce((t,s)=>{var e=(a-new Date(s.last_changed).getTime())/36e5/o-i/o;return t[e=Math.floor(Math.abs(e))]||(t[e]=[]),t[e].push(s),t},[]);if(r.length=Math.ceil(i/o),0!=Object.keys(r).length){"0"!=(s=Object.keys(r)[0])&&(r[0]=[],r[0].push(r[s][0]));for(var e=0;e<i/o;e++)r[e]||(r[e]=[],r[e].push(r[e-1][r[e-1].length-1]));s=(this.coords=r).map(t=>(t=>t.reduce((t,s)=>t+Number(s.state),0)/t.length)(t)),"bar"==t.type&&(this.toolsets[t.tsidx].tools[t.idx].tool.series=[...s]),this.requestUpdate()}}}getCardSize(){return 4}}customElements.define("swiss-army-knife-card",SwissArmyKnifeCard);