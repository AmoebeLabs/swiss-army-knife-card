 ...
 */var Ge=/; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g,Ue=/\\([\u000b\u0020-\u00ff])/g,qe=/^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/,He=function(t){if(!t)throw new TypeError("argument string is required");var e="object"==typeof t?function(t){var e;"function"==typeof t.getHeader?e=t.getHeader("content-type"):"object"==typeof t.headers&&(e=t.headers&&t.headers["content-type"]);if("string"!=typeof e)throw new TypeError("content-type header is missing from object");return e}(t):t;if("string"!=typeof e)throw new TypeError("argument string is required to be a string");var s=e.indexOf(";"),i=-1!==s?e.slice(0,s).trim():e.trim();if(!qe.test(i))throw new TypeError("invalid media type");var a=new je(i.toLowerCase());if(-1!==s){var r,o,n;for(Ge.lastIndex=s;o=Ge.exec(e);){if(o.index!==s)throw new TypeError("invalid parameter format");s+=o[0].length,r=o[1].toLowerCase(),34===(n=o[2]).charCodeAt(0)&&-1!==(n=n.slice(1,-1)).indexOf("\\")&&(n=n.replace(Ue,"$1")),a.parameters[r]=n}if(s!==e.length)throw new TypeError("invalid parameter format")}return a};function je(t){this.parameters=Object.create(null),this.type=t}var We=new Map,Ye=function(t){return t.cloneNode(!0)},Je=function(){return"file:"===window.location.protocol},Ze=function(t,e,s){var i=new XMLHttpRequest;i.onreadystatechange=function(){try{if(!/\.svg/i.test(t)&&2===i.readyState){var e=i.getResponseHeader("Content-Type");if(!e)throw new Error("Content type not found");var a=He(e).type;if("image/svg+xml"!==a&&"text/plain"!==a)throw new Error("Invalid content type: ".concat(a))}if(4===i.readyState){if(404===i.status||null===i.responseXML)throw new Error(Je()?"Note: SVG injection ajax calls do not work locally without adjusting security settings in your browser. Or consider using a local webserver.":"Unable to load SVG file: "+t);if(!(200===i.status||Je()&&0===i.status))throw new Error("There was a problem injecting the SVG: "+i.status+" "+i.statusText);s(null,i)}}catch(r){if(i.abort(),!(r instanceof Error))throw r;s(r,i)}},i.open("GET",t),i.withCredentials=e,i.overrideMimeType&&i.overrideMimeType("text/xml"),i.send()},Xe={},Ke=function(t,e){Xe[t]=Xe[t]||[],Xe[t].push(e)},Qe=function(t,e,s){if(We.has(t)){var i=We.get(t);if(void 0===i)return void Ke(t,s);if(i instanceof SVGSVGElement)return void s(null,Ye(i))}We.set(t,void 0),Ke(t,s),Ze(t,e,(function(e,s){var i;e?We.set(t,e):(null===(i=s.responseXML)||void 0===i?void 0:i.documentElement)instanceof SVGSVGElement&&We.set(t,s.responseXML.documentElement),function(t){for(var e=function(e,s){setTimeout((function(){if(Array.isArray(Xe[t])){var s=We.get(t),i=Xe[t][e];s instanceof SVGSVGElement&&i(null,Ye(s)),s instanceof Error&&i(s),e===Xe[t].length-1&&delete Xe[t]}}),0)},s=0,i=Xe[t].length;s<i;s++)e(s)}(t)}))},ts=function(t,e,s){Ze(t,e,(function(t,e){var i;t?s(t):(null===(i=e.responseXML)||void 0===i?void 0:i.documentElement)instanceof SVGSVGElement&&s(null,e.responseXML.documentElement)}))},es=0,ss=[],is={},as="http://www.w3.org/1999/xlink",rs=function(t,e,s,i,a,r,o){var n=t.getAttribute("data-src")||t.getAttribute("src");if(n){if(-1!==ss.indexOf(t))return ss.splice(ss.indexOf(t),1),void(t=null);ss.push(t),t.setAttribute("src",""),(i?Qe:ts)(n,a,(function(i,a){if(!a)return ss.splice(ss.indexOf(t),1),t=null,void o(i);var h=t.getAttribute("id");h&&a.setAttribute("id",h);var l=t.getAttribute("title");l&&a.setAttribute("title",l);var c=t.getAttribute("width");c&&a.setAttribute("width",c);var d=t.getAttribute("height");d&&a.setAttribute("height",d);var g=Array.from(new Set(Fe(Fe(Fe([],(a.getAttribute("class")||"").split(" "),!0),["injected-svg"],!1),(t.getAttribute("class")||"").split(" "),!0))).join(" ").trim();a.setAttribute("class",g);var u=t.getAttribute("style");u&&a.setAttribute("style",u),a.setAttribute("data-src",n);var m=[].filter.call(t.attributes,(function(t){return/^data-\w[\w-]*$/.test(t.name)}));if(Array.prototype.forEach.call(m,(function(t){t.name&&t.value&&a.setAttribute(t.name,t.value)})),s){var p,f,v,_,y,b={clipPath:["clip-path"],"color-profile":["color-profile"],cursor:["cursor"],filter:["filter"],linearGradient:["fill","stroke"],marker:["marker","marker-start","marker-mid","marker-end"],mask:["mask"],path:[],pattern:["fill","stroke"],radialGradient:["fill","stroke"]};Object.keys(b).forEach((function(t){p=t,v=b[t];for(var e=function(t,e){var s;_=f[t].id,y=_+"-"+ ++es,Array.prototype.forEach.call(v,(function(t){for(var e=0,i=(s=a.querySelectorAll("["+t+'*="'+_+'"]')).length;e<i;e++){var r=s[e].getAttribute(t);r&&!r.match(new RegExp('url\\("?#'+_+'"?\\)'))||s[e].setAttribute(t,"url(#"+y+")")}}));for(var i=a.querySelectorAll("[*|href]"),r=[],o=0,n=i.length;o<n;o++){var h=i[o].getAttributeNS(as,"href");h&&h.toString()==="#"+f[t].id&&r.push(i[o])}for(var l=0,c=r.length;l<c;l++)r[l].setAttributeNS(as,"href","#"+y);f[t].id=y},s=0,i=(f=a.querySelectorAll(p+"[id]")).length;s<i;s++)e(s)}))}a.removeAttribute("xmlns:a");for(var w,x,$=a.querySelectorAll("script"),k=[],S=0,M=$.length;S<M;S++)(x=$[S].getAttribute("type"))&&"application/ecmascript"!==x&&"application/javascript"!==x&&"text/javascript"!==x||((w=$[S].innerText||$[S].textContent)&&k.push(w),a.removeChild($[S]));if(k.length>0&&("always"===e||"once"===e&&!is[n])){for(var A=0,C=k.length;A<C;A++)new Function(k[A])(window);is[n]=!0}var E=a.querySelectorAll("style");if(Array.prototype.forEach.call(E,(function(t){t.textContent+=""})),a.setAttribute("xmlns","http://www.w3.org/2000/svg"),a.setAttribute("xmlns:xlink",as),r(a),!t.parentNode)return ss.splice(ss.indexOf(t),1),t=null,void o(new Error("Parent node is null"));t.parentNode.replaceChild(a,t),ss.splice(ss.indexOf(t),1),t=null,o(null,a)}))}else o(new Error("Invalid data-src or src attribute"))};class os extends At{constructor(t,e,s){if(super(t,yt.mergeDeep({position:{cx:50,cy:50,height:50,width:50},options:{svginject:!0},styles:{usersvg:{},mask:{fill:"white"}}},e),s),this.images={},this.images=Object.assign({},...this.config.images),this.item={},this.item.image="default",this.imageCur="none",this.imagePrev="none",this.classes={},this.classes.tool={},this.classes.usersvg={},this.classes.mask={},this.styles={},this.styles.tool={},this.styles.usersvg={},this.styles.mask={},this.injector={},this.injector.svg=null,this.injector.cache=[],this.clipPath={},this.config.clip_path){this.svg.cp_cx=bt.calculateSvgCoordinate(this.config.clip_path.position.cx||this.config.position.cx,0),this.svg.cp_cy=bt.calculateSvgCoordinate(this.config.clip_path.position.cy||this.config.position.cy,0),this.svg.cp_height=bt.calculateSvgDimension(this.config.clip_path.position.height||this.config.position.height),this.svg.cp_width=bt.calculateSvgDimension(this.config.clip_path.position.width||this.config.position.width);const t=Math.min(this.svg.cp_height,this.svg.cp_width)/2;this.svg.radiusTopLeft=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.top_left||this.config.clip_path.position.radius.left||this.config.clip_path.position.radius.top||this.config.clip_path.position.radius.all)))||0,this.svg.radiusTopRight=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.top_right||this.config.clip_path.position.radius.right||this.config.clip_path.position.radius.top||this.config.clip_path.position.radius.all)))||0,this.svg.radiusBottomLeft=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.bottom_left||this.config.clip_path.position.radius.left||this.config.clip_path.position.radius.bottom||this.config.clip_path.position.radius.all)))||0,this.svg.radiusBottomRight=+Math.min(t,Math.max(0,bt.calculateSvgDimension(this.config.clip_path.position.radius.bottom_right||this.config.clip_path.position.radius.right||this.config.clip_path.position.radius.bottom||this.config.clip_path.position.radius.all)))||0}this.dev.debug&&console.log("UserSvgTool constructor config, svg",this.toolId,this.config,this.svg)}set value(t){super.value=t}updated(t){var e=this;this.config.options.svginject&&!this.injector.cache[this.imageCur]&&(this.injector.elementsToInject=this._card.shadowRoot.getElementById("usersvg-".concat(this.toolId)).querySelectorAll("svg[data-src]:not(.injected-svg)"),0!==this.injector.elementsToInject.length&&function(t,e){var s=void 0===e?{}:e,i=s.afterAll,a=void 0===i?function(){}:i,r=s.afterEach,o=void 0===r?function(){}:r,n=s.beforeEach,h=void 0===n?function(){}:n,l=s.cacheRequests,c=void 0===l||l,d=s.evalScripts,g=void 0===d?"never":d,u=s.httpRequestWithCredentials,m=void 0!==u&&u,p=s.renumerateIRIElements,f=void 0===p||p;if(t&&"length"in t)for(var v=0,_=0,y=t.length;_<y;_++)rs(t[_],g,f,c,m,h,(function(e,s){o(e,s),t&&"length"in t&&t.length===++v&&a(v)}));else t?rs(t,g,f,c,m,h,(function(e,s){o(e,s),a(1),t=null})):a(0)}(this.injector.elementsToInject,{afterAll(t){setTimeout((()=>{e._card.requestUpdate()}),0)},afterEach(t,s){if(t)throw e.injector.error=t,e.config.options.svginject=!1,t;e.injector.error="",e.injector.cache[e.imageCur]=s},beforeEach(t){t.removeAttribute("height"),t.removeAttribute("width")},cacheRequests:!1,evalScripts:"once",httpRequestWithCredentials:!1,renumerateIRIElements:!1}))}_renderUserSvg(){this.MergeAnimationStyleIfChanged();const t=wt.getJsTemplateOrValue(this,this._stateValue,yt.mergeDeep(this.images));if(this.imagePrev=this.imageCur,this.imageCur=t[this.item.image],"none"===t[this.item.image])return F``;let e=this.injector.cache[this.imageCur],s=F``,i="",a="";this.config.clip_path&&(i=`url(#clip-path-${this.toolId})`,a=`url(#mask-${this.toolId})`,s=F`
    ...
    `}}class ns extends At{constructor(t,e,s){super(t,yt.mergeDeep({position:{cx:50,cy:50,radius:50},classes:{tool:{"sak-path-progress":!0,hover:!0},circle:{"sak-path-progress__progress":!0}},styles:{tool:{},circle:{}}},e),s),this.EnableHoverForInteraction(),this.svg.radius=bt.calculateSvgDimension(e.position.radius),this.classes.tool={},this.classes.ProgressPath={},this.styles.tool={},this.styles.ProgressPath={},this.ticking=!1,this.length=100,this.myValue=50}set value(t){super.value=t}getPerpendicularAngle(t,e){const{x:s,y:i}=this.path.getPointAtLength(t),{x:a,y:r}=this.path.getPointAtLength(e);return{x:s,y:i,x2:a,y2:r,angle:180+180*Math.atan2(i-r,s-a)/Math.PI}}renderPacman(){const t=1e4;let e;const s=i=>{if(this.ticking)return;e||(e=i),this.ticking=!0;const a=i-e,r=this.getPerpendicularAngle(a/t*this.length,a/t*(this.length+1));if(this.target.setAttribute("transform",`translate(${r.x} ${r.y}) rotate(${r.angle})`),this.target2.setAttribute("transform",`translate(${r.x2} ${r.y2})`),a>t)return e=null,this.monster.classList.toggle("destroy"),setTimeout((()=>{this.ticking=!1,window.requestAnimationFrame(s),this.monster.classList.toggle("destroy")}),500);this.ticking=!1,window.requestAnimationFrame(s)};window.requestAnimationFrame(s)}renderPointer(t){let e;console.log("renderPointer IN/OUT"),this.progressPctPrev=this.progressPct||0,this.progressPct=this.myValue/100,this.progressDiff=this.progressPct-this.progressPctPrev,console.log("renderPointer progress",this.myValue,this.progressPctPrev,this.progressPct,this.progressDiff);const s=t=>{e||(e=t);const i=(t=>--t**5+1)(Math.min(1,(t-e)/5e3)),a=this.myValue-this.myValuePrev;let r=this.myValuePrev+i*a;const o=this.getPerpendicularAngle((100-r)/100*this.length,(100-r)/100*(this.length+1));this.target.setAttribute("transform",`translate(${o.x} ${o.y}) rotate(${o.angle})`),i<1?window.requestAnimationFrame(s):e=null};console.log("renderPointer, calling animate frame"),window.requestAnimationFrame(s)}firstUpdated(t){const e=this._card.shadowRoot;this.path=e.getElementById("motion-path"),this.length=this.path.getTotalLength(),"pacman"===this.config.progpath.show.path_type&&(this.target=e.getElementById("target"),this.target2=e.getElementById("target2"),this.monster=e.getElementById("monster"),this.pacman=e.getElementById("pacman"),this.renderPacman(Date.now())),"rectangle"===this.config.progpath.show.path_type&&(this.target=e.getElementById("target"),this.target2=e.getElementById("target2"),this.progressPath=e.getElementById("progress-path"),this.pacman=e.getElementById("pacman"),console.log("updated, targets",this.target,this.target2,this.monster,this.pacman),this.renderPointer(Date.now()))}_renderMarker(){let t;switch(this.config.progpath.marker){case"drag-vertical":t=F`
          ...
          `;break;case"arrow-up-bold-outline":t=F`
