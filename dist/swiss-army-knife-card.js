    ...
    <g class='graph-clock'
      ...
      ${this.renderSvgRadialBarcodeFace(this.svg.width/2-40)}
        ...
        <animate attributeName='x' from=${this.svg.margin.x} to=${t.x} dur='3s' fill='remove'
          calcMode='spline' keyTimes='0; 1' keySplines='0.215 0.61 0.355 1'>
        </animate>`:"",o=this.styles.barcode_graph?.rx||0,r=this.styles.barcode_graph?.ry||o,n=t.height-this.svg.margin.t-this.svg.margin.b-this.svg.line_width,h=n<1?-(1-n):0;return F` 
      <!-- Barcode Part -->
