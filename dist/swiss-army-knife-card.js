 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const k=t=>null===t||!("object"==typeof t||"function"==typeof t),M=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class E{constructor(t,e,s){this.dirty=!0,this.element=t,this.name=e,this.strings=s,this.parts=[];for(let i=0;i<s.length-1;i++)this.parts[i]=this._createPart()}_createPart(){return new T(this)}_getValue(){const t=this.strings,e=t.length-1,s=this.parts;if(1===e&&""===t[0]&&""===t[1]){const t=s[0].value;if("symbol"==typeof t)return String(t);if("string"==typeof t||!M(t))return t}let i="";for(let o=0;o<e;o++){i+=t[o];const e=s[o];if(void 0!==e){const t=e.value;if(k(t)||!M(t))i+="string"==typeof t?t:String(t);else for(const e of t)i+="string"==typeof e?e:String(e)}}return i+=t[e],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class T{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===y||k(t)&&t===this.value||(this.value=t,v(t)||(this.committer.dirty=!0))}commit(){for(;v(this.value);){const t=this.value;this.value=y,t(this)}this.value!==y&&this.committer.commit()}}class C{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(c()),this.endNode=t.appendChild(c())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=c()),t.__insert(this.endNode=c())}insertAfterPart(t){t.__insert(this.startNode=c()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;v(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}const t=this.__pendingValue;t!==y&&(k(t)?t!==this.value&&this.__commitText(t):t instanceof $?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):M(t)?this.__commitIterable(t):t===_?(this.value=_,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,s="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=s:this.__commitNode(document.createTextNode(s)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof b&&this.value.template===e)this.value.update(t.values);else{const s=new b(e,t.processor,this.options),i=s._clone();s.update(t.values),this.__commitNode(i),this.value=s}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let s,i=0;for(const o of t)s=e[i],void 0===s&&(s=new C(this.options),e.push(s),0===i?s.appendIntoPart(this):s.insertAfterPart(e[i-1])),s.setValue(o),s.commit(),i++;i<e.length&&(e.length=i,this.clear(s&&s.endNode))}clear(t=this.startNode){s(this.startNode.parentNode,t.nextSibling,this.endNode)}}class I{constructor(t,e,s){if(this.value=void 0,this.__pendingValue=void 0,2!==s.length||""!==s[0]||""!==s[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=s}setValue(t){this.__pendingValue=t}commit(){for(;v(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=y}}class A extends E{constructor(t,e,s){super(t,e,s),this.single=2===s.length&&""===s[0]&&""===s[1]}_createPart(){return new N(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class N extends T{}let V=!1;(()=>{try{const t={get capture(){return V=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class D{constructor(t,e,s){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=s,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;v(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=this.__pendingValue,e=this.value,s=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),i=null!=t&&(null==e||s);s&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),i&&(this.__options=P(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=y}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const P=t=>t&&(V?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function L(t){let e=O.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},O.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const o=t.strings.join(i);return s=e.keyString.get(o),void 0===s&&(s=new n(t,t.getTemplateElement()),e.keyString.set(o,s)),e.stringsArray.set(t.strings,s),s}const O=new Map,R=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const o=e[0];if("."===o){return new A(t,e.slice(1),s).parts}if("@"===o)return[new D(t,e.slice(1),i.eventContext)];if("?"===o)return[new I(t,e.slice(1),s)];return new E(t,e,s).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */class xt{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const s of e)this.classes.add(s)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach((e=>t+=e+" ")),this.element.setAttribute("class",t)}}}const $t=new WeakMap,St=f((t=>e=>{if(!(e instanceof T)||e instanceof N||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:s}=e,{element:i}=s;let o=$t.get(e);void 0===o&&(i.setAttribute("class",s.strings.join(" ")),$t.set(e,o=new Set));const a=i.classList||new xt(i);o.forEach((e=>{e in t||(a.remove(e),o.delete(e))}));for(const r in t){const e=t[r];e!=o.has(r)&&(e?(a.add(r),o.add(r)):(a.remove(r),o.delete(r)))}"function"==typeof a.commit&&a.commit()})),kt=(t,e,s,i)=>{i=i||{},s=null==s?{}:s;const o=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return o.detail=s,t.dispatchEvent(o),o};class Mt{static{Mt.colorCache={},Mt.element=void 0}static _prefixKeys(t){let e={};return Object.keys(t).forEach((s=>{const i=`--${s}`,o=String(t[s]);e[i]=`${o}`})),e}static processTheme(t){let e={},s={},i={},o={};const{modes:a,...r}=t;return a&&(s={...r,...a.dark},e={...r,...a.light}),i=Mt._prefixKeys(e),o=Mt._prefixKeys(s),{themeLight:i,themeDark:o}}static processPalette(t){let e={},s={},i={},o={},a={};return Object.values(t).forEach((t=>{const{modes:o,...a}=t;e={...e,...a},o&&(i={...i,...a,...o.dark},s={...s,...a,...o.light})})),o=Mt._prefixKeys(s),a=Mt._prefixKeys(i),{paletteLight:o,paletteDark:a}}static setElement(t){Mt.element=t}static calculateColor(t,e,s){const i=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let o,a,r;const n=i.length;if(t<=i[0])return e[i[0]];if(t>=i[n-1])return e[i[n-1]];for(let h=0;h<n-1;h++){const n=i[h],l=i[h+1];if(t>=n&&t<l){if([o,a]=[e[n],e[l]],!s)return o;r=Mt.calculateValueBetween(n,l,t);break}}return Mt.getGradientValue(o,a,r)}static calculateColor2(t,e,s,i,o){const a=Object.keys(e).map((t=>Number(t))).sort(((t,e)=>t-e));let r,n,h;const l=a.length;if(t<=a[0])return e[a[0]];if(t>=a[l-1])return e[a[l-1]];for(let c=0;c<l-1;c++){const l=a[c],d=a[c+1];if(t>=l&&t<d){if([r,n]=[e[l].styles[s][i],e[d].styles[s][i]],!o)return r;h=Mt.calculateValueBetween(l,d,t);break}}return Mt.getGradientValue(r,n,h)}static calculateValueBetween(t,e,s){return(Math.min(Math.max(s,t),e)-t)/(e-t)}static getColorVariable(t){const e=t.substr(4,t.length-5);return window.getComputedStyle(Mt.element).getPropertyValue(e)}static getGradientValue(t,e,s){const i=Mt.colorToRGBA(t),o=Mt.colorToRGBA(e),a=1-s,r=s,n=Math.floor(i[0]*a+o[0]*r),h=Math.floor(i[1]*a+o[1]*r),l=Math.floor(i[2]*a+o[2]*r),c=Math.floor(i[3]*a+o[3]*r);return`#${Mt.padZero(n.toString(16))}${Mt.padZero(h.toString(16))}${Mt.padZero(l.toString(16))}${Mt.padZero(c.toString(16))}`}static padZero(t){return t.length<2&&(t=`0${t}`),t.substr(0,2)}static colorToRGBA(t){const e=Mt.colorCache[t];if(e)return e;let s=t;"var"===t.substr(0,3).valueOf()&&(s=Mt.getColorVariable(t));const i=window.document.createElement("canvas");i.width=i.height=1;const o=i.getContext("2d");o.clearRect(0,0,1,1),o.fillStyle=s,o.fillRect(0,0,1,1);const a=[...o.getImageData(0,0,1,1).data];return Mt.colorCache[t]=a,a}static hslToRgb(t){const e=t.h/360,s=t.s/100,i=t.l/100;let o,a,r;if(0===s)o=a=r=i;else{function n(t,e,s){return s<0&&(s+=1),s>1&&(s-=1),s<1/6?t+6*(e-t)*s:s<.5?e:s<2/3?t+(e-t)*(2/3-s)*6:t}const h=i<.5?i*(1+s):i+s-i*s,l=2*i-h;o=n(l,h,e+1/3),a=n(l,h,e),r=n(l,h,e-1/3)}return o*=255,a*=255,r*=255,{r:o,g:a,b:r}}}class Et{constructor(t,e,s){this.toolId=Math.random().toString(36).substr(2,9),this.toolset=t,this._card=this.toolset._card,this.config=e,this.dev={...this._card.dev},this.toolsetPos=s,this.svg={},this.svg.cx=bt.calculateSvgCoordinate(e.position.cx,0),this.svg.cy=bt.calculateSvgCoordinate(e.position.cy,0),this.svg.height=e.position.height?bt.calculateSvgDimension(e.position.height):0,this.svg.width=e.position.width?bt.calculateSvgDimension(e.position.width):0,this.svg.x=this.svg.cx-this.svg.width/2,this.svg.y=this.svg.cy-this.svg.height/2,this.classes={},this.classes.card={},this.classes.toolset={},this.classes.tool={},this.styles={},this.styles.card={},this.styles.toolset={},this.styles.tool={},this.animationClass={},this.animationClassHasChanged=!0,this.animationStyle={},this.animationStyleHasChanged=!0,this.config?.show?.style||(this.config.show||(this.config.show={}),this.config.show.style="default"),this.colorStops={},this.config.colorstops&&this.config.colorstops.colors&&Object.keys(this.config.colorstops.colors).forEach((t=>{this.colorStops[t]=this.config.colorstops.colors[t]})),"colorstop"===this.config.show.style&&this.config?.colorstops.colors&&(this.sortedColorStops=Object.keys(this.config.colorstops.colors).map((t=>Number(t))).sort(((t,e)=>t-e))),this.csnew={},this.config.csnew&&this.config.csnew.colors&&(this.config.csnew.colors.forEach(((t,e)=>{this.csnew[t.stop]=this.config.csnew.colors[e]})),this.sortedcsnew=Object.keys(this.csnew).map((t=>Number(t))).sort(((t,e)=>t-e)))}textEllipsis(t,e){return e&&e<t.length?t.slice(0,e-1).concat("..."):t}defaultEntityIndex(){return this.default||(this.default={},this.config.hasOwnProperty("entity_indexes")?this.default.entity_index=this.config.entity_indexes[0].entity_index:this.default.entity_index=this.config.entity_index),this.default.entity_index}set value(t){let e=t;this.dev.debug&&console.log("BaseTool set value(state)",e);try{if("undefined"!==e&&void 0!==e&&this._stateValue?.toString().toLowerCase()===e.toString().toLowerCase())return}catch(i){console.log("catching something",i,t,this.config)}this.derivedEntity=null,this.config.derived_entity&&(this.derivedEntity=wt.getJsTemplateOrValue(this,t,_t.mergeDeep(this.config.derived_entity)),e=this.derivedEntity.state?.toString()),this._stateValuePrev=this._stateValue||e,this._stateValue=e,this._stateValueIsDirty=!0;let s=!1;this.activeAnimation=null,this.config.animations&&Object.keys(this.config.animations).map((t=>{const e=JSON.parse(JSON.stringify(this.config.animations[t])),i=wt.getJsTemplateOrValue(this,this._stateValue,_t.mergeDeep(e));if(s)return!0;switch(i.operator?i.operator:"=="){case"==":s=void 0===this._stateValue?void 0===i.state||"undefined"===i.state.toLowerCase():this._stateValue.toLowerCase()===i.state.toLowerCase();break;case"!=":s=void 0===this._stateValue?"undefined"!==i.state.toLowerCase():this._stateValue.toLowerCase()!==i.state.toLowerCase();break;case">":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())>Number(i.state.toLowerCase()));break;case"<":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())<Number(i.state.toLowerCase()));break;case">=":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())>=Number(i.state.toLowerCase()));break;case"<=":void 0!==this._stateValue&&(s=Number(this._stateValue.toLowerCase())<=Number(i.state.toLowerCase()));break;default:s=!1}return this.dev.debug&&console.log("BaseTool, animation, match, value, config, operator",s,this._stateValue,i.state,i.operator),!s||(this.animationClass&&i.reuse||(this.animationClass={}),i.classes&&(this.animationClass=_t.mergeDeep(this.animationClass,i.classes)),this.animationStyle&&i.reuse||(this.animationStyle={}),i.styles&&(this.animationStyle=_t.mergeDeep(this.animationStyle,i.styles)),this.animationStyleHasChanged=!0,this.item=i,this.activeAnimation=i,s)}))}getEntityIndexFromAnimation(t){return t.hasOwnProperty("entity_index")?t.entity_index:this.config.hasOwnProperty("entity_index")?this.config.entity_index:this.config.entity_indexes?this.config.entity_indexes[0].entity_index:void 0}getIndexInEntityIndexes(t){return this.config.entity_indexes.findIndex((e=>e.entity_index===t))}stateIsMatch(t,e){let s;const i=JSON.parse(JSON.stringify(t)),o=wt.getJsTemplateOrValue(this,e,_t.mergeDeep(i));switch(o.operator?o.operator:"=="){case"==":s=void 0===e?void 0===o.state||"undefined"===o.state.toLowerCase():e.toLowerCase()===o.state.toLowerCase();break;case"!=":s=void 0===e?void 0!==o.state||"undefined"!==o.state.toLowerCase():e.toLowerCase()!==o.state.toLowerCase();break;case">":void 0!==e&&(s=Number(e.toLowerCase())>Number(o.state.toLowerCase()));break;case"<":void 0!==e&&(s=Number(e.toLowerCase())<Number(o.state.toLowerCase()));break;case">=":void 0!==e&&(s=Number(e.toLowerCase())>=Number(o.state.toLowerCase()));break;case"<=":void 0!==e&&(s=Number(e.toLowerCase())<=Number(o.state.toLowerCase()));break;default:s=!1}return s}mergeAnimationData(t){this.animationClass&&t.reuse||(this.animationClass={}),t.classes&&(this.animationClass=_t.mergeDeep(this.animationClass,t.classes)),this.animationStyle&&t.reuse||(this.animationStyle={}),t.styles&&(this.animationStyle=_t.mergeDeep(this.animationStyle,t.styles)),this.animationStyleHasChanged=!0,this.item||(this.item={}),this.item=_t.mergeDeep(this.item,t),this.activeAnimation={...t}}set values(t){this._lastStateValues||(this._lastStateValues=[]),this._stateValues||(this._stateValues=[]);const e=[...t];this.dev.debug&&console.log("BaseTool set values(state)",e);for(let s=0;s<t.length;++s){void 0!==e[s]&&(this._stateValues[s]?.toLowerCase()===e[s].toLowerCase()||this.config.derived_entities&&(this.derivedEntities[s]=wt.getJsTemplateOrValue(this,t[s],_t.mergeDeep(this.config.derived_entities[s])),e[s]=this.derivedEntities[s].state?.toString())),this._lastStateValues[s]=this._stateValues[s]||e[s],this._stateValues[s]=e[s],this._stateValueIsDirty=!0;let i=!1;this.activeAnimation=null,this.config.animations&&Object.keys(this.config.animations.map(((e,s)=>{const o=this.getIndexInEntityIndexes(this.getEntityIndexFromAnimation(e));return i=this.stateIsMatch(e,t[o]),!!i&&(this.mergeAnimationData(e),!0)})))}this._stateValue=this._stateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())],this._stateValuePrev=this._lastStateValues[this.getIndexInEntityIndexes(this.defaultEntityIndex())]}EnableHoverForInteraction(){const t=this.config.hasOwnProperty("entity_index")||this.config?.user_actions?.tap_action;this.classes.tool.hover=!!t}MergeAnimationStyleIfChanged(t){this.animationStyleHasChanged&&(this.animationStyleHasChanged=!1,this.styles=t?_t.mergeDeep(t,this.config.styles,this.animationStyle):_t.mergeDeep(this.config.styles,this.animationStyle),this.styles.card&&0!==Object.keys(this.styles.card).length&&(this._card.styles.card=_t.mergeDeep(this.styles.card)))}MergeAnimationClassIfChanged(t){this.animationClassHasChanged=!0,this.animationClassHasChanged&&(this.animationClassHasChanged=!1,this.classes=t?_t.mergeDeep(t,this.config.classes,this.animationClass):_t.mergeDeep(this.config.classes,this.animationClass))}MergeColorFromState(t){if(this.config.hasOwnProperty("entity_index")){const e=this.getColorFromState(this._stateValue);""!==e&&(t.fill=this.config[this.config.show.style].fill?e:"",t.stroke=this.config[this.config.show.style].stroke?e:"")}}MergeColorFromState2(t,e){if(this.config.hasOwnProperty("entity_index")){const s=this.config[this.config.show.style].fill?this.getColorFromState2(this._stateValue,e,"fill"):"",i=this.config[this.config.show.style].stroke?this.getColorFromState2(this._stateValue,e,"stroke"):"";""!==s&&(t.fill=s),""!==i&&(t.stroke=i)}}getColorFromState(t){let e="";switch(this.config.show.style){case"default":break;case"fixedcolor":e=this.config.color;break;case"colorstop":case"colorstops":case"colorstopgradient":e=Mt.calculateColor(t,this.colorStops,"colorstopgradient"===this.config.show.style);break;case"minmaxgradient":e=Mt.calculateColor(t,this.colorStopsMinMax,!0)}return e}getColorFromState2(t,e,s){let i="";switch(this.config.show.style){case"colorstop":case"colorstops":case"colorstopgradient":i=Mt.calculateColor2(t,this.csnew,e,s,"colorstopgradient"===this.config.show.style);break;case"minmaxgradient":i=Mt.calculateColor2(t,this.colorStopsMinMax,e,s,!0)}return i}_processTapEvent(t,e,s,i,o,a){let r;if(i){kt(t,"haptic",i.haptic||"medium"),this.dev.debug&&console.log("_processTapEvent",s,i,o,a);for(let s=0;s<i.actions.length;s++)switch(i.actions[s].action){case"more-info":void 0!==o&&(r=new Event("hass-more-info",{composed:!0}),r.detail={entityId:o},t.dispatchEvent(r));break;case"navigate":if(!i.actions[s].navigation_path)return;window.history.pushState(null,"",i.actions[s].navigation_path),r=new Event("location-changed",{composed:!0}),r.detail={replace:!1},window.dispatchEvent(r);break;case"call-service":{if(!i.actions[s].service)return;const[t,r]=i.actions[s].service.split(".",2),n={...i.actions[s].service_data};n.entity_id||(n.entity_id=o),i.actions[s].parameter&&(n[i.actions[s].parameter]=a),e.callService(t,r,n);break}case"fire-dom-event":{const e={...i.actions[s]};r=new Event("ll-custom",{composed:!0,bubbles:!0}),r.detail=e,t.dispatchEvent(r);break}default:console.error("Unknown Event definition",i)}}}handleTapEvent(t,e){let s;t.stopPropagation(),t.preventDefault();let i=this.defaultEntityIndex();s=void 0===i||e.user_actions?e.user_actions?.tap_action:{haptic:"light",actions:[{action:"more-info"}]},s&&this._processTapEvent(this._card,this._card._hass,this.config,s,this._card.config.hasOwnProperty("entities")?this._card.config.entities[i]?.entity:void 0,void 0)}}class Tt extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,width:100,height:25,radius:5,ratio:30,divider:30},classes:{tool:{"sak-badge":!0,hover:!0},left:{"sak-badge__left":!0},right:{"sak-badge__right":!0}},styles:{tool:{},left:{},right:{}}},e),s),this.svg.radius=bt.calculateSvgDimension(e.position.radius),this.svg.leftXpos=this.svg.x,this.svg.leftYpos=this.svg.y,this.svg.leftWidth=this.config.position.ratio/100*this.svg.width,this.svg.arrowSize=this.svg.height*this.config.position.divider/100/2,this.svg.divSize=this.svg.height*(100-this.config.position.divider)/100/2,this.svg.rightXpos=this.svg.x+this.svg.leftWidth,this.svg.rightYpos=this.svg.y,this.svg.rightWidth=(100-this.config.position.ratio)/100*this.svg.width,this.classes.tool={},this.classes.left={},this.classes.right={},this.styles.tool={},this.styles.left={},this.styles.right={},this.dev.debug&&console.log("BadgeTool constructor coords, dimensions",this.svg,this.config)}_renderBadge(){let t=[];return this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),t=B`
    ...
    `}}class At extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,radiusx:50,radiusy:25},classes:{tool:{"sak-ellipse":!0,hover:!0},ellipse:{"sak-ellipse__ellipse":!0}},styles:{tool:{},ellipse:{}}},e),s),this.svg.radiusx=bt.calculateSvgDimension(e.position.radiusx),this.svg.radiusy=bt.calculateSvgDimension(e.position.radiusy),this.classes.tool={},this.classes.ellipse={},this.styles.tool={},this.styles.ellipse={},this.dev.debug&&console.log("EllipseTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}_renderEllipse(){return this.MergeAnimationClassIfChanged(),this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.ellipse),this.dev.debug&&console.log("EllipseTool - renderEllipse",this.svg.cx,this.svg.cy,this.svg.radiusx,this.svg.radiusy),B`
    ...
    <svg overflow="visible" id="state-${this.toolId}"
      ...
      `}}const xe=36e5;class $e{constructor(t,e,s,i=24,o=1,a="avg",r="interval",n=!0,h=!1){this.aggregateFuncMap={avg:this._average,median:this._median,max:this._maximum,min:this._minimum,first:this._first,last:this._last,sum:this._sum,delta:this._delta,diff:this._diff},this.graphArea={},this.graphArea.x=0,this.graphArea.y=0,this.graphArea.width=t-2*this.graphArea.x,this.graphArea.height=e-2*this.graphArea.y,this.drawArea={},this.drawArea.x=s.l,this.drawArea.y=s.t,this.drawArea.top=s.t,this.drawArea.bottom=s.b,this.drawArea.width=t-(s.l+s.r),this.drawArea.height=e-(s.t+s.b),this._history=void 0,this.coords=[],this.width=t,this.height=e,this.margin=s,this._max=0,this._min=0,this.points=o,this.hours=i,this.aggregateFuncName=a,this._calcPoint=this.aggregateFuncMap[a]||this._average,this._smoothing=n,this._logarithmic=h,this._groupBy=r,this._endTime=0,this.valuesPerBucket=0,this.buckets=1}get max(){return this._max}set max(t){this._max=t}get min(){return this._min}set min(t){this._min=t}set history(t){this._history=t}update(t=void 0){if(t&&(this._history=t),!this._history)return;this._updateEndTime();const e=this._history.reduce(((t,e)=>this._reducer(t,e)),[]);e[0]&&e[0].length&&(e[0]=[e[0][e[0].length-1]]);const s=Math.ceil(this.hours*this.points);e.length=s,this.coords=this._calcPoints(e),this.min=Math.min(...this.coords.map((t=>Number(t[2])))),this.max=Math.max(...this.coords.map((t=>Number(t[2]))));const i=this._history.reduce(((t,e)=>this._reducerMinMax(t,e)),[]);i[0][0]&&i[0][0].length&&(i[0][0]=[i[0][0][i[0][0].length-1]]),i[1][0]&&i[1][0].length&&(i[1][0]=[i[1][0][i[1][0].length-1]]),i[0].length=s,i[1].length=s;const o=[...e],a=[...e];let r=this._calcPoint;this._calcPoint=this.aggregateFuncMap.min,this.coordsMin=[],this.coordsMin=this._calcPoints(o),this._calcPoint=this.aggregateFuncMap.max,this.coordsMax=[],this.coordsMax=this._calcPoints(a),this._calcPoint=r,this.min=Math.min(...this.coordsMin.map((t=>Number(t[2])))),this.max=Math.max(...this.coordsMax.map((t=>Number(t[2]))))}_reducerMinMax2(t,e){const s=(this._endTime-new Date(e.last_changed).getTime())/xe*this.points-this.hours*this.points,i=s<0?Math.floor(Math.abs(s)):0;return t[i]||(t[i]=[],t[i][0]=[],t[i][1]=[]),t[i][0]=Math.min(t[i][0]?t[i][0]:Number.POSITIVE_INFINITY,e.state),t[i][1]=Math.max(t[i][1],Number(e.state)),t}_reducerMinMax(t,e){const s=(this._endTime-new Date(e.last_changed).getTime())/xe*this.points-this.hours*this.points,i=s<0?Math.floor(Math.abs(s)):0;return t[0]||(t[0]=[]),t[1]||(t[1]=[]),t[0][i]||(t[0][i]={},t[1][i]={}),t[0][i].state=Math.min(t[0][i].state?t[0][i].state:Number.POSITIVE_INFINITY,e.state),t[1][i].state=Math.max(t[1][i].state?t[0][i].state:Number.NEGATIVE_INFINITY,e.state),t}_reducer(t,e){const s=(this._endTime-new Date(e.last_changed).getTime())/xe*this.points-this.hours*this.points,i=s<0?Math.floor(Math.abs(s)):0;return t[i]||(t[i]=[]),t[i].push(e),t}_calcPoints(t){const e=[];let s=this.drawArea.width/(this.hours*this.points-1);s=Number.isFinite(s)?s:this.drawArea.width;const i=t.filter(Boolean)[0];let o=[this._calcPoint(i),this._lastValue(i)];const a=(t,i)=>{const a=s*i+this.drawArea.x;return t&&(o=[this._calcPoint(t),this._lastValue(t)]),e.push([a,0,t?o[0]:o[1]])};for(let r=0;r<t.length;r+=1)a(t[r],r);return e}_calcY(t){const e=this._logarithmic?Math.log10(Math.max(1,this.max)):this.max,s=this._logarithmic?Math.log10(Math.max(1,this.min)):this.min,i=(e-s)/this.drawArea.height||1;return t.map((t=>{const e=this._logarithmic?Math.log10(Math.max(1,t[2])):t[2],o=s<0?Math.abs(s):0;e>0&&Math.max(0,s);this.drawArea.height,this.drawArea.y;const a=e>0?this.drawArea.height+1*this.drawArea.y-o/i-(e-Math.max(0,s))/i:this.drawArea.height+1*this.drawArea.y-(0-s)/i,r=this.drawArea.height+1*this.drawArea.y-(e-s)/i;return[t[0],r,t[2],a]}))}_calcLevelY(t){console.log("calcLevelY, coord",t);const e=this._logarithmic?Math.log10(Math.max(1,this.max)):this.max,s=this._logarithmic?Math.log10(Math.max(1,this.min)):this.min,i=(e-s)/this.drawArea.height||1,o=s<0?Math.abs(s):0;let a=[];return t[2].forEach(((t,r)=>{const n=t>=0?this.drawArea.height+1*this.drawArea.y-1*o/i-(t-Math.max(0,s))/i:this.drawArea.height+1*this.drawArea.y-(0-t)/i;return console.log("_calcLevelY...",t,o,i,s,e,n),a.push(n),a})),console.log("calcLevelY, yStack...",a),a}getPoints(){let t,e,{coords:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coords);let i=s[0];s.shift();return s.map(((s,o)=>{t=s,e=this._smoothing?this._midPoint(i[0],i[1],t[0],t[1]):t;const a=this._smoothing?(t[2]+i[2])/2:t[2];return i=t,[e[0],e[1],a,o+1]}))}getPath(){let t,e,{coords:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coords);let i="",o=s[0];return i+=`M${o[0]},${o[1]}`,s.forEach((s=>{t=s,e=this._smoothing?this._midPoint(o[0],o[1],t[0],t[1]):t,i+=` ${e[0]},${e[1]}`,i+=` Q ${t[0]},${t[1]}`,o=t})),i+=` ${t[0]},${t[1]}`,i}getPathMin(){let t,e,{coordsMin:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coordsMin);let i="",o=s[0];return i+=`M${o[0]},${o[1]}`,s.forEach((s=>{t=s,e=t,i+=` ${e[0]},${e[1]}`,i+=` Q ${t[0]},${t[1]}`,o=t})),i+=` ${t[0]},${t[1]}`,i}getPathMax(){let t,e,{coordsMax:s}=this;1===s.length&&(s[1]=[this.width+this.margin.x,0,s[0][2]]),s=this._calcY(this.coordsMax);let i="",o=s[s.length-1];return s.reverse().forEach(((s,a,r)=>{t=s,e=t,i+=` ${e[0]},${e[1]}`,i+=` Q ${t[0]},${t[1]}`,o=t})),i+=` ${t[0]},${t[1]}`,i+=`M${o[0]},${o[1]}`,i}computeGradient(t,e){const s=e?Math.log10(Math.max(1,this._max))-Math.log10(Math.max(1,this._min)):this._max-this._min;return t.map(((t,i,o)=>{let a,r;if(t.value>this._max&&o[i+1]){const e=(this._max-o[i+1].value)/(t.value-o[i+1].value);a=Mt.getGradientValue(o[i+1].color,t.color,e)}else if(t.value<this._min&&o[i-1]){const e=(o[i-1].value-this._min)/(o[i-1].value-t.value);a=Mt.getGradientValue(o[i-1].color,t.color,e)}return r=s<=0?0:e?(Math.log10(Math.max(1,this._max))-Math.log10(Math.max(1,t.value)))*(100/s):(this._max-t.value)*(100/s),{color:a||t.color,offset:r}}))}getFill2(t){const e=this.height+4*this.margin.y;let s=t;return s+=` L ${this.width-2*this.margin.x}, ${e}`,s+=` L ${this.coords[0][0]}, ${e} z`,s}getFillMinMax(t,e){let s=t;return s+=` L ${this.coordsMax[this.coordsMax.length-1][0]},\n                ${this.coordsMax[this.coordsMax.length-1][1]}`,s+=e,s+=" z",s}getFill(t){const e=(this._min>=0?this.height:this.height+0-Math.abs(this._min)/(this._max-this._min)*this.height)+1.5*this.drawArea.y;let s=t;return s+=` L ${this.drawArea.width+this.drawArea.x}, ${e}`,s+=` L ${this.coords[0][0]}, ${e} z`,s}getLevels(t,e,s=4){const i=(this.drawArea.width+s)/Math.ceil(this.hours*this.points)/e;this._max,this._min,this.drawArea.height;this._min<0&&Math.abs(this._min);const o=(this.drawArea.height-this.buckets*s)/this.buckets;let a;return this.coords.map(((t,e)=>{let s=[];const i=Math.trunc(t[2]/this.valuesPerBucket),o=Math.trunc(this._min/this.valuesPerBucket);a=i-o,s[0]=t[0],s[1]=[],s[2]=[];for(let r=0;r<a;r++)s[2][r]=this._min+r*this.valuesPerBucket;return s[1]=this._calcLevelY(s),console.log("getLevels, newCoord = ",s),s})).map(((a,r)=>({x:i*r*e+i*t+this.drawArea.x,y:a[1],height:o,width:i-s,value:a[2]})))}getBars(t,e,s=4){const i=this._calcY(this.coords),o=(this.drawArea.width+s)/Math.ceil(this.hours*this.points)/e,a=(this._max-this._min)/this.drawArea.height||1;return this._min<0&&Math.abs(this._min),i.map(((i,r)=>({x:o*r*e+o*t+this.drawArea.x,y:this._min>0?i[1]:i[3],height:i[2]>0?this._min<0?i[2]/a:(i[2]-this._min)/a:i[1]-i[3],width:o-s,value:i[2]})))}_midPoint(t,e,s,i){return[(t-s)/2+s,(e-i)/2+i]}_average(t){return t.reduce(((t,e)=>t+parseFloat(e.state)),0)/t.length}_median(t){const e=[...t].sort(((t,e)=>parseFloat(t)-parseFloat(e))),s=Math.floor((e.length-1)/2);return e.length%2==1?parseFloat(e[s].state):(parseFloat(e[s].state)+parseFloat(e[s+1].state))/2}_maximum(t){return Math.max(...t.map((t=>t.state)))}_minimum(t){return Math.min(...t.map((t=>t.state)))}_first(t){return parseFloat(t[0].state)}_last(t){return parseFloat(t[t.length-1].state)}_sum(t){return t.reduce(((t,e)=>t+parseFloat(e.state)),0)}_delta(t){return this._maximum(t)-this._minimum(t)}_diff(t){return this._last(t)-this._first(t)}_lastValue(t){return["delta","diff"].includes(this.aggregateFuncName)?0:parseFloat(t[t.length-1].state)||0}_updateEndTime(){switch(this._endTime=new Date,this._groupBy){case"month":this._endTime.setMonth(this._endTime.getMonth()+1),this._endTime.setDate(1);break;case"date":this._endTime.setDate(this._endTime.getDate()+1),this._endTime.setHours(0,0,0,0);break;case"hour":this._endTime.setHours(this._endTime.getHours()+1),this._endTime.setMinutes(0,0,0)}}}const Se=(t,e,s="en-US")=>t.toLocaleString(s,{hour:"numeric",minute:"numeric",...e}),ke=t=>3600*t*1e3,Me=["var(--accent-color)","#3498db","#e74c3c","#9b59b6","#f1c40f","#2ecc71","#1abc9c","#34495e","#e67e22","#7f8c8d","#27ae60","#2980b9","#8e44ad"],Ee=(t,e)=>{for(let s=e,i=t.length;s<i;s+=1)if(null!=t[s].value)return s;throw new Error('Error in threshold interpolation: could not find right-nearest valued stop. Do the first and last thresholds have a set "value"?')},Te=(t,e)=>{const s=(t=>{if(!t||!t.length)return t;if(null==t[0].value||null==t[t.length-1].value)throw new Error('The first and last thresholds must have a set "value".\n See xyz manual');let e=0,s=null;return t.map(((i,o)=>{if(null!=i.value)return e=o,{...i};null==s?s=Ee(t,o):o>s&&(e=s,s=Ee(t,o));const a=t[e].value,r=(t[s].value-a)/(s-e);return{color:"string"==typeof i?i:i.color,value:r*o+a}}))})(t);if(s.sort(((t,e)=>e.value-t.value)),"smooth"===e)return s;return[].concat(...s.map(((t,e)=>[t,{value:t.value-1e-4,color:s[e+1]?s[e+1].color:t.color}])))};class Ce extends Et{constructor(t,e,s){const i={position:{cx:50,cy:50,height:25,width:25,margin:.5},hours_to_show:24,points_per_hour:.5,value_buckets:10,animate:!0,hour24:!1,font_size:10,aggregate_func:"avg",group_by:"interval",line_color:[...Me],color_thresholds:[],color_thresholds_transition:"smooth",line_width:5,bar_spacing:4,compress:!0,smoothing:!0,state_map:[],cache:!0,value_factor:0,color:"var(--primary-color)",classes:{tool:{"sak-graph":!0,hover:!0},bar:{},line:{"sak-graph__line":!0,hover:!0}},styles:{tool:{},line:{},bar:{},area_mask_above:{fill:"url(#sak-graph-area-mask-tb-1)"},area_mask_below:{fill:"url(#sak-graph-area-mask-bt-1)"},bar_mask_above:{fill:"url(#sak-graph-bar-mask-tb-80)"},bar_mask_below:{fill:"url(#sak-graph-bar-mask-bt-80)"}},colorstops:[],show:{style:"fixedcolor"}};super(t,_t.mergeDeep(i,e),s),this.svg.margin={},"object"==typeof this.config.position.margin?(this.svg.margin.t=bt.calculateSvgDimension(this.config.position.margin?.t)||bt.calculateSvgDimension(this.config.position.margin?.y),this.svg.margin.b=bt.calculateSvgDimension(this.config.position.margin?.b)||bt.calculateSvgDimension(this.config.position.margin?.y),this.svg.margin.r=bt.calculateSvgDimension(this.config.position.margin?.r)||bt.calculateSvgDimension(this.config.position.margin?.x),this.svg.margin.l=bt.calculateSvgDimension(this.config.position.margin?.l)||bt.calculateSvgDimension(this.config.position.margin?.x),this.svg.margin.x=this.svg.margin.l,this.svg.margin.y=this.svg.margin.t):(this.svg.margin.x=bt.calculateSvgDimension(this.config.position.margin),this.svg.margin.y=this.svg.margin.x,this.svg.margin.t=this.svg.margin.x,this.svg.margin.r=this.svg.margin.x,this.svg.margin.b=this.svg.margin.x,this.svg.margin.l=this.svg.margin.x),this._data=[],this._bars=[],this._scale={},this._needsRendering=!1,this.classes.tool={},this.classes.bar={},this.styles.tool={},this.styles.line={},this.stylesBar={},this.seriesIndex=0,this.id=this.toolId,this.bound=[0,0],this.boundSecondary=[0,0],this.length=[],this.entity=[],this.line=[],this.lineMin=[],this.lineMax=[],this.bar=[],this.level=[],this.abs=[],this.fill=[],this.fillMinMax=[],this.points=[],this.gradient=[],this.tooltip={},this.updateQueue=[],this.updating=!1,this.stateChanged=!1,this.initial=!0,this._md5Config=void 0,this.config.width=this.svg.width,this.config.height=this.svg.height,this.svg.line_width=bt.calculateSvgDimension(this.config.line_width),this.config.color_thresholds=Te(this.config.color_thresholds,this.config.color_thresholds_transition),this.svg.graph={},this.svg.graph.height=this.svg.height-0*this.svg.margin.y,this.svg.graph.width=this.svg.width-0*this.svg.margin.x,this.Graph=this.config.entity_indexes.map((t=>new $e(this.svg.graph.width,this.svg.graph.height,this.svg.margin,this.config.hours_to_show,this.config.points_per_hour,t.aggregate_func||this.config.aggregate_func,this.config.group_by,((...t)=>t.find((t=>void 0!==t)))(t.smoothing,this.config.smoothing,!this._card.config.entities[t.entity_index].entity.startsWith("binary_sensor.")),this.config.logarithmic))),this.dev.debug&&console.log("SparklelineGraph constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}set data(t){this.seriesIndex=t}set series(t){if(this.dev&&this.dev.fakeData){console.log("SparklineGraphTool::set series(states)",t);let e=40;for(let s=0;s<t.length;s++)s<t.length/2&&(e-=4*s),s>t.length/2&&(e+=3*s),t[s].state=e}if(!0===this._card.config.entities[0].fixed_value){console.log("update, YUP, fixed value...");const e=t[t.length-1];t=[e,e]}this.Graph[this.seriesIndex].update(t),this.updateBounds();let{config:e}=this;if(e.show.graph){let t=0;this._card.entities.forEach(((s,i)=>{if(!s||0===this.Graph[i].coords.length)return;const o="secondary"===this._card.config.entities[i].y_axis?this.boundSecondary:this.bound;if([this.Graph[i].min,this.Graph[i].max]=[o[0],o[1]],"bar"===e.show.graph){const s=this.visibleEntities.length;this.bar[i]=this.Graph[i].getBars(t,s,e.bar_spacing),t+=1,e.color_thresholds.length>0&&!this._card.config.entities[i].color&&(this.gradient[i]=this.Graph[i].computeGradient(e.color_thresholds,this.config.logarithmic))}else{const t=this.Graph[i].getPath();!1!==this._card.config.entities[i].show_line&&(this.line[i]=t),e.show.fill&&!1!==this._card.config.entities[i].show_fill&&(this.fill[i]=this.Graph[i].getFill(t)),e.show.points&&!1!==this._card.config.entities[i].show_points&&(this.points[i]=this.Graph[i].getPoints()),e.color_thresholds.length>0&&!this._card.config.entities[i].color&&(this.gradient[i]=this.Graph[i].computeGradient(e.color_thresholds,this.config.logarithmic));const s=this.Graph[i].getPathMin(),o=this.Graph[i].getPathMax();this.lineMin||(this.lineMin=[]),this.lineMax||(this.lineMax=[]),this.lineMin[i]=s,this.lineMax[i]=o,this.fillMinMax||(this.fillMinMax=[]),this.fillMinMax[i]=this.Graph[i].getFillMinMax(s,o),"levels"===this.config.show.graph&&(this.Graph[i].buckets=this.config.value_buckets,this.Graph[i].valuesPerBucket=(this.Graph[i].max-this.Graph[i].min)/this.config.value_buckets,this.level[i]=this.Graph[i].getLevels(0,this.visibleEntities.length,e.bar_spacing))}})),this.line=[...this.line]}this.updating=!1}hasSeries(){return this.defaultEntityIndex()}get visibleEntities(){return this._card.config.entities.filter((t=>!1!==t.show_graph))}get primaryYaxisEntities(){return this.visibleEntities.filter((t=>void 0===t.y_axis||"primary"===t.y_axis))}get secondaryYaxisEntities(){return this.visibleEntities.filter((t=>"secondary"===t.y_axis))}get visibleLegends(){return this.visibleEntities.filter((t=>!1!==t.show_legend))}get primaryYaxisSeries(){return this.primaryYaxisEntities.map(((t,e)=>this.Graph[e]))}get secondaryYaxisSeries(){return this.secondaryYaxisEntities.map((t=>this.Graph[t.index]))}getBoundary(t,e,s,i){if(!(t in Math))throw new Error(`The type "${t}" is not present on the Math object`);return void 0===s?Math[t](...e.map((e=>e[t])))||i:"~"!==s[0]?s:Math[t](Number(s.substr(1)),...e.map((e=>e[t])))}getBoundaries(t,e,s,i,o){let a=[this.getBoundary("min",t,e,i[0],o),this.getBoundary("max",t,s,i[1],o)];if(o){const t=Math.abs(a[0]-a[1]),e=parseFloat(o)-t;e>0&&(a=[a[0]-e/2,a[1]+e/2])}return a}updateBounds({config:t}=this){this.bound=this.getBoundaries(this.primaryYaxisSeries,t.lower_bound,t.upper_bound,this.bound,t.min_bound_range),this.boundSecondary=this.getBoundaries(this.secondaryYaxisSeries,t.lower_bound_secondary,t.upper_bound_secondary,this.boundSecondary,t.min_bound_range_secondary)}computeColor(t,e){const{color_thresholds:s,line_color:i}=this.config,o=Number(t)||0,a={color:i[e]||i[0],...s.slice(-1)[0],...s.find((t=>t.value<o))};return this._card.config.entities[e].color||a.color}intColor(t,e){const{color_thresholds:s,line_color:i}=this.config,o=Number(t)||0;let a;if(s.length>0)if("bar"===this.config.show.graph){const{color:t}=s.find((t=>t.value<o))||s.slice(-1)[0];a=t}else{const e=s.findIndex((t=>t.value<o)),i=s[e],r=s[e-1];if(r){const e=(r.value-t)/(r.value-i.value);a=Mt.getGradientValue(r.color,i.color,e)}else a=e?s[s.length-1].color:s[0].color}return this._card.config.entities[e].color||a||i[e]||i[0]}getEndDate(){const t=new Date;switch(this.config.group_by){case"date":t.setDate(t.getDate()+1),t.setHours(0,0,0);break;case"hour":t.setHours(t.getHours()+1),t.setMinutes(0,0)}return t}setTooltip(t,e,s,i=null){const{points_per_hour:o,hours_to_show:a,format:r}=this.config,n=a<1&&o<1?o*a:1/o,h=Math.abs(e+1-Math.ceil(a*o)),l=this.getEndDate(),c=1/60;l.setMilliseconds(l.getMilliseconds()-ke(n*h+c));const d=Se(l,r,this._card._hass.language);l.setMilliseconds(l.getMilliseconds()-ke(n-c));const g=Se(l,r,this._card._hass.language);this.tooltip={value:s,id:h,entity:t,time:[g,d],index:e,label:i}}renderSvgAreaMask(t,e){if("dots"===this.config.show.graph)return;if(!t)return;const s="fade"===this.config.show.fill,i=this.length[e]||!1===this._card.config.entities[e].show_line,o=this.Graph[e]._min>=0?0:Math.abs(this.Graph[e]._min)/(this.Graph[e]._max-this.Graph[e]._min)*100;return B`
    <defs>
      ...
      <mask id=${`fill-grad-mask-pos-${this.id}-${e}`}>
        <rect width="100%" height="${100-o}%" fill=${this.config.styles.area_mask_above.fill}
         />
      </mask>
      ...
      <mask id=${`fill-grad-mask-neg-${this.id}-${e}`}>
        <rect width="100%" y=${100-o}% height="${o}%" fill=${this.config.styles.area_mask_below.fill}
         />
      </mask>
    </defs>
    ...
    <mask id=${`fill-${this.id}-${e}`}>
      ...
      ${this.Graph[e]._min<0?B`<path class='fill'
            ...
            d=${this.fill[e]}
          />`:""}
    </mask>`}renderSvgAreaMinMaxMask(t,e){if("dots"===this.config.show.graph)return;if(!t)return;const s="fade"===this.config.show.fill,i=this.length[e]||!1===this._card.config.entities[e].show_line,o=this.Graph[e]._min>=0?0:Math.abs(this.Graph[e]._min)/(this.Graph[e]._max-this.Graph[e]._min)*100;return B`
    <defs>
      <linearGradient id=${`fill-grad-pos-${this.id}-${e}`} x1="0%" y1="0%" x2="0%" y2="100%">
        <stop stop-color='white' offset='0%' stop-opacity='1'/>
        <stop stop-color='white' offset='100%' stop-opacity='0.1'/>
  ...
  `}renderSvgLineMinMaxMask(t,e){if("dots"===this.config.show.graph)return;if(!t)return;console.log("renderSvgLineMinMaxMask",t,e);const s=B`
    <path
      class='lineMinMax'
      .id=${e}
      anim=${this.config.animate} ?init=${this.length[e]}
  ...
  `}renderSvgPoints(t,e){if(!t)return;const s=this.computeColor(this._card.entities[e].state,e);return B`
    <g class='line--points'
      ...
      <linearGradient id=${`grad-${this.id}-${e}`} gradientTransform="rotate(90)">
        ...
        `))}
      </linearGradient>`}));return B`${e}`}renderSvgLineBackground(t,e){if(["dots","levels"].includes(this.config.show.graph))return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e);return B`
    <rect class='line--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`line-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#line-${this.id}-${e})`}
    />`}renderSvgLineMinMaxBackground(t,e){if(["dots","levels"].includes(this.config.show.graph))return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.computeColor(this._card.entities[e].state,e);return B`
    <rect class='line--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`line-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#lineMinMax-${this.id}-${e})`}
    />`}renderSvgAreaBackground(t,e){if(["dots","levels"].includes(this.config.show.graph))return;if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return B`
    <rect class='fill--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`fill-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#fill-${this.id}-${e})`}
    />`}renderSvgAreaMinMaxBackground(t,e){if(!t)return;const s=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return B`
    <rect class='fill--rect'
      ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
      id=${`fill-rect-${this.id}-${e}`}
      fill=${s} height="100%" width="100%"
      mask=${`url(#fillMinMax-${this.id}-${e})`}
    />`}renderSvgLevelsMask(t,e){if("levels"!==this.config.show.graph)return;if(!t)return;console.log("renderSvgLevelsMask",t);const s="fade"===this.config.show.fill;this.id;const i=`url(#fill-grad-mask-pos-${this.id}-${e}})`,o=this.config.styles.bar_mask_below.fill,a=this.config.styles.bar_mask_above.fill,r=t.map(((t,i)=>{console.log("renderSvgLevelsMask",i,t);const r=this.config.animate?B`
        <animate attributeName='y' from=${this.svg.height} to=${t.y} dur='1s' fill='remove'
          calcMode='spline' keyTimes='0; 1' keySplines='0.215 0.61 0.355 1'>
        </animate>`:"";if(!0===this.config.square){const e=Math.min(t.width,t.height);t.width=e,t.height=e}const n=t.value.map(((i,n)=>B`
      <rect class='level' x=${t.x} y=${t.y[n]-1*t.height-this.svg.line_width/1}
        height=${Math.max(0,t.height-this.svg.line_width)} width=${t.width}
        fill=${s?t.value>0?a:o:"white"}
        stroke=${s?t.value>0?a:o:"white"}
    ...
    <mask id=${`levels-bg-${this.id}-${e}`}>
      ${r}
      mask = ${i}
    </mask>
  `}renderSvgBarsMask(t,e){if("dots"===this.config.show.graph)return;if(!t)return;const s="fade"===this.config.show.fill;this.id;const i=`url(#fill-grad-mask-pos-${this.id}-${e}})`,o=this.config.styles.bar_mask_below.fill,a=this.config.styles.bar_mask_above.fill,r=t.map(((t,i)=>{const r=this.config.animate?B`
        <animate attributeName='y' from=${this.svg.height} to=${t.y} dur='1s' fill='remove'
          calcMode='spline' keyTimes='0; 1' keySplines='0.215 0.61 0.355 1'>
        </animate>`:"";return B` 
  ...
  `}renderSvgLevelsBackground(t,e){if("levels"!==this.config.show.graph)return;if(!t)return;if("fadenever"===this.config.show.fill){this.length[e]||this._card.config.entities[e].show_line;const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return this.gradient[e]?this.id:this.intColor(this._card.entities[e].state,e),B`
      <defs>
      ...
      <g mask = ${`url(#fill-grad-mask-${this.id}-${e})`}>
        <rect class='levels--bg'
          ?inactive=${void 0!==this.tooltip.entity&&this.tooltip.entity!==e}
          id=${`levels-bg-${this.id}-${e}`}
          fill=${t} height="100%" width="100%"
          mask=${`url(#levels-bg-${this.id}-${e})`}
        />
      ...
      <rect class='levels--bg'
        ...
        fill=${t} height="100%" width="100%"
        mask=${`url(#levels-bg-${this.id}-${e})`}
      />`}}renderSvgBarsBackground(t,e){if("dots"===this.config.show.graph)return;if(!t)return;if("fadenever"===this.config.show.fill){this.length[e]||this._card.config.entities[e].show_line;const t=this.gradient[e]?`url(#grad-${this.id}-${e})`:this.intColor(this._card.entities[e].state,e);return this.gradient[e]?this.id:this.intColor(this._card.entities[e].state,e),B`
      <defs>
        <linearGradient id=${`fill-grad-${this.id}-${e}`} x1="0%" y1="0%" x2="0%" y2="100%">
          <stop stop-color='white' offset='0%' stop-opacity='1'/>
          <stop stop-color='white' offset='100%' stop-opacity='.1'/>
      ...
      <rect class='bar' x=${t.x} y=${t.y}
        ...
        @mouseout=${()=>this.tooltip={}}>
        ${i}
      </rect>`}));return B`<g class='bars' ?anim=${this.config.animate}>${s}</g>`}renderSvg(){return this.svg.height,this.svg.margin.y,this.svg.width,this.svg.margin.x,B`
  <svg width="${this.svg.width}" height="${this.svg.height}" overflow="visible"
    ...
    <g>
        ...
        ${this.level.map(((t,e)=>this.renderSvgLevelsMask(t,e)))}
        ${this.level.map(((t,e)=>this.renderSvgLevelsBackground(t,e)))}
      ...
      `}}class Ie extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,radius:45},card_filter:"card--filter-none",horseshoe_scale:{min:0,max:100,width:3,color:"var(--primary-background-color)"},horseshoe_state:{width:6,color:"var(--primary-color)"},show:{horseshoe:!0,scale_tickmarks:!1,horseshoe_style:"fixed"}},e),s),this.HORSESHOE_RADIUS_SIZE=180,this.TICKMARKS_RADIUS_SIZE=172,this.HORSESHOE_PATH_LENGTH=520/360*Math.PI*this.HORSESHOE_RADIUS_SIZE,this.config.entity_index=this.config.entity_index?this.config.entity_index:0,this.svg.radius=bt.calculateSvgDimension(this.config.position.radius),this.svg.radius_ticks=bt.calculateSvgDimension(.95*this.config.position.radius),this.svg.horseshoe_scale={},this.svg.horseshoe_scale.width=bt.calculateSvgDimension(this.config.horseshoe_scale.width),this.svg.horseshoe_state={},this.svg.horseshoe_state.width=bt.calculateSvgDimension(this.config.horseshoe_state.width),this.svg.horseshoe_scale.dasharray=52/36*Math.PI*this.svg.radius,this.svg.rotate={},this.svg.rotate.degrees=-220,this.svg.rotate.cx=this.svg.cx,this.svg.rotate.cy=this.svg.cy,this.colorStops={},this.config.color_stops&&Object.keys(this.config.color_stops).forEach((t=>{this.colorStops[t]=this.config.color_stops[t]})),this.sortedStops=Object.keys(this.colorStops).map((t=>Number(t))).sort(((t,e)=>t-e)),this.colorStopsMinMax={},this.colorStopsMinMax[this.config.horseshoe_scale.min]=this.colorStops[this.sortedStops[0]],this.colorStopsMinMax[this.config.horseshoe_scale.max]=this.colorStops[this.sortedStops[this.sortedStops.length-1]],this.color0=this.colorStops[this.sortedStops[0]],this.color1=this.colorStops[this.sortedStops[this.sortedStops.length-1]],this.angleCoords={x1:"0%",y1:"0%",x2:"100%",y2:"0%"},this.color1_offset="0%",this.dev.debug&&console.log("HorseshoeTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}set value(t){if(this._stateValue===t)return;this._stateValuePrev=this._stateValue||t,this._stateValue=t,this._stateValueIsDirty=!0;const e=this.config.horseshoe_scale.min||0,s=this.config.horseshoe_scale.max||100,i=Math.min(bt.calculateValueBetween(e,s,t),1),o=i*this.HORSESHOE_PATH_LENGTH,a=10*this.HORSESHOE_RADIUS_SIZE;this.dashArray=`${o} ${a}`;const r=this.config.show.horseshoe_style;if("fixed"===r)this.stroke_color=this.config.horseshoe_state.color,this.color0=this.config.horseshoe_state.color,this.color1=this.config.horseshoe_state.color,this.color1_offset="0%";else if("autominmax"===r){const e=Mt.calculateColor(t,this.colorStopsMinMax,!0);this.color0=e,this.color1=e,this.color1_offset="0%"}else if("colorstop"===r||"colorstopgradient"===r){const e=Mt.calculateColor(t,this.colorStops,"colorstopgradient"===r);this.color0=e,this.color1=e,this.color1_offset="0%"}else if("lineargradient"===r){const t={x1:"0%",y1:"0%",x2:"100%",y2:"0%"};this.color1_offset=`${Math.round(100*(1-i))}%`,this.angleCoords=t}this.dev.debug&&console.log("HorseshoeTool set value",this.cardId,t)}_renderTickMarks(){const{config:t}=this;if(!t.show.scale_tickmarks)return;const e=t.horseshoe_scale.color?t.horseshoe_scale.color:"var(--primary-background-color)",s=t.horseshoe_scale.ticksize?t.horseshoe_scale.ticksize:(t.horseshoe_scale.max-t.horseshoe_scale.min)/10,i=t.horseshoe_scale.min%s,o=t.horseshoe_scale.min+(0===i?0:s-i),a=(o-t.horseshoe_scale.min)/(t.horseshoe_scale.max-t.horseshoe_scale.min)*260,r=(t.horseshoe_scale.max-o)/s;let n=Math.floor(r);const h=(260-a)/r;Math.floor(n*s+o)<=t.horseshoe_scale.max&&(n+=1);const l=this.svg.horseshoe_scale.width?this.svg.horseshoe_scale.width/2:3;let c;const d=[];let g;for(g=0;g<n;g++)c=a+(360-g*h-230)*Math.PI/180,d[g]=B`
    ...
    `}}class Pe extends Et{constructor(t,e,s){super(t,_t.mergeDeep({position:{cx:50,cy:50,radius:50,side_count:6,side_skip:1,angle_offset:0},classes:{tool:{"sak-polygon":!0,hover:!0},regpoly:{"sak-polygon__regpoly":!0}},styles:{tool:{},regpoly:{}}},e),s),this.svg.radius=bt.calculateSvgDimension(e.position.radius),this.classes.regpoly={},this.styles.regpoly={},this.dev.debug&&console.log("RegPolyTool constructor config, svg",this.toolId,this.config,this.svg)}set value(t){super.value=t}_renderRegPoly(){return this.MergeAnimationStyleIfChanged(),this.MergeColorFromState(this.styles.regpoly),B`
    ...
    `}}class Fe extends Et{constructor(t,e,s){super(t,_t.mergeDeep({classes:{tool:{"sak-text":!0},text:{"sak-text__text":!0,hover:!1}},styles:{tool:{},text:{}}},e),s),this.EnableHoverForInteraction(),this.text=this.config.text,this.classes.tool={},this.classes.text={},this.styles.tool={},this.styles.text={},this.dev.debug&&console.log("TextTool constructor coords, dimensions",this.coords,this.dimensions,this.svg,this.config)}_renderText(){return this.MergeAnimationClassIfChanged(),this.MergeColorFromState(this.styles.text),this.MergeAnimationStyleIfChanged(),B`
        <text>
