import{LitElement,html,css,svg,unsafeCSS}from"lit-element";import{styleMap}from"lit-html/directives/style-map.js";import{unsafeSVG}from"lit-html/directives/unsafe-svg.js";import{ifDefined}from"lit-html/directives/if-defined.js";import{selectUnit}from"@formatjs/intl-utils";import{version}from"../package.json";import{SCALE_DIMENSIONS,SVG_DEFAULT_DIMENSIONS,SVG_DEFAULT_DIMENSIONS_HALF,SVG_VIEW_BOX,FONT_SIZE,clamp,round,angle360,range}from"./const";import Merge from"./merge";import Utils from"./utils";import Templates from"./templates";import Toolset from"./toolset";import*as SvgInjector from"../dist/SVGInjector.min.js";console.info(`%c  SWISS-ARMY-KNIFE-CARD  
